...
public class Warehouse: JSONEncodable {
    ...
    public var shipStationAllowRateShopping: Bool?
    public var shipStationBlockShippingForUnresolvedShortWork: Bool?
    public var inventorySearchInnerPackBarcode: Bool?
    public var inventorySearchCaseBarcode: Bool?
    public var inventorySearchPalletBarcode: Bool?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["shipStationAllowRateShopping"] = self.shipStationAllowRateShopping
        nillableDictionary["shipStationBlockShippingForUnresolvedShortWork"] = self.shipStationBlockShippingForUnresolvedShortWork
        nillableDictionary["inventorySearchInnerPackBarcode"] = self.inventorySearchInnerPackBarcode
        nillableDictionary["inventorySearchCaseBarcode"] = self.inventorySearchCaseBarcode
        nillableDictionary["inventorySearchPalletBarcode"] = self.inventorySearchPalletBarcode
