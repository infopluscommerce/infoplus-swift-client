...
public class Work: JSONEncodable {
    ...
    public var workProductList: [WorkProduct]?
    public var fulfillmentProcessId: Int32?
    public var pickLineId: Int32?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["workProductList"] = self.workProductList?.encodeToJSON()
        nillableDictionary["fulfillmentProcessId"] = self.fulfillmentProcessId?.encodeToJSON()
        nillableDictionary["pickLineId"] = self.pickLineId?.encodeToJSON()
