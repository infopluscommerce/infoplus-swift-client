...
public class OrderLine: JSONEncodable {
    ...
    public var overrideReceiptsForFulfillmentList: [OverrideReceiptsForFulfillment]?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["overrideReceiptsForFulfillmentList"] = self.overrideReceiptsForFulfillmentList?.encodeToJSON()
