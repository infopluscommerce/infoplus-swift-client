...
public class CartonType: JSONEncodable {
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["noOfCavities"] = self.noOfCavities?.encodeToJSON()
        nillableDictionary["materialDescription"] = self.materialDescription
