...
public class FulfillmentProcess: JSONEncodable {
    ...
    public var selectAlternatePickLocation: Bool?
    public var firstPickPosition: Int32?
    public var autoCreateCycleCountWork: Bool?
    public var autoAdjustmentTolerance: Int32?
    ...
    public var orderAssemblyGuideLayout: String?
    public var createOrderInvoice: String?
    public var overrideOrderInvoiceTemplateId: Int32?
    public var createCartonGS1128Labels: String?
    public var createLineItemEachGS1128Labels: String?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["selectAlternatePickLocation"] = self.selectAlternatePickLocation
        nillableDictionary["firstPickPosition"] = self.firstPickPosition?.encodeToJSON()
        nillableDictionary["autoCreateCycleCountWork"] = self.autoCreateCycleCountWork
        nillableDictionary["autoAdjustmentTolerance"] = self.autoAdjustmentTolerance?.encodeToJSON()
        ...
        nillableDictionary["orderAssemblyGuideLayout"] = self.orderAssemblyGuideLayout
        ...
        nillableDictionary["createCartonGS1128Labels"] = self.createCartonGS1128Labels
        nillableDictionary["createLineItemEachGS1128Labels"] = self.createLineItemEachGS1128Labels
