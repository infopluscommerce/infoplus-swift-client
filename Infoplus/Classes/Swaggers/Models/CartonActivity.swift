...
public class CartonActivity: JSONEncodable {
    ...
    public var cartonAbbr: String?
    public var cartonName: String?
    public var cartonLength: Double?
    public var cartonWidth: Double?
    public var cartonHeight: Double?
    public var cartonInnerLength: Double?
    public var cartonInnerWidth: Double?
    public var cartonInnerHeight: Double?
    public var cartonWeight: Double?
    public var predefinedCartonId: Int32?
    public var predefinedCartonLabel: String?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["cartonAbbr"] = self.cartonAbbr
        nillableDictionary["cartonName"] = self.cartonName
        ...
        nillableDictionary["cartonInnerLength"] = self.cartonInnerLength
        nillableDictionary["cartonInnerWidth"] = self.cartonInnerWidth
        nillableDictionary["cartonInnerHeight"] = self.cartonInnerHeight
        nillableDictionary["cartonWeight"] = self.cartonWeight
        nillableDictionary["predefinedCartonId"] = self.predefinedCartonId?.encodeToJSON()
        nillableDictionary["predefinedCartonLabel"] = self.predefinedCartonLabel
