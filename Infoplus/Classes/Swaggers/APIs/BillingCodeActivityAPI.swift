...
public class BillingCodeActivityAPI: APIBase {
  ...
  "recordTypeName" : "recordTypeName"
    ...
    public class func addBillingCodeActivityWithRequestBuilder(body body: BillingCodeActivity) -> RequestBuilder<BillingCodeActivity> {
        let path = "/v3.0/billingCodeActivity"
    ...
    /**
     Add new audit for a billingCodeActivity
     - PUT /v3.0/billingCodeActivity/{billingCodeActivityId}/audit/{billingCodeActivityAudit}
    ...
    public class func addBillingCodeActivityAuditWithRequestBuilder(billingCodeActivityId billingCodeActivityId: Int32, billingCodeActivityAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeActivity/{billingCodeActivityId}/audit/{billingCodeActivityAudit}"
    ...
    /**
     Attach a file to a billingCodeActivity
     - POST /v3.0/billingCodeActivity/{billingCodeActivityId}/file/{fileName}
    ...
    public class func addBillingCodeActivityFileWithRequestBuilder(billingCodeActivityId billingCodeActivityId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeActivity/{billingCodeActivityId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeActivityId}", withString: "\(billingCodeActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter billingCodeActivityId: (path) Id of the billingCodeActivity to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addBillingCodeActivityFileByURL(body body: RecordFile, billingCodeActivityId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addBillingCodeActivityFileByURLWithRequestBuilder(body: body, billingCodeActivityId: billingCodeActivityId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a billingCodeActivity by URL.
     - POST /v3.0/billingCodeActivity/{billingCodeActivityId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addBillingCodeActivityFileByURLWithRequestBuilder(body body: RecordFile, billingCodeActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeActivity/{billingCodeActivityId}/file"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeActivityId}", withString: "\(billingCodeActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for a billingCodeActivity.
     - PUT /v3.0/billingCodeActivity/{billingCodeActivityId}/tag/{billingCodeActivityTag}
    ...
    public class func addBillingCodeActivityTagWithRequestBuilder(billingCodeActivityId billingCodeActivityId: Int32, billingCodeActivityTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeActivity/{billingCodeActivityId}/tag/{billingCodeActivityTag}"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeActivityId}", withString: "\(billingCodeActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a billingCodeActivity
     - DELETE /v3.0/billingCodeActivity/{billingCodeActivityId}
    ...
    public class func deleteBillingCodeActivityWithRequestBuilder(billingCodeActivityId billingCodeActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeActivity/{billingCodeActivityId}"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeActivityId}", withString: "\(billingCodeActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter billingCodeActivityId: (path) Id of the billingCodeActivity to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteBillingCodeActivityFile(billingCodeActivityId billingCodeActivityId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteBillingCodeActivityFileWithRequestBuilder(billingCodeActivityId: billingCodeActivityId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a billingCodeActivity.
     - DELETE /v3.0/billingCodeActivity/{billingCodeActivityId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteBillingCodeActivityFileWithRequestBuilder(billingCodeActivityId billingCodeActivityId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeActivity/{billingCodeActivityId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeActivityId}", withString: "\(billingCodeActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a billingCodeActivity.
     - DELETE /v3.0/billingCodeActivity/{billingCodeActivityId}/tag/{billingCodeActivityTag}
    ...
    /**
     Search billingCodeActivitys by filter
     - GET /v3.0/billingCodeActivity/search
  ...
  "recordTypeName" : "recordTypeName"
    ...
    public class func getBillingCodeActivityByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[BillingCodeActivity]> {
        let path = "/v3.0/billingCodeActivity/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a billingCodeActivity by id
     - GET /v3.0/billingCodeActivity/{billingCodeActivityId}
  ...
  "recordTypeName" : "recordTypeName"
    ...
    /**
     ...
     - parameter billingCodeActivityId: (path) Id of the billingCodeActivity to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getBillingCodeActivityFiles(billingCodeActivityId billingCodeActivityId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getBillingCodeActivityFilesWithRequestBuilder(billingCodeActivityId: billingCodeActivityId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a billingCodeActivity.
     - GET /v3.0/billingCodeActivity/{billingCodeActivityId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getBillingCodeActivityFilesWithRequestBuilder(billingCodeActivityId billingCodeActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeActivity/{billingCodeActivityId}/file"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeActivityId}", withString: "\(billingCodeActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a billingCodeActivity.
     - GET /v3.0/billingCodeActivity/{billingCodeActivityId}/tag
    ...
    public class func getBillingCodeActivityTagsWithRequestBuilder(billingCodeActivityId billingCodeActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeActivity/{billingCodeActivityId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeActivityId}", withString: "\(billingCodeActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a duplicated a billingCodeActivity by id
     - GET /v3.0/billingCodeActivity/duplicate/{billingCodeActivityId}
  ...
  "recordTypeName" : "recordTypeName"
    ...
    public class func getDuplicateBillingCodeActivityByIdWithRequestBuilder(billingCodeActivityId billingCodeActivityId: Int32) -> RequestBuilder<BillingCodeActivity> {
        var path = "/v3.0/billingCodeActivity/duplicate/{billingCodeActivityId}"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeActivityId}", withString: "\(billingCodeActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
