...
public class ExternalShippingSystemAPI: APIBase {
    ...
    /**
     Create an externalShippingSystem
     - POST /v3.0/externalShippingSystem
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func addExternalShippingSystemWithRequestBuilder(body body: ExternalShippingSystem) -> RequestBuilder<ExternalShippingSystem> {
        let path = "/v3.0/externalShippingSystem"
    ...
    /**
     Add new audit for an externalShippingSystem
     - PUT /v3.0/externalShippingSystem/{externalShippingSystemId}/audit/{externalShippingSystemAudit}
    ...
    public class func addExternalShippingSystemAuditWithRequestBuilder(externalShippingSystemId externalShippingSystemId: Int32, externalShippingSystemAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/externalShippingSystem/{externalShippingSystemId}/audit/{externalShippingSystemAudit}"
    ...
    /**
     ...
     - parameter externalShippingSystemId: (path) Id of the externalShippingSystem to add a file to 
     - parameter fileName: (path) Name of file 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addExternalShippingSystemFile(externalShippingSystemId externalShippingSystemId: Int32, fileName: String, completion: ((error: ErrorType?) -> Void)) {
        addExternalShippingSystemFileWithRequestBuilder(externalShippingSystemId: externalShippingSystemId, fileName: fileName).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an externalShippingSystem
     - POST /v3.0/externalShippingSystem/{externalShippingSystemId}/file/{fileName}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addExternalShippingSystemFileWithRequestBuilder(externalShippingSystemId externalShippingSystemId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/externalShippingSystem/{externalShippingSystemId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{externalShippingSystemId}", withString: "\(externalShippingSystemId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter externalShippingSystemId: (path) Id of the externalShippingSystem to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addExternalShippingSystemFileByURL(body body: RecordFile, externalShippingSystemId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addExternalShippingSystemFileByURLWithRequestBuilder(body: body, externalShippingSystemId: externalShippingSystemId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an externalShippingSystem by URL.
     - POST /v3.0/externalShippingSystem/{externalShippingSystemId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addExternalShippingSystemFileByURLWithRequestBuilder(body body: RecordFile, externalShippingSystemId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/externalShippingSystem/{externalShippingSystemId}/file"
        path = path.stringByReplacingOccurrencesOfString("{externalShippingSystemId}", withString: "\(externalShippingSystemId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for an externalShippingSystem.
     - PUT /v3.0/externalShippingSystem/{externalShippingSystemId}/tag/{externalShippingSystemTag}
    ...
    public class func addExternalShippingSystemTagWithRequestBuilder(externalShippingSystemId externalShippingSystemId: Int32, externalShippingSystemTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/externalShippingSystem/{externalShippingSystemId}/tag/{externalShippingSystemTag}"
        path = path.stringByReplacingOccurrencesOfString("{externalShippingSystemId}", withString: "\(externalShippingSystemId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete an externalShippingSystem
     - DELETE /v3.0/externalShippingSystem/{externalShippingSystemId}
    ...
    public class func deleteExternalShippingSystemWithRequestBuilder(externalShippingSystemId externalShippingSystemId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/externalShippingSystem/{externalShippingSystemId}"
        path = path.stringByReplacingOccurrencesOfString("{externalShippingSystemId}", withString: "\(externalShippingSystemId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter externalShippingSystemId: (path) Id of the externalShippingSystem to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteExternalShippingSystemFile(externalShippingSystemId externalShippingSystemId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteExternalShippingSystemFileWithRequestBuilder(externalShippingSystemId: externalShippingSystemId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for an externalShippingSystem.
     - DELETE /v3.0/externalShippingSystem/{externalShippingSystemId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteExternalShippingSystemFileWithRequestBuilder(externalShippingSystemId externalShippingSystemId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/externalShippingSystem/{externalShippingSystemId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{externalShippingSystemId}", withString: "\(externalShippingSystemId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for an externalShippingSystem.
     - DELETE /v3.0/externalShippingSystem/{externalShippingSystemId}/tag/{externalShippingSystemTag}
    ...
    /**
     Get a duplicated an externalShippingSystem by id
     - GET /v3.0/externalShippingSystem/duplicate/{externalShippingSystemId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getDuplicateExternalShippingSystemByIdWithRequestBuilder(externalShippingSystemId externalShippingSystemId: Int32) -> RequestBuilder<ExternalShippingSystem> {
        var path = "/v3.0/externalShippingSystem/duplicate/{externalShippingSystemId}"
        path = path.stringByReplacingOccurrencesOfString("{externalShippingSystemId}", withString: "\(externalShippingSystemId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search externalShippingSystems by filter
     - GET /v3.0/externalShippingSystem/search
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getExternalShippingSystemByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[ExternalShippingSystem]> {
        let path = "/v3.0/externalShippingSystem/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get an externalShippingSystem by id
     - GET /v3.0/externalShippingSystem/{externalShippingSystemId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     ...
     - parameter externalShippingSystemId: (path) Id of the externalShippingSystem to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getExternalShippingSystemFiles(externalShippingSystemId externalShippingSystemId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getExternalShippingSystemFilesWithRequestBuilder(externalShippingSystemId: externalShippingSystemId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for an externalShippingSystem.
     - GET /v3.0/externalShippingSystem/{externalShippingSystemId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getExternalShippingSystemFilesWithRequestBuilder(externalShippingSystemId externalShippingSystemId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/externalShippingSystem/{externalShippingSystemId}/file"
        path = path.stringByReplacingOccurrencesOfString("{externalShippingSystemId}", withString: "\(externalShippingSystemId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for an externalShippingSystem.
     - GET /v3.0/externalShippingSystem/{externalShippingSystemId}/tag
    ...
    public class func getExternalShippingSystemTagsWithRequestBuilder(externalShippingSystemId externalShippingSystemId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/externalShippingSystem/{externalShippingSystemId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{externalShippingSystemId}", withString: "\(externalShippingSystemId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update an externalShippingSystem
     - PUT /v3.0/externalShippingSystem
    ...
    /**
     Update an externalShippingSystem custom fields
     - PUT /v3.0/externalShippingSystem/customFields
    ...
    public class func updateExternalShippingSystemCustomFieldsWithRequestBuilder(body body: ExternalShippingSystem) -> RequestBuilder<Void> {
        let path = "/v3.0/externalShippingSystem/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
