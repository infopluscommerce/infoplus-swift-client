...
public class ItemReceiptAPI: APIBase {
    ...
    /**
     Add new audit for an itemReceipt
     - PUT /v3.0/itemReceipt/{itemReceiptId}/audit/{itemReceiptAudit}
    ...
    public class func addItemReceiptAuditWithRequestBuilder(itemReceiptId itemReceiptId: Int32, itemReceiptAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemReceipt/{itemReceiptId}/audit/{itemReceiptAudit}"
    ...
    /**
     ...
     - parameter itemReceiptId: (path) Id of the itemReceipt to add a file to 
     - parameter fileName: (path) Name of file 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addItemReceiptFile(itemReceiptId itemReceiptId: Int32, fileName: String, completion: ((error: ErrorType?) -> Void)) {
        addItemReceiptFileWithRequestBuilder(itemReceiptId: itemReceiptId, fileName: fileName).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an itemReceipt
     - POST /v3.0/itemReceipt/{itemReceiptId}/file/{fileName}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addItemReceiptFileWithRequestBuilder(itemReceiptId itemReceiptId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemReceipt/{itemReceiptId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptId}", withString: "\(itemReceiptId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter itemReceiptId: (path) Id of the itemReceipt to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addItemReceiptFileByURL(body body: RecordFile, itemReceiptId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addItemReceiptFileByURLWithRequestBuilder(body: body, itemReceiptId: itemReceiptId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an itemReceipt by URL.
     - POST /v3.0/itemReceipt/{itemReceiptId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addItemReceiptFileByURLWithRequestBuilder(body body: RecordFile, itemReceiptId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemReceipt/{itemReceiptId}/file"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptId}", withString: "\(itemReceiptId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Add new tags for an itemReceipt.
     - PUT /v3.0/itemReceipt/{itemReceiptId}/tag/{itemReceiptTag}
    ...
    public class func addItemReceiptTagWithRequestBuilder(itemReceiptId itemReceiptId: Int32, itemReceiptTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemReceipt/{itemReceiptId}/tag/{itemReceiptTag}"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptId}", withString: "\(itemReceiptId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter itemReceiptId: (path) Id of the itemReceipt to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteItemReceiptFile(itemReceiptId itemReceiptId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteItemReceiptFileWithRequestBuilder(itemReceiptId: itemReceiptId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for an itemReceipt.
     - DELETE /v3.0/itemReceipt/{itemReceiptId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteItemReceiptFileWithRequestBuilder(itemReceiptId itemReceiptId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemReceipt/{itemReceiptId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptId}", withString: "\(itemReceiptId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for an itemReceipt.
     - DELETE /v3.0/itemReceipt/{itemReceiptId}/tag/{itemReceiptTag}
    ...
    /**
     Get a duplicated an itemReceipt by id
     - GET /v3.0/itemReceipt/duplicate/{itemReceiptId}
  ...
  "freezeAction" : "freezeAction"
    ...
    public class func getDuplicateItemReceiptByIdWithRequestBuilder(itemReceiptId itemReceiptId: Int32) -> RequestBuilder<ItemReceipt> {
        var path = "/v3.0/itemReceipt/duplicate/{itemReceiptId}"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptId}", withString: "\(itemReceiptId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
  ...
  "freezeAction" : "freezeAction"
    ...
    public class func getItemReceiptByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[ItemReceipt]> {
        let path = "/v3.0/itemReceipt/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get an itemReceipt by id
     - GET /v3.0/itemReceipt/{itemReceiptId}
  ...
  "freezeAction" : "freezeAction"
    ...
    public class func getItemReceiptByIdWithRequestBuilder(itemReceiptId itemReceiptId: Int32) -> RequestBuilder<ItemReceipt> {
        var path = "/v3.0/itemReceipt/{itemReceiptId}"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptId}", withString: "\(itemReceiptId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter itemReceiptId: (path) Id of the itemReceipt to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getItemReceiptFiles(itemReceiptId itemReceiptId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getItemReceiptFilesWithRequestBuilder(itemReceiptId: itemReceiptId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for an itemReceipt.
     - GET /v3.0/itemReceipt/{itemReceiptId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getItemReceiptFilesWithRequestBuilder(itemReceiptId itemReceiptId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemReceipt/{itemReceiptId}/file"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptId}", withString: "\(itemReceiptId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for an itemReceipt.
     - GET /v3.0/itemReceipt/{itemReceiptId}/tag
    ...
    public class func getItemReceiptTagsWithRequestBuilder(itemReceiptId itemReceiptId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemReceipt/{itemReceiptId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptId}", withString: "\(itemReceiptId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update an itemReceipt custom fields
     - PUT /v3.0/itemReceipt/customFields
    ...
    public class func updateItemReceiptCustomFieldsWithRequestBuilder(body body: ItemReceipt) -> RequestBuilder<Void> {
        let path = "/v3.0/itemReceipt/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
