...
public class OrderInvoiceTemplateLineItemDescriptionEnumAPI: APIBase {
    ...
    /**
     Get an orderInvoiceTemplateLineItemDescriptionEnum by id
     - GET /v3.0/orderInvoiceTemplateLineItemDescriptionEnum/{orderInvoiceTemplateLineItemDescriptionEnumId}
  ...
  "label" : "label"
    ...
    public class func getOrderInvoiceTemplateLineItemDescriptionEnumByIdWithRequestBuilder(orderInvoiceTemplateLineItemDescriptionEnumId orderInvoiceTemplateLineItemDescriptionEnumId: String) -> RequestBuilder<OrderInvoiceTemplateLineItemDescriptionEnum> {
        var path = "/v3.0/orderInvoiceTemplateLineItemDescriptionEnum/{orderInvoiceTemplateLineItemDescriptionEnumId}"
    ...
    /**
     Search orderInvoiceTemplateLineItemDescriptionEnums
     - GET /v3.0/orderInvoiceTemplateLineItemDescriptionEnum/search
  ...
  "label" : "label"
    ...
    public class func getOrderInvoiceTemplateLineItemDescriptionEnumBySearchTextWithRequestBuilder(searchText searchText: String? = nil, page: Int32? = nil, limit: Int32? = nil) -> RequestBuilder<[OrderInvoiceTemplateLineItemDescriptionEnum]> {
        let path = "/v3.0/orderInvoiceTemplateLineItemDescriptionEnum/search"
        let URLString = InfoplusAPI.basePath + path
