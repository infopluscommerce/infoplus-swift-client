...
public class ReceivingWorksheetAPI: APIBase {
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     Attach a file to a receivingWorksheet
     - POST /beta/receivingWorksheet/{receivingWorksheetId}/file/{fileName}
    ...
    public class func addReceivingWorksheetFileWithRequestBuilder(receivingWorksheetId receivingWorksheetId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/beta/receivingWorksheet/{receivingWorksheetId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{receivingWorksheetId}", withString: "\(receivingWorksheetId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Attach a file to a receivingWorksheet by URL.
     - POST /beta/receivingWorksheet/{receivingWorksheetId}/file
    ...
    public class func addReceivingWorksheetFileByURLWithRequestBuilder(body body: RecordFile, receivingWorksheetId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/receivingWorksheet/{receivingWorksheetId}/file"
        path = path.stringByReplacingOccurrencesOfString("{receivingWorksheetId}", withString: "\(receivingWorksheetId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Delete a file for a receivingWorksheet.
     - DELETE /beta/receivingWorksheet/{receivingWorksheetId}/file/{fileId}
    ...
    public class func deleteReceivingWorksheetFileWithRequestBuilder(receivingWorksheetId receivingWorksheetId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/receivingWorksheet/{receivingWorksheetId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{receivingWorksheetId}", withString: "\(receivingWorksheetId)", options: .LiteralSearch, range: nil)
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     Get the files for a receivingWorksheet.
     - GET /beta/receivingWorksheet/{receivingWorksheetId}/file
