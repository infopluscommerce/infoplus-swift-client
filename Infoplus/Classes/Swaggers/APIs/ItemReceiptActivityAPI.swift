...
public class ItemReceiptActivityAPI: APIBase {
  ...
  "itemMajorGroupName" : "itemMajorGroupName"
    ...
    public class func addItemReceiptActivityWithRequestBuilder(body body: ItemReceiptActivity) -> RequestBuilder<ItemReceiptActivity> {
        let path = "/v3.0/itemReceiptActivity"
    ...
    /**
     Add new audit for an itemReceiptActivity
     - PUT /v3.0/itemReceiptActivity/{itemReceiptActivityId}/audit/{itemReceiptActivityAudit}
    ...
    public class func addItemReceiptActivityAuditWithRequestBuilder(itemReceiptActivityId itemReceiptActivityId: Int32, itemReceiptActivityAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemReceiptActivity/{itemReceiptActivityId}/audit/{itemReceiptActivityAudit}"
    ...
    /**
     Attach a file to an itemReceiptActivity
     - POST /v3.0/itemReceiptActivity/{itemReceiptActivityId}/file/{fileName}
    ...
    public class func addItemReceiptActivityFileWithRequestBuilder(itemReceiptActivityId itemReceiptActivityId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemReceiptActivity/{itemReceiptActivityId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptActivityId}", withString: "\(itemReceiptActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Attach a file to an itemReceiptActivity by URL.
     - POST /v3.0/itemReceiptActivity/{itemReceiptActivityId}/file
    ...
    public class func addItemReceiptActivityFileByURLWithRequestBuilder(body body: RecordFile, itemReceiptActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemReceiptActivity/{itemReceiptActivityId}/file"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptActivityId}", withString: "\(itemReceiptActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for an itemReceiptActivity.
     - PUT /v3.0/itemReceiptActivity/{itemReceiptActivityId}/tag/{itemReceiptActivityTag}
    ...
    public class func addItemReceiptActivityTagWithRequestBuilder(itemReceiptActivityId itemReceiptActivityId: Int32, itemReceiptActivityTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemReceiptActivity/{itemReceiptActivityId}/tag/{itemReceiptActivityTag}"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptActivityId}", withString: "\(itemReceiptActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete an itemReceiptActivity
     - DELETE /v3.0/itemReceiptActivity/{itemReceiptActivityId}
    ...
    public class func deleteItemReceiptActivityWithRequestBuilder(itemReceiptActivityId itemReceiptActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemReceiptActivity/{itemReceiptActivityId}"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptActivityId}", withString: "\(itemReceiptActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Delete a file for an itemReceiptActivity.
     - DELETE /v3.0/itemReceiptActivity/{itemReceiptActivityId}/file/{fileId}
    ...
    public class func deleteItemReceiptActivityFileWithRequestBuilder(itemReceiptActivityId itemReceiptActivityId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemReceiptActivity/{itemReceiptActivityId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptActivityId}", withString: "\(itemReceiptActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for an itemReceiptActivity.
     - DELETE /v3.0/itemReceiptActivity/{itemReceiptActivityId}/tag/{itemReceiptActivityTag}
    ...
    /**
     Get a duplicated an itemReceiptActivity by id
     - GET /v3.0/itemReceiptActivity/duplicate/{itemReceiptActivityId}
  ...
  "itemMajorGroupName" : "itemMajorGroupName"
    ...
    public class func getDuplicateItemReceiptActivityByIdWithRequestBuilder(itemReceiptActivityId itemReceiptActivityId: Int32) -> RequestBuilder<ItemReceiptActivity> {
        var path = "/v3.0/itemReceiptActivity/duplicate/{itemReceiptActivityId}"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptActivityId}", withString: "\(itemReceiptActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search itemReceiptActivitys by filter
     - GET /v3.0/itemReceiptActivity/search
  ...
  "itemMajorGroupName" : "itemMajorGroupName"
    ...
    public class func getItemReceiptActivityByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[ItemReceiptActivity]> {
        let path = "/v3.0/itemReceiptActivity/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get an itemReceiptActivity by id
     - GET /v3.0/itemReceiptActivity/{itemReceiptActivityId}
  ...
  "itemMajorGroupName" : "itemMajorGroupName"
    ...
    /**
     Get the files for an itemReceiptActivity.
     - GET /v3.0/itemReceiptActivity/{itemReceiptActivityId}/file
    ...
    /**
     Get the tags for an itemReceiptActivity.
     - GET /v3.0/itemReceiptActivity/{itemReceiptActivityId}/tag
    ...
    public class func getItemReceiptActivityTagsWithRequestBuilder(itemReceiptActivityId itemReceiptActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemReceiptActivity/{itemReceiptActivityId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{itemReceiptActivityId}", withString: "\(itemReceiptActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
