...
public class FulfillmentLayoutPositionAPI: APIBase {
    ...
    /**
     Add new audit for a fulfillmentLayoutPosition
     - PUT /v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/audit/{fulfillmentLayoutPositionAudit}
    ...
    public class func addFulfillmentLayoutPositionAuditWithRequestBuilder(fulfillmentLayoutPositionId fulfillmentLayoutPositionId: Int32, fulfillmentLayoutPositionAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/audit/{fulfillmentLayoutPositionAudit}"
    ...
    /**
     Attach a file to a fulfillmentLayoutPosition
     - POST /v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/file/{fileName}
    ...
    public class func addFulfillmentLayoutPositionFileWithRequestBuilder(fulfillmentLayoutPositionId fulfillmentLayoutPositionId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentLayoutPositionId}", withString: "\(fulfillmentLayoutPositionId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter fulfillmentLayoutPositionId: (path) Id of the fulfillmentLayoutPosition to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addFulfillmentLayoutPositionFileByURL(body body: RecordFile, fulfillmentLayoutPositionId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addFulfillmentLayoutPositionFileByURLWithRequestBuilder(body: body, fulfillmentLayoutPositionId: fulfillmentLayoutPositionId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a fulfillmentLayoutPosition by URL.
     - POST /v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addFulfillmentLayoutPositionFileByURLWithRequestBuilder(body body: RecordFile, fulfillmentLayoutPositionId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/file"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentLayoutPositionId}", withString: "\(fulfillmentLayoutPositionId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Add new tags for a fulfillmentLayoutPosition.
     - PUT /v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/tag/{fulfillmentLayoutPositionTag}
    ...
    public class func addFulfillmentLayoutPositionTagWithRequestBuilder(fulfillmentLayoutPositionId fulfillmentLayoutPositionId: Int32, fulfillmentLayoutPositionTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/tag/{fulfillmentLayoutPositionTag}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentLayoutPositionId}", withString: "\(fulfillmentLayoutPositionId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter fulfillmentLayoutPositionId: (path) Id of the fulfillmentLayoutPosition to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteFulfillmentLayoutPositionFile(fulfillmentLayoutPositionId fulfillmentLayoutPositionId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteFulfillmentLayoutPositionFileWithRequestBuilder(fulfillmentLayoutPositionId: fulfillmentLayoutPositionId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a fulfillmentLayoutPosition.
     - DELETE /v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteFulfillmentLayoutPositionFileWithRequestBuilder(fulfillmentLayoutPositionId fulfillmentLayoutPositionId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentLayoutPositionId}", withString: "\(fulfillmentLayoutPositionId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a fulfillmentLayoutPosition.
     - DELETE /v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/tag/{fulfillmentLayoutPositionTag}
    ...
    /**
     Get a duplicated a fulfillmentLayoutPosition by id
     - GET /v3.0/fulfillmentLayoutPosition/duplicate/{fulfillmentLayoutPositionId}
  ...
  "lobId" : 1
    ...
    public class func getDuplicateFulfillmentLayoutPositionByIdWithRequestBuilder(fulfillmentLayoutPositionId fulfillmentLayoutPositionId: Int32) -> RequestBuilder<FulfillmentLayoutPosition> {
        var path = "/v3.0/fulfillmentLayoutPosition/duplicate/{fulfillmentLayoutPositionId}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentLayoutPositionId}", withString: "\(fulfillmentLayoutPositionId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search fulfillmentLayoutPositions by filter
     - GET /v3.0/fulfillmentLayoutPosition/search
  ...
  "lobId" : 1
    ...
    public class func getFulfillmentLayoutPositionByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[FulfillmentLayoutPosition]> {
        let path = "/v3.0/fulfillmentLayoutPosition/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a fulfillmentLayoutPosition by id
     - GET /v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}
  ...
  "lobId" : 1
    ...
    public class func getFulfillmentLayoutPositionByIdWithRequestBuilder(fulfillmentLayoutPositionId fulfillmentLayoutPositionId: Int32) -> RequestBuilder<FulfillmentLayoutPosition> {
        var path = "/v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentLayoutPositionId}", withString: "\(fulfillmentLayoutPositionId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter fulfillmentLayoutPositionId: (path) Id of the fulfillmentLayoutPosition to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getFulfillmentLayoutPositionFiles(fulfillmentLayoutPositionId fulfillmentLayoutPositionId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getFulfillmentLayoutPositionFilesWithRequestBuilder(fulfillmentLayoutPositionId: fulfillmentLayoutPositionId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a fulfillmentLayoutPosition.
     - GET /v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getFulfillmentLayoutPositionFilesWithRequestBuilder(fulfillmentLayoutPositionId fulfillmentLayoutPositionId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/file"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentLayoutPositionId}", withString: "\(fulfillmentLayoutPositionId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a fulfillmentLayoutPosition.
     - GET /v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/tag
    ...
    public class func getFulfillmentLayoutPositionTagsWithRequestBuilder(fulfillmentLayoutPositionId fulfillmentLayoutPositionId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentLayoutPosition/{fulfillmentLayoutPositionId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentLayoutPositionId}", withString: "\(fulfillmentLayoutPositionId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
