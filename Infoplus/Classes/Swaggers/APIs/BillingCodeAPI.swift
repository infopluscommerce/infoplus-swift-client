...
public class BillingCodeAPI: APIBase {
  ...
  "lobId" : 5
    ...
    /**
     Attach a file to a billingCode
     - POST /beta/billingCode/{billingCodeId}/file/{fileName}
    ...
    public class func addBillingCodeFileWithRequestBuilder(billingCodeId billingCodeId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/beta/billingCode/{billingCodeId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeId}", withString: "\(billingCodeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Attach a file to a billingCode by URL.
     - POST /beta/billingCode/{billingCodeId}/file
    ...
    public class func addBillingCodeFileByURLWithRequestBuilder(body body: RecordFile, billingCodeId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/billingCode/{billingCodeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeId}", withString: "\(billingCodeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Delete a file for a billingCode.
     - DELETE /beta/billingCode/{billingCodeId}/file/{fileId}
    ...
    public class func deleteBillingCodeFileWithRequestBuilder(billingCodeId billingCodeId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/billingCode/{billingCodeId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeId}", withString: "\(billingCodeId)", options: .LiteralSearch, range: nil)
  ...
  "lobId" : 5
    ...
    /**
     Get the files for a billingCode.
     - GET /beta/billingCode/{billingCodeId}/file
