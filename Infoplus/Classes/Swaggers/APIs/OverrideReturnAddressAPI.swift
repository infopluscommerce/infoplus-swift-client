...
public class OverrideReturnAddressAPI: APIBase {
    ...
    /**
     Create an overrideReturnAddress
     - POST /v3.0/overrideReturnAddress
  ...
  "lobId" : 6
    ...
    public class func addOverrideReturnAddressWithRequestBuilder(body body: OverrideReturnAddress) -> RequestBuilder<OverrideReturnAddress> {
        let path = "/v3.0/overrideReturnAddress"
    ...
    /**
     Add new audit for an overrideReturnAddress
     - PUT /v3.0/overrideReturnAddress/{overrideReturnAddressId}/audit/{overrideReturnAddressAudit}
    ...
    public class func addOverrideReturnAddressAuditWithRequestBuilder(overrideReturnAddressId overrideReturnAddressId: Int32, overrideReturnAddressAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/overrideReturnAddress/{overrideReturnAddressId}/audit/{overrideReturnAddressAudit}"
    ...
    /**
     Attach a file to an overrideReturnAddress
     - POST /v3.0/overrideReturnAddress/{overrideReturnAddressId}/file/{fileName}
    ...
    public class func addOverrideReturnAddressFileWithRequestBuilder(overrideReturnAddressId overrideReturnAddressId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/overrideReturnAddress/{overrideReturnAddressId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{overrideReturnAddressId}", withString: "\(overrideReturnAddressId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter overrideReturnAddressId: (path) Id of the overrideReturnAddress to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addOverrideReturnAddressFileByURL(body body: RecordFile, overrideReturnAddressId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addOverrideReturnAddressFileByURLWithRequestBuilder(body: body, overrideReturnAddressId: overrideReturnAddressId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an overrideReturnAddress by URL.
     - POST /v3.0/overrideReturnAddress/{overrideReturnAddressId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addOverrideReturnAddressFileByURLWithRequestBuilder(body body: RecordFile, overrideReturnAddressId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/overrideReturnAddress/{overrideReturnAddressId}/file"
        path = path.stringByReplacingOccurrencesOfString("{overrideReturnAddressId}", withString: "\(overrideReturnAddressId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for an overrideReturnAddress.
     - PUT /v3.0/overrideReturnAddress/{overrideReturnAddressId}/tag/{overrideReturnAddressTag}
    ...
    public class func addOverrideReturnAddressTagWithRequestBuilder(overrideReturnAddressId overrideReturnAddressId: Int32, overrideReturnAddressTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/overrideReturnAddress/{overrideReturnAddressId}/tag/{overrideReturnAddressTag}"
        path = path.stringByReplacingOccurrencesOfString("{overrideReturnAddressId}", withString: "\(overrideReturnAddressId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete an overrideReturnAddress
     - DELETE /v3.0/overrideReturnAddress/{overrideReturnAddressId}
    ...
    public class func deleteOverrideReturnAddressWithRequestBuilder(overrideReturnAddressId overrideReturnAddressId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/overrideReturnAddress/{overrideReturnAddressId}"
        path = path.stringByReplacingOccurrencesOfString("{overrideReturnAddressId}", withString: "\(overrideReturnAddressId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter overrideReturnAddressId: (path) Id of the overrideReturnAddress to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteOverrideReturnAddressFile(overrideReturnAddressId overrideReturnAddressId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteOverrideReturnAddressFileWithRequestBuilder(overrideReturnAddressId: overrideReturnAddressId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for an overrideReturnAddress.
     - DELETE /v3.0/overrideReturnAddress/{overrideReturnAddressId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteOverrideReturnAddressFileWithRequestBuilder(overrideReturnAddressId overrideReturnAddressId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/overrideReturnAddress/{overrideReturnAddressId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{overrideReturnAddressId}", withString: "\(overrideReturnAddressId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for an overrideReturnAddress.
     - DELETE /v3.0/overrideReturnAddress/{overrideReturnAddressId}/tag/{overrideReturnAddressTag}
    ...
    /**
     Get a duplicated an overrideReturnAddress by id
     - GET /v3.0/overrideReturnAddress/duplicate/{overrideReturnAddressId}
  ...
  "lobId" : 6
    ...
    public class func getDuplicateOverrideReturnAddressByIdWithRequestBuilder(overrideReturnAddressId overrideReturnAddressId: Int32) -> RequestBuilder<OverrideReturnAddress> {
        var path = "/v3.0/overrideReturnAddress/duplicate/{overrideReturnAddressId}"
        path = path.stringByReplacingOccurrencesOfString("{overrideReturnAddressId}", withString: "\(overrideReturnAddressId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search overrideReturnAddresses by filter
     - GET /v3.0/overrideReturnAddress/search
  ...
  "lobId" : 6
    ...
    public class func getOverrideReturnAddressByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[OverrideReturnAddress]> {
        let path = "/v3.0/overrideReturnAddress/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get an overrideReturnAddress by id
     - GET /v3.0/overrideReturnAddress/{overrideReturnAddressId}
  ...
  "lobId" : 6
    ...
    /**
     ...
     - parameter overrideReturnAddressId: (path) Id of the overrideReturnAddress to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getOverrideReturnAddressFiles(overrideReturnAddressId overrideReturnAddressId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getOverrideReturnAddressFilesWithRequestBuilder(overrideReturnAddressId: overrideReturnAddressId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for an overrideReturnAddress.
     - GET /v3.0/overrideReturnAddress/{overrideReturnAddressId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getOverrideReturnAddressFilesWithRequestBuilder(overrideReturnAddressId overrideReturnAddressId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/overrideReturnAddress/{overrideReturnAddressId}/file"
        path = path.stringByReplacingOccurrencesOfString("{overrideReturnAddressId}", withString: "\(overrideReturnAddressId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for an overrideReturnAddress.
     - GET /v3.0/overrideReturnAddress/{overrideReturnAddressId}/tag
    ...
    public class func getOverrideReturnAddressTagsWithRequestBuilder(overrideReturnAddressId overrideReturnAddressId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/overrideReturnAddress/{overrideReturnAddressId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{overrideReturnAddressId}", withString: "\(overrideReturnAddressId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update an overrideReturnAddress
     - PUT /v3.0/overrideReturnAddress
    ...
    /**
     Update an overrideReturnAddress custom fields
     - PUT /v3.0/overrideReturnAddress/customFields
    ...
    public class func updateOverrideReturnAddressCustomFieldsWithRequestBuilder(body body: OverrideReturnAddress) -> RequestBuilder<Void> {
        let path = "/v3.0/overrideReturnAddress/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
