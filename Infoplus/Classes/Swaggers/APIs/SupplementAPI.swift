...
public class SupplementAPI: APIBase {
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     Add new audit for a supplement
     - PUT /v3.0/supplement/{supplementId}/audit/{supplementAudit}
    ...
    public class func addSupplementAuditWithRequestBuilder(supplementId supplementId: Int32, supplementAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/supplement/{supplementId}/audit/{supplementAudit}"
    ...
    /**
     Attach a file to a supplement
     - POST /v3.0/supplement/{supplementId}/file/{fileName}
    ...
    public class func addSupplementFileWithRequestBuilder(supplementId supplementId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/supplement/{supplementId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{supplementId}", withString: "\(supplementId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter supplementId: (path) Id of the supplement to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addSupplementFileByURL(body body: RecordFile, supplementId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addSupplementFileByURLWithRequestBuilder(body: body, supplementId: supplementId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a supplement by URL.
     - POST /v3.0/supplement/{supplementId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addSupplementFileByURLWithRequestBuilder(body body: RecordFile, supplementId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/supplement/{supplementId}/file"
        path = path.stringByReplacingOccurrencesOfString("{supplementId}", withString: "\(supplementId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for a supplement.
     - PUT /v3.0/supplement/{supplementId}/tag/{supplementTag}
    ...
    public class func addSupplementTagWithRequestBuilder(supplementId supplementId: Int32, supplementTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/supplement/{supplementId}/tag/{supplementTag}"
        path = path.stringByReplacingOccurrencesOfString("{supplementId}", withString: "\(supplementId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a supplement
     - DELETE /v3.0/supplement/{supplementId}
    ...
    public class func deleteSupplementWithRequestBuilder(supplementId supplementId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/supplement/{supplementId}"
        path = path.stringByReplacingOccurrencesOfString("{supplementId}", withString: "\(supplementId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter supplementId: (path) Id of the supplement to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteSupplementFile(supplementId supplementId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteSupplementFileWithRequestBuilder(supplementId: supplementId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a supplement.
     - DELETE /v3.0/supplement/{supplementId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteSupplementFileWithRequestBuilder(supplementId supplementId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/supplement/{supplementId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{supplementId}", withString: "\(supplementId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a supplement.
     - DELETE /v3.0/supplement/{supplementId}/tag/{supplementTag}
    ...
    /**
     Get a duplicated a supplement by id
     - GET /v3.0/supplement/duplicate/{supplementId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getDuplicateSupplementByIdWithRequestBuilder(supplementId supplementId: Int32) -> RequestBuilder<Supplement> {
        var path = "/v3.0/supplement/duplicate/{supplementId}"
        path = path.stringByReplacingOccurrencesOfString("{supplementId}", withString: "\(supplementId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getSupplementByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[Supplement]> {
        let path = "/v3.0/supplement/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a supplement by id
     - GET /v3.0/supplement/{supplementId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     ...
     - parameter supplementId: (path) Id of the supplement to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getSupplementFiles(supplementId supplementId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getSupplementFilesWithRequestBuilder(supplementId: supplementId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a supplement.
     - GET /v3.0/supplement/{supplementId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getSupplementFilesWithRequestBuilder(supplementId supplementId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/supplement/{supplementId}/file"
        path = path.stringByReplacingOccurrencesOfString("{supplementId}", withString: "\(supplementId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a supplement.
     - GET /v3.0/supplement/{supplementId}/tag
    ...
    public class func getSupplementTagsWithRequestBuilder(supplementId supplementId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/supplement/{supplementId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{supplementId}", withString: "\(supplementId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update a supplement custom fields
     - PUT /v3.0/supplement/customFields
    ...
    public class func updateSupplementCustomFieldsWithRequestBuilder(body body: Supplement) -> RequestBuilder<Void> {
        let path = "/v3.0/supplement/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
