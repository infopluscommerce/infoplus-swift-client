...
public class CartonActivityAPI: APIBase {
  ...
  "cartonTypeId" : 1,
  "cartonInnerWidth" : 9.7029638000235660655334868351928889751434326171875,
  ...
  "slaStatus" : "slaStatus",
  "cartonInnerLength" : 0.8774076871421565559927557842456735670566558837890625,
  "billToZip" : "billToZip",
  ...
  "predefinedCartonId" : 5,
  "chargeRate" : 6.07389808578115175663469926803372800350189208984375,
  ...
  "cartonHeight" : 9.132027271330688478201409452594816684722900390625,
  ...
  "numberOfCartons" : 2,
  "cartonWidth" : 7.26052126480210358039357743109576404094696044921875,
  "cartonNo" : 5,
  "shipToZip" : "shipToZip",
  ...
  "billingQuantity" : 4.863159081028840091676102019846439361572265625,
  "residential" : false,
  ...
  "cartonWeight" : 7.93350688173715123951978966942988336086273193359375,
  ...
  "extendedCharge" : 8.2516257489237574418439180590212345123291015625,
  "numberOfLineItems" : 6,
  ...
  "cartonLength" : 4.67894798900584873990737833082675933837890625,
  ...
  "cartonInnerHeight" : 0.519900201872498524124921459588222205638885498046875,
  ...
  "backOrderStatus" : "backOrderStatus"
    ...
    /**
     Add new audit for a cartonActivity
     - PUT /v3.0/cartonActivity/{cartonActivityId}/audit/{cartonActivityAudit}
    ...
    public class func addCartonActivityAuditWithRequestBuilder(cartonActivityId cartonActivityId: Int32, cartonActivityAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/cartonActivity/{cartonActivityId}/audit/{cartonActivityAudit}"
    ...
    /**
     Attach a file to a cartonActivity
     - POST /v3.0/cartonActivity/{cartonActivityId}/file/{fileName}
    ...
    public class func addCartonActivityFileWithRequestBuilder(cartonActivityId cartonActivityId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/cartonActivity/{cartonActivityId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{cartonActivityId}", withString: "\(cartonActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Attach a file to a cartonActivity by URL.
     - POST /v3.0/cartonActivity/{cartonActivityId}/file
    ...
    public class func addCartonActivityFileByURLWithRequestBuilder(body body: RecordFile, cartonActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/cartonActivity/{cartonActivityId}/file"
        path = path.stringByReplacingOccurrencesOfString("{cartonActivityId}", withString: "\(cartonActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for a cartonActivity.
     - PUT /v3.0/cartonActivity/{cartonActivityId}/tag/{cartonActivityTag}
    ...
    public class func addCartonActivityTagWithRequestBuilder(cartonActivityId cartonActivityId: Int32, cartonActivityTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/cartonActivity/{cartonActivityId}/tag/{cartonActivityTag}"
        path = path.stringByReplacingOccurrencesOfString("{cartonActivityId}", withString: "\(cartonActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a cartonActivity
     - DELETE /v3.0/cartonActivity/{cartonActivityId}
    ...
    public class func deleteCartonActivityWithRequestBuilder(cartonActivityId cartonActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/cartonActivity/{cartonActivityId}"
        path = path.stringByReplacingOccurrencesOfString("{cartonActivityId}", withString: "\(cartonActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Delete a file for a cartonActivity.
     - DELETE /v3.0/cartonActivity/{cartonActivityId}/file/{fileId}
    ...
    public class func deleteCartonActivityFileWithRequestBuilder(cartonActivityId cartonActivityId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/cartonActivity/{cartonActivityId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{cartonActivityId}", withString: "\(cartonActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a cartonActivity.
     - DELETE /v3.0/cartonActivity/{cartonActivityId}/tag/{cartonActivityTag}
    ...
    /**
     Search cartonActivitys by filter
     - GET /v3.0/cartonActivity/search
  ...
  "backOrderStatus" : "backOrderStatus"
    ...
    public class func getCartonActivityByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[CartonActivity]> {
        let path = "/v3.0/cartonActivity/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a cartonActivity by id
     - GET /v3.0/cartonActivity/{cartonActivityId}
  ...
  "backOrderStatus" : "backOrderStatus"
    ...
    /**
     Get the files for a cartonActivity.
     - GET /v3.0/cartonActivity/{cartonActivityId}/file
    ...
    /**
     Get the tags for a cartonActivity.
     - GET /v3.0/cartonActivity/{cartonActivityId}/tag
    ...
    public class func getCartonActivityTagsWithRequestBuilder(cartonActivityId cartonActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/cartonActivity/{cartonActivityId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{cartonActivityId}", withString: "\(cartonActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a duplicated a cartonActivity by id
     - GET /v3.0/cartonActivity/duplicate/{cartonActivityId}
  ...
  "backOrderStatus" : "backOrderStatus"
    ...
    public class func getDuplicateCartonActivityByIdWithRequestBuilder(cartonActivityId cartonActivityId: Int32) -> RequestBuilder<CartonActivity> {
        var path = "/v3.0/cartonActivity/duplicate/{cartonActivityId}"
        path = path.stringByReplacingOccurrencesOfString("{cartonActivityId}", withString: "\(cartonActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
