...
public class CartonActivityAPI: APIBase {
  ...
  "cartonTypeId" : 4,
  "cartonInnerWidth" : 0.519900201872498524124921459588222205638885498046875,
  ...
  "slaStatus" : "slaStatus",
  "cartonInnerLength" : 9.7029638000235660655334868351928889751434326171875,
  "billToZip" : "billToZip",
  ...
  "predefinedCartonId" : 4,
  "chargeRate" : 8.2516257489237574418439180590212345123291015625,
  "shippingSystemName" : "shippingSystemName",
  "warehouseId" : 5,
  "billToAttention" : "billToAttention",
  "subtotal" : 0.885137473901165261480628032586537301540374755859375,
  "cartonHeight" : 0.8774076871421565559927557842456735670566558837890625,
  "integrationPartnerName" : "integrationPartnerName",
  "status" : "status",
  "warehouseServiceLevelId" : 1,
  "alternateUsage" : "alternateUsage",
  "authorizationAmount" : 7.14353804701230643559028976596891880035400390625,
  "freight" : 6.96511769763884558415156789124011993408203125,
  "cartonCreateDate" : "2000-01-23T04:56:07.000+00:00",
  "billToCompany" : "billToCompany",
  "productionType" : "productionType",
  "taxOnFreight" : 7.05877035158235610623478351044468581676483154296875,
  "shipToCompany" : "shipToCompany",
  "warehouseName" : "warehouseName",
  "numberOfCartons" : 2,
  "cartonWidth" : 9.132027271330688478201409452594816684722900390625,
  "cartonNo" : 5,
  "shipToZip" : "shipToZip",
  "cartonAbbr" : "cartonAbbr",
  "customerPONo" : "customerPONo",
  "lastShipDate" : "2000-01-23T04:56:07.000+00:00",
  "shipToAttention" : "shipToAttention",
  "createDate" : "2000-01-23T04:56:07.000+00:00",
  "distributionCharges" : 0.10263654006109401706225980888120830059051513671875,
  "numberOfPallets" : 6,
  "legacyRestrictionType" : "legacyRestrictionType",
  "shipToPhone" : "shipToPhone",
  "needByDate" : "2000-01-23T04:56:07.000+00:00",
  "orderWeightLbs" : 1.2846590061165319429647979632136411964893341064453125,
  "shipCode" : "shipCode",
  "chargedFreightAmount" : 1.024645700144157789424070870154537260532379150390625,
  "billingQuantity" : 6.07389808578115175663469926803372800350189208984375,
  "residential" : false,
  ...
  "totalDiscount" : 8.9695787981969115065794539987109601497650146484375,
  "priorityCode" : 9,
  "completionStatus" : "completionStatus",
  "mediaCode" : "mediaCode",
  "customerOrderNo" : "customerOrderNo",
  "packingSlipTemplateId" : 3,
  "estimatedNumberOfPicks" : 5,
  "cartonWeight" : 5.5073869641798811613853104063309729099273681640625,
  "predefinedCartonLabel" : "predefinedCartonLabel",
  "branchCustomerType" : "branchCustomerType",
  "totalQty" : 7,
  "warehouseServiceTypeId" : 4,
  ...
  "shippingCharge" : 4.6523964329332461176136348512955009937286376953125,
  "manifestId" : 4,
  ...
  "totalPaid" : 3.093745262666447448651751983561553061008453369140625,
  "orderSourceName" : "orderSourceName",
  "tax" : 6.51918095101838179772357761976309120655059814453125,
  ...
  "extendedCharge" : 4.4596050349586793259959449642337858676910400390625,
  "numberOfLineItems" : 6,
  "retailFreightAmount" : 6.8468526983526398765889098285697400569915771484375,
  "orderEstimatedWeightLbs" : 2.884162126668780246063761296682059764862060546875,
  ...
  "shipmentConfirmationEmailTemplateId" : 4,
  ...
  "cartonLength" : 7.26052126480210358039357743109576404094696044921875,
  "orderCreateDate" : "2000-01-23T04:56:07.000+00:00",
  "shipVia" : "shipVia",
  "total" : 6.70401929795003592715829654480330646038055419921875,
  "slaDate" : "2000-01-23T04:56:07.000+00:00",
  "weightLbs" : 7.3862819483858839220147274318151175975799560546875,
  "shipToCountry" : "shipToCountry",
  "balanceDue" : 3.35319334701124294184637619764544069766998291015625,
  "orderLoadProgramId" : 9,
  "cartonInnerHeight" : 7.93350688173715123951978966942988336086273193359375,
  ...
  "backOrderStatus" : "backOrderStatus"
    ...
    /**
     ...
     - parameter cartonActivityId: (path) Id of the cartonActivity to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addCartonActivityFileByURL(body body: RecordFile, cartonActivityId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addCartonActivityFileByURLWithRequestBuilder(body: body, cartonActivityId: cartonActivityId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a cartonActivity by URL.
     - POST /beta/cartonActivity/{cartonActivityId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addCartonActivityFileByURLWithRequestBuilder(body body: RecordFile, cartonActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/cartonActivity/{cartonActivityId}/file"
        path = path.stringByReplacingOccurrencesOfString("{cartonActivityId}", withString: "\(cartonActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     ...
     - parameter cartonActivityId: (path) Id of the cartonActivity to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteCartonActivityFile(cartonActivityId cartonActivityId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteCartonActivityFileWithRequestBuilder(cartonActivityId: cartonActivityId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a cartonActivity.
     - DELETE /beta/cartonActivity/{cartonActivityId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteCartonActivityFileWithRequestBuilder(cartonActivityId cartonActivityId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/cartonActivity/{cartonActivityId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{cartonActivityId}", withString: "\(cartonActivityId)", options: .LiteralSearch, range: nil)
  ...
  "backOrderStatus" : "backOrderStatus"
    ...
    /**
     ...
     - parameter cartonActivityId: (path) Id of the cartonActivity to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getCartonActivityFiles(cartonActivityId cartonActivityId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getCartonActivityFilesWithRequestBuilder(cartonActivityId: cartonActivityId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a cartonActivity.
     - GET /beta/cartonActivity/{cartonActivityId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getCartonActivityFilesWithRequestBuilder(cartonActivityId cartonActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/cartonActivity/{cartonActivityId}/file"
        path = path.stringByReplacingOccurrencesOfString("{cartonActivityId}", withString: "\(cartonActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
