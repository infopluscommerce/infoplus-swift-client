...
public class InvoiceWorksheetAPI: APIBase {
  ...
  "status" : "status"
    ...
    /**
     Attach a file to an invoiceWorksheet by URL.
     - POST /beta/invoiceWorksheet/{invoiceWorksheetId}/file
    ...
    public class func addInvoiceWorksheetFileByURLWithRequestBuilder(body body: RecordFile, invoiceWorksheetId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/invoiceWorksheet/{invoiceWorksheetId}/file"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetId}", withString: "\(invoiceWorksheetId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Delete a file for an invoiceWorksheet.
     - DELETE /beta/invoiceWorksheet/{invoiceWorksheetId}/file/{fileId}
    ...
    public class func deleteInvoiceWorksheetFileWithRequestBuilder(invoiceWorksheetId invoiceWorksheetId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/invoiceWorksheet/{invoiceWorksheetId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetId}", withString: "\(invoiceWorksheetId)", options: .LiteralSearch, range: nil)
  ...
  "status" : "status"
    ...
    /**
     Get the files for an invoiceWorksheet.
     - GET /beta/invoiceWorksheet/{invoiceWorksheetId}/file
