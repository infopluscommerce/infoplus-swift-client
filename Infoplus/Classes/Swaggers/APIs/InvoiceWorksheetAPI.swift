...
public class InvoiceWorksheetAPI: APIBase {
  ...
  "status" : "status"
    ...
    public class func addInvoiceWorksheetWithRequestBuilder(body body: InvoiceWorksheet) -> RequestBuilder<InvoiceWorksheet> {
        let path = "/v3.0/invoiceWorksheet"
    ...
    /**
     Add new audit for an invoiceWorksheet
     - PUT /v3.0/invoiceWorksheet/{invoiceWorksheetId}/audit/{invoiceWorksheetAudit}
    ...
    public class func addInvoiceWorksheetAuditWithRequestBuilder(invoiceWorksheetId invoiceWorksheetId: Int32, invoiceWorksheetAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheet/{invoiceWorksheetId}/audit/{invoiceWorksheetAudit}"
    ...
    /**
     Attach a file to an invoiceWorksheet
     - POST /v3.0/invoiceWorksheet/{invoiceWorksheetId}/file/{fileName}
    ...
    public class func addInvoiceWorksheetFileWithRequestBuilder(invoiceWorksheetId invoiceWorksheetId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheet/{invoiceWorksheetId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetId}", withString: "\(invoiceWorksheetId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter invoiceWorksheetId: (path) Id of the invoiceWorksheet to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addInvoiceWorksheetFileByURL(body body: RecordFile, invoiceWorksheetId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addInvoiceWorksheetFileByURLWithRequestBuilder(body: body, invoiceWorksheetId: invoiceWorksheetId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an invoiceWorksheet by URL.
     - POST /v3.0/invoiceWorksheet/{invoiceWorksheetId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addInvoiceWorksheetFileByURLWithRequestBuilder(body body: RecordFile, invoiceWorksheetId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheet/{invoiceWorksheetId}/file"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetId}", withString: "\(invoiceWorksheetId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for an invoiceWorksheet.
     - PUT /v3.0/invoiceWorksheet/{invoiceWorksheetId}/tag/{invoiceWorksheetTag}
    ...
    public class func addInvoiceWorksheetTagWithRequestBuilder(invoiceWorksheetId invoiceWorksheetId: Int32, invoiceWorksheetTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheet/{invoiceWorksheetId}/tag/{invoiceWorksheetTag}"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetId}", withString: "\(invoiceWorksheetId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete an invoiceWorksheet
     - DELETE /v3.0/invoiceWorksheet/{invoiceWorksheetId}
    ...
    public class func deleteInvoiceWorksheetWithRequestBuilder(invoiceWorksheetId invoiceWorksheetId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheet/{invoiceWorksheetId}"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetId}", withString: "\(invoiceWorksheetId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter invoiceWorksheetId: (path) Id of the invoiceWorksheet to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteInvoiceWorksheetFile(invoiceWorksheetId invoiceWorksheetId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteInvoiceWorksheetFileWithRequestBuilder(invoiceWorksheetId: invoiceWorksheetId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for an invoiceWorksheet.
     - DELETE /v3.0/invoiceWorksheet/{invoiceWorksheetId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteInvoiceWorksheetFileWithRequestBuilder(invoiceWorksheetId invoiceWorksheetId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheet/{invoiceWorksheetId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetId}", withString: "\(invoiceWorksheetId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for an invoiceWorksheet.
     - DELETE /v3.0/invoiceWorksheet/{invoiceWorksheetId}/tag/{invoiceWorksheetTag}
    ...
    /**
     Get a duplicated an invoiceWorksheet by id
     - GET /v3.0/invoiceWorksheet/duplicate/{invoiceWorksheetId}
  ...
  "status" : "status"
    ...
    public class func getDuplicateInvoiceWorksheetByIdWithRequestBuilder(invoiceWorksheetId invoiceWorksheetId: Int32) -> RequestBuilder<InvoiceWorksheet> {
        var path = "/v3.0/invoiceWorksheet/duplicate/{invoiceWorksheetId}"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetId}", withString: "\(invoiceWorksheetId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search invoiceWorksheets by filter
     - GET /v3.0/invoiceWorksheet/search
  ...
  "status" : "status"
    ...
    public class func getInvoiceWorksheetByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[InvoiceWorksheet]> {
        let path = "/v3.0/invoiceWorksheet/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get an invoiceWorksheet by id
     - GET /v3.0/invoiceWorksheet/{invoiceWorksheetId}
  ...
  "status" : "status"
    ...
    /**
     ...
     - parameter invoiceWorksheetId: (path) Id of the invoiceWorksheet to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getInvoiceWorksheetFiles(invoiceWorksheetId invoiceWorksheetId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getInvoiceWorksheetFilesWithRequestBuilder(invoiceWorksheetId: invoiceWorksheetId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for an invoiceWorksheet.
     - GET /v3.0/invoiceWorksheet/{invoiceWorksheetId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getInvoiceWorksheetFilesWithRequestBuilder(invoiceWorksheetId invoiceWorksheetId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheet/{invoiceWorksheetId}/file"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetId}", withString: "\(invoiceWorksheetId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for an invoiceWorksheet.
     - GET /v3.0/invoiceWorksheet/{invoiceWorksheetId}/tag
    ...
    public class func getInvoiceWorksheetTagsWithRequestBuilder(invoiceWorksheetId invoiceWorksheetId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheet/{invoiceWorksheetId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetId}", withString: "\(invoiceWorksheetId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
