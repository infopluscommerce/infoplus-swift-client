...
public class OrderSourceAPI: APIBase {
  ...
  "lineItemEachGS1128TemplateId" : 6,
  "packingSlipId" : 1,
  "customFields" : {
    "key" : "{}"
  },
  "orderConfirmationEmailId" : 5,
  "palletGS1128TemplateId" : 2,
  "defaultServiceTypeId" : 3,
  "requireCartonizedASN" : false,
  "palletGS1128NoOfCopies" : 4,
  "id" : 0,
  ...
  "masterCartonGS1128TemplateId" : 7,
  "usesReservations" : false,
  "cartonGS1128NoOfCopies" : 1,
  "lineItemEachGS1128NoOfCopies" : 7,
  "outForDeliveryConfirmationEmailId" : 7,
  "cartonGS1128TemplateId" : 1,
  "packingNotes" : "packingNotes",
  "masterCartonGS1128NoOfCopies" : 1,
  "name" : "name"
}}]
    ...
    /**
     Add new audit for an orderSource
     - PUT /v3.0/orderSource/{orderSourceId}/audit/{orderSourceAudit}
    ...
    public class func addOrderSourceAuditWithRequestBuilder(orderSourceId orderSourceId: Int32, orderSourceAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/orderSource/{orderSourceId}/audit/{orderSourceAudit}"
    ...
    /**
     Attach a file to an orderSource
     - POST /v3.0/orderSource/{orderSourceId}/file/{fileName}
    ...
    public class func addOrderSourceFileWithRequestBuilder(orderSourceId orderSourceId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/orderSource/{orderSourceId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{orderSourceId}", withString: "\(orderSourceId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter orderSourceId: (path) Id of the orderSource to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addOrderSourceFileByURL(body body: RecordFile, orderSourceId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addOrderSourceFileByURLWithRequestBuilder(body: body, orderSourceId: orderSourceId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an orderSource by URL.
     - POST /v3.0/orderSource/{orderSourceId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addOrderSourceFileByURLWithRequestBuilder(body body: RecordFile, orderSourceId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/orderSource/{orderSourceId}/file"
        path = path.stringByReplacingOccurrencesOfString("{orderSourceId}", withString: "\(orderSourceId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for an orderSource.
     - PUT /v3.0/orderSource/{orderSourceId}/tag/{orderSourceTag}
    ...
    public class func addOrderSourceTagWithRequestBuilder(orderSourceId orderSourceId: Int32, orderSourceTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/orderSource/{orderSourceId}/tag/{orderSourceTag}"
        path = path.stringByReplacingOccurrencesOfString("{orderSourceId}", withString: "\(orderSourceId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete an orderSource
     - DELETE /v3.0/orderSource/{orderSourceId}
    ...
    public class func deleteOrderSourceWithRequestBuilder(orderSourceId orderSourceId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/orderSource/{orderSourceId}"
        path = path.stringByReplacingOccurrencesOfString("{orderSourceId}", withString: "\(orderSourceId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter orderSourceId: (path) Id of the orderSource to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteOrderSourceFile(orderSourceId orderSourceId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteOrderSourceFileWithRequestBuilder(orderSourceId: orderSourceId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for an orderSource.
     - DELETE /v3.0/orderSource/{orderSourceId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteOrderSourceFileWithRequestBuilder(orderSourceId orderSourceId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/orderSource/{orderSourceId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{orderSourceId}", withString: "\(orderSourceId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for an orderSource.
     - DELETE /v3.0/orderSource/{orderSourceId}/tag/{orderSourceTag}
    ...
    /**
     Get a duplicated an orderSource by id
     - GET /v3.0/orderSource/duplicate/{orderSourceId}
  ...
  "name" : "name"
    ...
    public class func getDuplicateOrderSourceByIdWithRequestBuilder(orderSourceId orderSourceId: Int32) -> RequestBuilder<OrderSource> {
        var path = "/v3.0/orderSource/duplicate/{orderSourceId}"
        path = path.stringByReplacingOccurrencesOfString("{orderSourceId}", withString: "\(orderSourceId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
  ...
  "name" : "name"
    ...
    public class func getOrderSourceByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[OrderSource]> {
        let path = "/v3.0/orderSource/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get an orderSource by id
     - GET /v3.0/orderSource/{orderSourceId}
  ...
  "name" : "name"
    ...
    /**
     ...
     - parameter orderSourceId: (path) Id of the orderSource to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getOrderSourceFiles(orderSourceId orderSourceId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getOrderSourceFilesWithRequestBuilder(orderSourceId: orderSourceId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for an orderSource.
     - GET /v3.0/orderSource/{orderSourceId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getOrderSourceFilesWithRequestBuilder(orderSourceId orderSourceId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/orderSource/{orderSourceId}/file"
        path = path.stringByReplacingOccurrencesOfString("{orderSourceId}", withString: "\(orderSourceId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for an orderSource.
     - GET /v3.0/orderSource/{orderSourceId}/tag
    ...
    public class func getOrderSourceTagsWithRequestBuilder(orderSourceId orderSourceId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/orderSource/{orderSourceId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{orderSourceId}", withString: "\(orderSourceId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update an orderSource custom fields
     - PUT /v3.0/orderSource/customFields
    ...
    public class func updateOrderSourceCustomFieldsWithRequestBuilder(body body: OrderSource) -> RequestBuilder<Void> {
        let path = "/v3.0/orderSource/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
