...
public class OrderSourceAPI: APIBase {
  ...
  "name" : "name"
    ...
    /**
     Attach a file to an orderSource by URL.
     - POST /beta/orderSource/{orderSourceId}/file
    ...
    public class func addOrderSourceFileByURLWithRequestBuilder(body body: RecordFile, orderSourceId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/orderSource/{orderSourceId}/file"
        path = path.stringByReplacingOccurrencesOfString("{orderSourceId}", withString: "\(orderSourceId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Delete a file for an orderSource.
     - DELETE /beta/orderSource/{orderSourceId}/file/{fileId}
    ...
    public class func deleteOrderSourceFileWithRequestBuilder(orderSourceId orderSourceId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/orderSource/{orderSourceId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{orderSourceId}", withString: "\(orderSourceId)", options: .LiteralSearch, range: nil)
  ...
  "name" : "name"
    ...
    /**
     Get the files for an orderSource.
     - GET /beta/orderSource/{orderSourceId}/file
