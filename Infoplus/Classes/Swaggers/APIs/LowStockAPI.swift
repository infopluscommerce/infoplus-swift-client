...
public class LowStockAPI: APIBase {
    ...
    /**
     Add new audit for a lowStock
     - PUT /v3.0/lowStock/{lowStockId}/audit/{lowStockAudit}
    ...
    public class func addLowStockAuditWithRequestBuilder(lowStockId lowStockId: Int32, lowStockAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/lowStock/{lowStockId}/audit/{lowStockAudit}"
    ...
    /**
     ...
     - parameter lowStockId: (path) Id of the lowStock to add a file to 
     - parameter fileName: (path) Name of file 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addLowStockFile(lowStockId lowStockId: Int32, fileName: String, completion: ((error: ErrorType?) -> Void)) {
        addLowStockFileWithRequestBuilder(lowStockId: lowStockId, fileName: fileName).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a lowStock
     - POST /v3.0/lowStock/{lowStockId}/file/{fileName}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addLowStockFileWithRequestBuilder(lowStockId lowStockId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/lowStock/{lowStockId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{lowStockId}", withString: "\(lowStockId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter lowStockId: (path) Id of the lowStock to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addLowStockFileByURL(body body: RecordFile, lowStockId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addLowStockFileByURLWithRequestBuilder(body: body, lowStockId: lowStockId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a lowStock by URL.
     - POST /v3.0/lowStock/{lowStockId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addLowStockFileByURLWithRequestBuilder(body body: RecordFile, lowStockId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/lowStock/{lowStockId}/file"
        path = path.stringByReplacingOccurrencesOfString("{lowStockId}", withString: "\(lowStockId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Add new tags for a lowStock.
     - PUT /v3.0/lowStock/{lowStockId}/tag/{lowStockTag}
    ...
    public class func addLowStockTagWithRequestBuilder(lowStockId lowStockId: Int32, lowStockTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/lowStock/{lowStockId}/tag/{lowStockTag}"
        path = path.stringByReplacingOccurrencesOfString("{lowStockId}", withString: "\(lowStockId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter lowStockId: (path) Id of the lowStock to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteLowStockFile(lowStockId lowStockId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteLowStockFileWithRequestBuilder(lowStockId: lowStockId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a lowStock.
     - DELETE /v3.0/lowStock/{lowStockId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteLowStockFileWithRequestBuilder(lowStockId lowStockId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/lowStock/{lowStockId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{lowStockId}", withString: "\(lowStockId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a lowStock.
     - DELETE /v3.0/lowStock/{lowStockId}/tag/{lowStockTag}
    ...
    /**
     Get a duplicated a lowStock by id
     - GET /v3.0/lowStock/duplicate/{lowStockId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getDuplicateLowStockByIdWithRequestBuilder(lowStockId lowStockId: Int32) -> RequestBuilder<LowStock> {
        var path = "/v3.0/lowStock/duplicate/{lowStockId}"
        path = path.stringByReplacingOccurrencesOfString("{lowStockId}", withString: "\(lowStockId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getLowStockByIdWithRequestBuilder(lowStockId lowStockId: Int32) -> RequestBuilder<LowStock> {
        var path = "/v3.0/lowStock/{lowStockId}"
        path = path.stringByReplacingOccurrencesOfString("{lowStockId}", withString: "\(lowStockId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter lowStockId: (path) Id of the lowStock to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getLowStockFiles(lowStockId lowStockId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getLowStockFilesWithRequestBuilder(lowStockId: lowStockId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a lowStock.
     - GET /v3.0/lowStock/{lowStockId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getLowStockFilesWithRequestBuilder(lowStockId lowStockId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/lowStock/{lowStockId}/file"
        path = path.stringByReplacingOccurrencesOfString("{lowStockId}", withString: "\(lowStockId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a lowStock.
     - GET /v3.0/lowStock/{lowStockId}/tag
    ...
    public class func getLowStockTagsWithRequestBuilder(lowStockId lowStockId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/lowStock/{lowStockId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{lowStockId}", withString: "\(lowStockId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
