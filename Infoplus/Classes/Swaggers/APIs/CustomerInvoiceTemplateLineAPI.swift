...
public class CustomerInvoiceTemplateLineAPI: APIBase {
     ...
     */
    public class func addCustomerInvoiceTemplateLineAudit(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int, customerInvoiceTemplateLineAudit: String, completion: ((error: ErrorType?) -> Void)) {
     ...
     */
    public class func addCustomerInvoiceTemplateLineAuditWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int, customerInvoiceTemplateLineAudit: String) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addCustomerInvoiceTemplateLineTag(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int, customerInvoiceTemplateLineTag: String, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addCustomerInvoiceTemplateLineTagWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int, customerInvoiceTemplateLineTag: String) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteCustomerInvoiceTemplateLine(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteCustomerInvoiceTemplateLineWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteCustomerInvoiceTemplateLineTag(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int, customerInvoiceTemplateLineTag: String, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteCustomerInvoiceTemplateLineTagWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int, customerInvoiceTemplateLineTag: String) -> RequestBuilder<Void> {
        var path = "/beta/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/tag/{customerInvoiceTemplateLineTag}"
        path = path.stringByReplacingOccurrencesOfString("{customerInvoiceTemplateLineId}", withString: "\(customerInvoiceTemplateLineId)", options: .LiteralSearch, range: nil)
        path = path.stringByReplacingOccurrencesOfString("{customerInvoiceTemplateLineTag}", withString: "\(customerInvoiceTemplateLineTag)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getCustomerInvoiceTemplateLineByFilter(filter filter: String?, page: Int?, limit: Int?, sort: String?, completion: ((data: [CustomerInvoiceTemplateLine]?, error: ErrorType?) -> Void)) {
  ...
  "invoiceTemplateId" : 123
     ...
     */
    public class func getCustomerInvoiceTemplateLineByFilterWithRequestBuilder(filter filter: String?, page: Int?, limit: Int?, sort: String?) -> RequestBuilder<[CustomerInvoiceTemplateLine]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getCustomerInvoiceTemplateLineById(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int, completion: ((data: CustomerInvoiceTemplateLine?, error: ErrorType?) -> Void)) {
  ...
  "invoiceTemplateId" : 123
     ...
     - returns: RequestBuilder<CustomerInvoiceTemplateLine> 
     */
    public class func getCustomerInvoiceTemplateLineByIdWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int) -> RequestBuilder<CustomerInvoiceTemplateLine> {
        var path = "/beta/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}"
        path = path.stringByReplacingOccurrencesOfString("{customerInvoiceTemplateLineId}", withString: "\(customerInvoiceTemplateLineId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getCustomerInvoiceTemplateLineTags(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getCustomerInvoiceTemplateLineTagsWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getDuplicateCustomerInvoiceTemplateLineById(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int, completion: ((data: CustomerInvoiceTemplateLine?, error: ErrorType?) -> Void)) {
  ...
  "invoiceTemplateId" : 123
     ...
     - returns: RequestBuilder<CustomerInvoiceTemplateLine> 
     */
    public class func getDuplicateCustomerInvoiceTemplateLineByIdWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int) -> RequestBuilder<CustomerInvoiceTemplateLine> {
