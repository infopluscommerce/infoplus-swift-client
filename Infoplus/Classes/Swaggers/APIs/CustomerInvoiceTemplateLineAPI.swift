...
public class CustomerInvoiceTemplateLineAPI: APIBase {
    ...
    /**
     Add new audit for a customerInvoiceTemplateLine
     - PUT /v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/audit/{customerInvoiceTemplateLineAudit}
    ...
    public class func addCustomerInvoiceTemplateLineAuditWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int32, customerInvoiceTemplateLineAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/audit/{customerInvoiceTemplateLineAudit}"
    ...
    /**
     ...
     - parameter customerInvoiceTemplateLineId: (path) Id of the customerInvoiceTemplateLine to add a file to 
     - parameter fileName: (path) Name of file 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addCustomerInvoiceTemplateLineFile(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int32, fileName: String, completion: ((error: ErrorType?) -> Void)) {
        addCustomerInvoiceTemplateLineFileWithRequestBuilder(customerInvoiceTemplateLineId: customerInvoiceTemplateLineId, fileName: fileName).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a customerInvoiceTemplateLine
     - POST /v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/file/{fileName}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addCustomerInvoiceTemplateLineFileWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{customerInvoiceTemplateLineId}", withString: "\(customerInvoiceTemplateLineId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter customerInvoiceTemplateLineId: (path) Id of the customerInvoiceTemplateLine to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addCustomerInvoiceTemplateLineFileByURL(body body: RecordFile, customerInvoiceTemplateLineId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addCustomerInvoiceTemplateLineFileByURLWithRequestBuilder(body: body, customerInvoiceTemplateLineId: customerInvoiceTemplateLineId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a customerInvoiceTemplateLine by URL.
     - POST /v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addCustomerInvoiceTemplateLineFileByURLWithRequestBuilder(body body: RecordFile, customerInvoiceTemplateLineId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/file"
        path = path.stringByReplacingOccurrencesOfString("{customerInvoiceTemplateLineId}", withString: "\(customerInvoiceTemplateLineId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Add new tags for a customerInvoiceTemplateLine.
     - PUT /v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/tag/{customerInvoiceTemplateLineTag}
    ...
    public class func addCustomerInvoiceTemplateLineTagWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int32, customerInvoiceTemplateLineTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/tag/{customerInvoiceTemplateLineTag}"
        path = path.stringByReplacingOccurrencesOfString("{customerInvoiceTemplateLineId}", withString: "\(customerInvoiceTemplateLineId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a customerInvoiceTemplateLine
     - DELETE /v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}
    ...
    public class func deleteCustomerInvoiceTemplateLineWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}"
        path = path.stringByReplacingOccurrencesOfString("{customerInvoiceTemplateLineId}", withString: "\(customerInvoiceTemplateLineId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter customerInvoiceTemplateLineId: (path) Id of the customerInvoiceTemplateLine to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteCustomerInvoiceTemplateLineFile(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteCustomerInvoiceTemplateLineFileWithRequestBuilder(customerInvoiceTemplateLineId: customerInvoiceTemplateLineId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a customerInvoiceTemplateLine.
     - DELETE /v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteCustomerInvoiceTemplateLineFileWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{customerInvoiceTemplateLineId}", withString: "\(customerInvoiceTemplateLineId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a customerInvoiceTemplateLine.
     - DELETE /v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/tag/{customerInvoiceTemplateLineTag}
    ...
    /**
     Search customerInvoiceTemplateLines by filter
     - GET /v3.0/customerInvoiceTemplateLine/search
  ...
  "scriptId" : 3,
  "billingRuleId" : 7,
  "minimumCharge" : 9.301444243932575517419536481611430644989013671875,
  "id" : 1,
  ...
  "invoiceTemplateId" : 2
    ...
    public class func getCustomerInvoiceTemplateLineByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[CustomerInvoiceTemplateLine]> {
        let path = "/v3.0/customerInvoiceTemplateLine/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a customerInvoiceTemplateLine by id
     - GET /v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}
  ...
  "invoiceTemplateId" : 2
    ...
    /**
     ...
     - parameter customerInvoiceTemplateLineId: (path) Id of the customerInvoiceTemplateLine to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getCustomerInvoiceTemplateLineFiles(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getCustomerInvoiceTemplateLineFilesWithRequestBuilder(customerInvoiceTemplateLineId: customerInvoiceTemplateLineId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a customerInvoiceTemplateLine.
     - GET /v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getCustomerInvoiceTemplateLineFilesWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/file"
        path = path.stringByReplacingOccurrencesOfString("{customerInvoiceTemplateLineId}", withString: "\(customerInvoiceTemplateLineId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a customerInvoiceTemplateLine.
     - GET /v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/tag
    ...
    public class func getCustomerInvoiceTemplateLineTagsWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{customerInvoiceTemplateLineId}", withString: "\(customerInvoiceTemplateLineId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a duplicated a customerInvoiceTemplateLine by id
     - GET /v3.0/customerInvoiceTemplateLine/duplicate/{customerInvoiceTemplateLineId}
  ...
  "invoiceTemplateId" : 2
    ...
    public class func getDuplicateCustomerInvoiceTemplateLineByIdWithRequestBuilder(customerInvoiceTemplateLineId customerInvoiceTemplateLineId: Int32) -> RequestBuilder<CustomerInvoiceTemplateLine> {
        var path = "/v3.0/customerInvoiceTemplateLine/duplicate/{customerInvoiceTemplateLineId}"
        path = path.stringByReplacingOccurrencesOfString("{customerInvoiceTemplateLineId}", withString: "\(customerInvoiceTemplateLineId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update a customerInvoiceTemplateLine
     - PUT /v3.0/customerInvoiceTemplateLine
    ...
    public class func updateCustomerInvoiceTemplateLineWithRequestBuilder(body body: CustomerInvoiceTemplateLine) -> RequestBuilder<Void> {
        let path = "/v3.0/customerInvoiceTemplateLine"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
