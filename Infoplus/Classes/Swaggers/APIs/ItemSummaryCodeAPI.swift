...
public class ItemSummaryCodeAPI: APIBase {
  ...
  "lobId" : 0
    ...
    /**
     Add new audit for an itemSummaryCode
     - PUT /v3.0/itemSummaryCode/{itemSummaryCodeId}/audit/{itemSummaryCodeAudit}
    ...
    public class func addItemSummaryCodeAuditWithRequestBuilder(itemSummaryCodeId itemSummaryCodeId: Int32, itemSummaryCodeAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSummaryCode/{itemSummaryCodeId}/audit/{itemSummaryCodeAudit}"
    ...
    /**
     Attach a file to an itemSummaryCode
     - POST /v3.0/itemSummaryCode/{itemSummaryCodeId}/file/{fileName}
    ...
    public class func addItemSummaryCodeFileWithRequestBuilder(itemSummaryCodeId itemSummaryCodeId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSummaryCode/{itemSummaryCodeId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{itemSummaryCodeId}", withString: "\(itemSummaryCodeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter itemSummaryCodeId: (path) Id of the itemSummaryCode to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addItemSummaryCodeFileByURL(body body: RecordFile, itemSummaryCodeId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addItemSummaryCodeFileByURLWithRequestBuilder(body: body, itemSummaryCodeId: itemSummaryCodeId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an itemSummaryCode by URL.
     - POST /v3.0/itemSummaryCode/{itemSummaryCodeId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addItemSummaryCodeFileByURLWithRequestBuilder(body body: RecordFile, itemSummaryCodeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSummaryCode/{itemSummaryCodeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{itemSummaryCodeId}", withString: "\(itemSummaryCodeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for an itemSummaryCode.
     - PUT /v3.0/itemSummaryCode/{itemSummaryCodeId}/tag/{itemSummaryCodeTag}
    ...
    public class func addItemSummaryCodeTagWithRequestBuilder(itemSummaryCodeId itemSummaryCodeId: Int32, itemSummaryCodeTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSummaryCode/{itemSummaryCodeId}/tag/{itemSummaryCodeTag}"
        path = path.stringByReplacingOccurrencesOfString("{itemSummaryCodeId}", withString: "\(itemSummaryCodeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete an itemSummaryCode
     - DELETE /v3.0/itemSummaryCode/{itemSummaryCodeId}
    ...
    public class func deleteItemSummaryCodeWithRequestBuilder(itemSummaryCodeId itemSummaryCodeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSummaryCode/{itemSummaryCodeId}"
        path = path.stringByReplacingOccurrencesOfString("{itemSummaryCodeId}", withString: "\(itemSummaryCodeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter itemSummaryCodeId: (path) Id of the itemSummaryCode to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteItemSummaryCodeFile(itemSummaryCodeId itemSummaryCodeId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteItemSummaryCodeFileWithRequestBuilder(itemSummaryCodeId: itemSummaryCodeId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for an itemSummaryCode.
     - DELETE /v3.0/itemSummaryCode/{itemSummaryCodeId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteItemSummaryCodeFileWithRequestBuilder(itemSummaryCodeId itemSummaryCodeId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSummaryCode/{itemSummaryCodeId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{itemSummaryCodeId}", withString: "\(itemSummaryCodeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for an itemSummaryCode.
     - DELETE /v3.0/itemSummaryCode/{itemSummaryCodeId}/tag/{itemSummaryCodeTag}
    ...
    /**
     Get a duplicated an itemSummaryCode by id
     - GET /v3.0/itemSummaryCode/duplicate/{itemSummaryCodeId}
  ...
  "lobId" : 0
    ...
    public class func getDuplicateItemSummaryCodeByIdWithRequestBuilder(itemSummaryCodeId itemSummaryCodeId: Int32) -> RequestBuilder<ItemSummaryCode> {
        var path = "/v3.0/itemSummaryCode/duplicate/{itemSummaryCodeId}"
        path = path.stringByReplacingOccurrencesOfString("{itemSummaryCodeId}", withString: "\(itemSummaryCodeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search itemSummaryCodes by filter
     - GET /v3.0/itemSummaryCode/search
  ...
  "lobId" : 0
    ...
    public class func getItemSummaryCodeByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[ItemSummaryCode]> {
        let path = "/v3.0/itemSummaryCode/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get an itemSummaryCode by id
     - GET /v3.0/itemSummaryCode/{itemSummaryCodeId}
  ...
  "lobId" : 0
    ...
    /**
     ...
     - parameter itemSummaryCodeId: (path) Id of the itemSummaryCode to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getItemSummaryCodeFiles(itemSummaryCodeId itemSummaryCodeId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getItemSummaryCodeFilesWithRequestBuilder(itemSummaryCodeId: itemSummaryCodeId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for an itemSummaryCode.
     - GET /v3.0/itemSummaryCode/{itemSummaryCodeId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getItemSummaryCodeFilesWithRequestBuilder(itemSummaryCodeId itemSummaryCodeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSummaryCode/{itemSummaryCodeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{itemSummaryCodeId}", withString: "\(itemSummaryCodeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for an itemSummaryCode.
     - GET /v3.0/itemSummaryCode/{itemSummaryCodeId}/tag
    ...
    public class func getItemSummaryCodeTagsWithRequestBuilder(itemSummaryCodeId itemSummaryCodeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSummaryCode/{itemSummaryCodeId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{itemSummaryCodeId}", withString: "\(itemSummaryCodeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
