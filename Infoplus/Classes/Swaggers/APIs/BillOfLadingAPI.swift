...
public class BillOfLadingAPI: APIBase {
  ...
  "shipToName" : "shipToName"
    ...
    /**
     Add new audit for a billOfLading
     - PUT /v3.0/billOfLading/{billOfLadingId}/audit/{billOfLadingAudit}
    ...
    public class func addBillOfLadingAuditWithRequestBuilder(billOfLadingId billOfLadingId: Int32, billOfLadingAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/billOfLading/{billOfLadingId}/audit/{billOfLadingAudit}"
    ...
    /**
     Attach a file to a billOfLading
     - POST /v3.0/billOfLading/{billOfLadingId}/file/{fileName}
    ...
    public class func addBillOfLadingFileWithRequestBuilder(billOfLadingId billOfLadingId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/billOfLading/{billOfLadingId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{billOfLadingId}", withString: "\(billOfLadingId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter billOfLadingId: (path) Id of the billOfLading to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addBillOfLadingFileByURL(body body: RecordFile, billOfLadingId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addBillOfLadingFileByURLWithRequestBuilder(body: body, billOfLadingId: billOfLadingId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a billOfLading by URL.
     - POST /v3.0/billOfLading/{billOfLadingId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addBillOfLadingFileByURLWithRequestBuilder(body body: RecordFile, billOfLadingId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billOfLading/{billOfLadingId}/file"
        path = path.stringByReplacingOccurrencesOfString("{billOfLadingId}", withString: "\(billOfLadingId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for a billOfLading.
     - PUT /v3.0/billOfLading/{billOfLadingId}/tag/{billOfLadingTag}
    ...
    public class func addBillOfLadingTagWithRequestBuilder(billOfLadingId billOfLadingId: Int32, billOfLadingTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/billOfLading/{billOfLadingId}/tag/{billOfLadingTag}"
        path = path.stringByReplacingOccurrencesOfString("{billOfLadingId}", withString: "\(billOfLadingId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a billOfLading
     - DELETE /v3.0/billOfLading/{billOfLadingId}
    ...
    public class func deleteBillOfLadingWithRequestBuilder(billOfLadingId billOfLadingId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billOfLading/{billOfLadingId}"
        path = path.stringByReplacingOccurrencesOfString("{billOfLadingId}", withString: "\(billOfLadingId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter billOfLadingId: (path) Id of the billOfLading to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteBillOfLadingFile(billOfLadingId billOfLadingId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteBillOfLadingFileWithRequestBuilder(billOfLadingId: billOfLadingId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a billOfLading.
     - DELETE /v3.0/billOfLading/{billOfLadingId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteBillOfLadingFileWithRequestBuilder(billOfLadingId billOfLadingId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billOfLading/{billOfLadingId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{billOfLadingId}", withString: "\(billOfLadingId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a billOfLading.
     - DELETE /v3.0/billOfLading/{billOfLadingId}/tag/{billOfLadingTag}
  ...
  "shipToName" : "shipToName"
    ...
    public class func getBillOfLadingByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[BillOfLading]> {
        let path = "/v3.0/billOfLading/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a billOfLading by id
     - GET /v3.0/billOfLading/{billOfLadingId}
  ...
  "shipToName" : "shipToName"
    ...
    /**
     ...
     - parameter billOfLadingId: (path) Id of the billOfLading to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getBillOfLadingFiles(billOfLadingId billOfLadingId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getBillOfLadingFilesWithRequestBuilder(billOfLadingId: billOfLadingId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a billOfLading.
     - GET /v3.0/billOfLading/{billOfLadingId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getBillOfLadingFilesWithRequestBuilder(billOfLadingId billOfLadingId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billOfLading/{billOfLadingId}/file"
        path = path.stringByReplacingOccurrencesOfString("{billOfLadingId}", withString: "\(billOfLadingId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a billOfLading.
     - GET /v3.0/billOfLading/{billOfLadingId}/tag
    ...
    public class func getBillOfLadingTagsWithRequestBuilder(billOfLadingId billOfLadingId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billOfLading/{billOfLadingId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{billOfLadingId}", withString: "\(billOfLadingId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a duplicated a billOfLading by id
     - GET /v3.0/billOfLading/duplicate/{billOfLadingId}
  ...
  "shipToName" : "shipToName"
    ...
    public class func getDuplicateBillOfLadingByIdWithRequestBuilder(billOfLadingId billOfLadingId: Int32) -> RequestBuilder<BillOfLading> {
        var path = "/v3.0/billOfLading/duplicate/{billOfLadingId}"
        path = path.stringByReplacingOccurrencesOfString("{billOfLadingId}", withString: "\(billOfLadingId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update a billOfLading custom fields
     - PUT /v3.0/billOfLading/customFields
    ...
    public class func updateBillOfLadingCustomFieldsWithRequestBuilder(body body: BillOfLading) -> RequestBuilder<Void> {
        let path = "/v3.0/billOfLading/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
