...
public class ItemCategoryAPI: APIBase {
  ...
  "lobId" : 0
    ...
    /**
     Attach a file to an itemCategory
     - POST /beta/itemCategory/{itemCategoryId}/file/{fileName}
    ...
    public class func addItemCategoryFileWithRequestBuilder(itemCategoryId itemCategoryId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/beta/itemCategory/{itemCategoryId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{itemCategoryId}", withString: "\(itemCategoryId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Attach a file to an itemCategory by URL.
     - POST /beta/itemCategory/{itemCategoryId}/file
    ...
    public class func addItemCategoryFileByURLWithRequestBuilder(body body: RecordFile, itemCategoryId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/itemCategory/{itemCategoryId}/file"
        path = path.stringByReplacingOccurrencesOfString("{itemCategoryId}", withString: "\(itemCategoryId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Delete a file for an itemCategory.
     - DELETE /beta/itemCategory/{itemCategoryId}/file/{fileId}
    ...
    public class func deleteItemCategoryFileWithRequestBuilder(itemCategoryId itemCategoryId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/itemCategory/{itemCategoryId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{itemCategoryId}", withString: "\(itemCategoryId)", options: .LiteralSearch, range: nil)
  ...
  "lobId" : 0
    ...
    /**
     Get the files for an itemCategory.
     - GET /beta/itemCategory/{itemCategoryId}/file
