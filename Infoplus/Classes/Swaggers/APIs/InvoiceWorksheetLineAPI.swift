...
public class InvoiceWorksheetLineAPI: APIBase {
    ...
    /**
     Create an invoiceWorksheetLine
     - POST /v3.0/invoiceWorksheetLine
  ...
  "lobId" : 2
    ...
    public class func addInvoiceWorksheetLineWithRequestBuilder(body body: InvoiceWorksheetLine) -> RequestBuilder<InvoiceWorksheetLine> {
        let path = "/v3.0/invoiceWorksheetLine"
    ...
    /**
     Add new audit for an invoiceWorksheetLine
     - PUT /v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/audit/{invoiceWorksheetLineAudit}
    ...
    public class func addInvoiceWorksheetLineAuditWithRequestBuilder(invoiceWorksheetLineId invoiceWorksheetLineId: Int32, invoiceWorksheetLineAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/audit/{invoiceWorksheetLineAudit}"
    ...
    /**
     Attach a file to an invoiceWorksheetLine
     - POST /v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/file/{fileName}
    ...
    public class func addInvoiceWorksheetLineFileWithRequestBuilder(invoiceWorksheetLineId invoiceWorksheetLineId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetLineId}", withString: "\(invoiceWorksheetLineId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter invoiceWorksheetLineId: (path) Id of the invoiceWorksheetLine to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addInvoiceWorksheetLineFileByURL(body body: RecordFile, invoiceWorksheetLineId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addInvoiceWorksheetLineFileByURLWithRequestBuilder(body: body, invoiceWorksheetLineId: invoiceWorksheetLineId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an invoiceWorksheetLine by URL.
     - POST /v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addInvoiceWorksheetLineFileByURLWithRequestBuilder(body body: RecordFile, invoiceWorksheetLineId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/file"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetLineId}", withString: "\(invoiceWorksheetLineId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for an invoiceWorksheetLine.
     - PUT /v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/tag/{invoiceWorksheetLineTag}
    ...
    public class func addInvoiceWorksheetLineTagWithRequestBuilder(invoiceWorksheetLineId invoiceWorksheetLineId: Int32, invoiceWorksheetLineTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/tag/{invoiceWorksheetLineTag}"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetLineId}", withString: "\(invoiceWorksheetLineId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete an invoiceWorksheetLine
     - DELETE /v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}
    ...
    public class func deleteInvoiceWorksheetLineWithRequestBuilder(invoiceWorksheetLineId invoiceWorksheetLineId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetLineId}", withString: "\(invoiceWorksheetLineId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter invoiceWorksheetLineId: (path) Id of the invoiceWorksheetLine to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteInvoiceWorksheetLineFile(invoiceWorksheetLineId invoiceWorksheetLineId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteInvoiceWorksheetLineFileWithRequestBuilder(invoiceWorksheetLineId: invoiceWorksheetLineId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for an invoiceWorksheetLine.
     - DELETE /v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteInvoiceWorksheetLineFileWithRequestBuilder(invoiceWorksheetLineId invoiceWorksheetLineId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetLineId}", withString: "\(invoiceWorksheetLineId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for an invoiceWorksheetLine.
     - DELETE /v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/tag/{invoiceWorksheetLineTag}
    ...
    /**
     Get a duplicated an invoiceWorksheetLine by id
     - GET /v3.0/invoiceWorksheetLine/duplicate/{invoiceWorksheetLineId}
  ...
  "lobId" : 2
    ...
    public class func getDuplicateInvoiceWorksheetLineByIdWithRequestBuilder(invoiceWorksheetLineId invoiceWorksheetLineId: Int32) -> RequestBuilder<InvoiceWorksheetLine> {
        var path = "/v3.0/invoiceWorksheetLine/duplicate/{invoiceWorksheetLineId}"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetLineId}", withString: "\(invoiceWorksheetLineId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search invoiceWorksheetLines by filter
     - GET /v3.0/invoiceWorksheetLine/search
  ...
  "lobId" : 2
    ...
    public class func getInvoiceWorksheetLineByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[InvoiceWorksheetLine]> {
        let path = "/v3.0/invoiceWorksheetLine/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get an invoiceWorksheetLine by id
     - GET /v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}
  ...
  "lobId" : 2
    ...
    /**
     ...
     - parameter invoiceWorksheetLineId: (path) Id of the invoiceWorksheetLine to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getInvoiceWorksheetLineFiles(invoiceWorksheetLineId invoiceWorksheetLineId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getInvoiceWorksheetLineFilesWithRequestBuilder(invoiceWorksheetLineId: invoiceWorksheetLineId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for an invoiceWorksheetLine.
     - GET /v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getInvoiceWorksheetLineFilesWithRequestBuilder(invoiceWorksheetLineId invoiceWorksheetLineId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/file"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetLineId}", withString: "\(invoiceWorksheetLineId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for an invoiceWorksheetLine.
     - GET /v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/tag
    ...
    public class func getInvoiceWorksheetLineTagsWithRequestBuilder(invoiceWorksheetLineId invoiceWorksheetLineId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{invoiceWorksheetLineId}", withString: "\(invoiceWorksheetLineId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
