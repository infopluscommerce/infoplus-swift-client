...
public class OrderLoadProgramAPI: APIBase {
    ...
    /**
     Search orderLoadPrograms
     - GET /v3.0/orderLoadProgram/search
  ...
  "label" : "label"
    ...
    public class func getOrderLoadProgramBySearchTextWithRequestBuilder(searchText searchText: String? = nil, page: Int32? = nil, limit: Int32? = nil) -> RequestBuilder<[OrderLoadProgram]> {
        let path = "/v3.0/orderLoadProgram/search"
    ...
    /**
     Get an orderLoadProgram by id
     - GET /v3.0/orderLoadProgram/{orderLoadProgramId}
  ...
  "label" : "label"
    ...
    public class func getReqLoadProgramByIdWithRequestBuilder(orderLoadProgramId orderLoadProgramId: String) -> RequestBuilder<OrderLoadProgram> {
        var path = "/v3.0/orderLoadProgram/{orderLoadProgramId}"
