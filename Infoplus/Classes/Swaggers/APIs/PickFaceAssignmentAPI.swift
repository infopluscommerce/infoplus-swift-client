...
public class PickFaceAssignmentAPI: APIBase {
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func addPickFaceAssignmentWithRequestBuilder(body body: PickFaceAssignment) -> RequestBuilder<PickFaceAssignment> {
        let path = "/v3.0/pickFaceAssignment"
    ...
    /**
     Add new audit for a pickFaceAssignment
     - PUT /v3.0/pickFaceAssignment/{pickFaceAssignmentId}/audit/{pickFaceAssignmentAudit}
    ...
    public class func addPickFaceAssignmentAuditWithRequestBuilder(pickFaceAssignmentId pickFaceAssignmentId: Int32, pickFaceAssignmentAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/pickFaceAssignment/{pickFaceAssignmentId}/audit/{pickFaceAssignmentAudit}"
    ...
    /**
     Attach a file to a pickFaceAssignment
     - POST /v3.0/pickFaceAssignment/{pickFaceAssignmentId}/file/{fileName}
    ...
    public class func addPickFaceAssignmentFileWithRequestBuilder(pickFaceAssignmentId pickFaceAssignmentId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/pickFaceAssignment/{pickFaceAssignmentId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{pickFaceAssignmentId}", withString: "\(pickFaceAssignmentId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter pickFaceAssignmentId: (path) Id of the pickFaceAssignment to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addPickFaceAssignmentFileByURL(body body: RecordFile, pickFaceAssignmentId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addPickFaceAssignmentFileByURLWithRequestBuilder(body: body, pickFaceAssignmentId: pickFaceAssignmentId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a pickFaceAssignment by URL.
     - POST /v3.0/pickFaceAssignment/{pickFaceAssignmentId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addPickFaceAssignmentFileByURLWithRequestBuilder(body body: RecordFile, pickFaceAssignmentId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/pickFaceAssignment/{pickFaceAssignmentId}/file"
        path = path.stringByReplacingOccurrencesOfString("{pickFaceAssignmentId}", withString: "\(pickFaceAssignmentId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for a pickFaceAssignment.
     - PUT /v3.0/pickFaceAssignment/{pickFaceAssignmentId}/tag/{pickFaceAssignmentTag}
    ...
    public class func addPickFaceAssignmentTagWithRequestBuilder(pickFaceAssignmentId pickFaceAssignmentId: Int32, pickFaceAssignmentTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/pickFaceAssignment/{pickFaceAssignmentId}/tag/{pickFaceAssignmentTag}"
        path = path.stringByReplacingOccurrencesOfString("{pickFaceAssignmentId}", withString: "\(pickFaceAssignmentId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a pickFaceAssignment
     - DELETE /v3.0/pickFaceAssignment/{pickFaceAssignmentId}
    ...
    public class func deletePickFaceAssignmentWithRequestBuilder(pickFaceAssignmentId pickFaceAssignmentId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/pickFaceAssignment/{pickFaceAssignmentId}"
        path = path.stringByReplacingOccurrencesOfString("{pickFaceAssignmentId}", withString: "\(pickFaceAssignmentId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter pickFaceAssignmentId: (path) Id of the pickFaceAssignment to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deletePickFaceAssignmentFile(pickFaceAssignmentId pickFaceAssignmentId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deletePickFaceAssignmentFileWithRequestBuilder(pickFaceAssignmentId: pickFaceAssignmentId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a pickFaceAssignment.
     - DELETE /v3.0/pickFaceAssignment/{pickFaceAssignmentId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deletePickFaceAssignmentFileWithRequestBuilder(pickFaceAssignmentId pickFaceAssignmentId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/pickFaceAssignment/{pickFaceAssignmentId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{pickFaceAssignmentId}", withString: "\(pickFaceAssignmentId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a pickFaceAssignment.
     - DELETE /v3.0/pickFaceAssignment/{pickFaceAssignmentId}/tag/{pickFaceAssignmentTag}
    ...
    /**
     Get a duplicated a pickFaceAssignment by id
     - GET /v3.0/pickFaceAssignment/duplicate/{pickFaceAssignmentId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getDuplicatePickFaceAssignmentByIdWithRequestBuilder(pickFaceAssignmentId pickFaceAssignmentId: Int32) -> RequestBuilder<PickFaceAssignment> {
        var path = "/v3.0/pickFaceAssignment/duplicate/{pickFaceAssignmentId}"
        path = path.stringByReplacingOccurrencesOfString("{pickFaceAssignmentId}", withString: "\(pickFaceAssignmentId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search pickFaceAssignments by filter
     - GET /v3.0/pickFaceAssignment/search
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getPickFaceAssignmentByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[PickFaceAssignment]> {
        let path = "/v3.0/pickFaceAssignment/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a pickFaceAssignment by id
     - GET /v3.0/pickFaceAssignment/{pickFaceAssignmentId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     ...
     - parameter pickFaceAssignmentId: (path) Id of the pickFaceAssignment to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getPickFaceAssignmentFiles(pickFaceAssignmentId pickFaceAssignmentId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getPickFaceAssignmentFilesWithRequestBuilder(pickFaceAssignmentId: pickFaceAssignmentId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a pickFaceAssignment.
     - GET /v3.0/pickFaceAssignment/{pickFaceAssignmentId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getPickFaceAssignmentFilesWithRequestBuilder(pickFaceAssignmentId pickFaceAssignmentId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/pickFaceAssignment/{pickFaceAssignmentId}/file"
        path = path.stringByReplacingOccurrencesOfString("{pickFaceAssignmentId}", withString: "\(pickFaceAssignmentId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a pickFaceAssignment.
     - GET /v3.0/pickFaceAssignment/{pickFaceAssignmentId}/tag
    ...
    public class func getPickFaceAssignmentTagsWithRequestBuilder(pickFaceAssignmentId pickFaceAssignmentId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/pickFaceAssignment/{pickFaceAssignmentId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{pickFaceAssignmentId}", withString: "\(pickFaceAssignmentId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update a pickFaceAssignment custom fields
     - PUT /v3.0/pickFaceAssignment/customFields
    ...
    public class func updatePickFaceAssignmentCustomFieldsWithRequestBuilder(body body: PickFaceAssignment) -> RequestBuilder<Void> {
        let path = "/v3.0/pickFaceAssignment/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
