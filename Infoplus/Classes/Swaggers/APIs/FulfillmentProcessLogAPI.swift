...
public class FulfillmentProcessLogAPI: APIBase {
    ...
    /**
     Add new audit for a fulfillmentProcessLog
     - PUT /v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/audit/{fulfillmentProcessLogAudit}
    ...
    public class func addFulfillmentProcessLogAuditWithRequestBuilder(fulfillmentProcessLogId fulfillmentProcessLogId: Int32, fulfillmentProcessLogAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/audit/{fulfillmentProcessLogAudit}"
    ...
    /**
     Attach a file to a fulfillmentProcessLog
     - POST /v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/file/{fileName}
    ...
    public class func addFulfillmentProcessLogFileWithRequestBuilder(fulfillmentProcessLogId fulfillmentProcessLogId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessLogId}", withString: "\(fulfillmentProcessLogId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter fulfillmentProcessLogId: (path) Id of the fulfillmentProcessLog to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addFulfillmentProcessLogFileByURL(body body: RecordFile, fulfillmentProcessLogId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addFulfillmentProcessLogFileByURLWithRequestBuilder(body: body, fulfillmentProcessLogId: fulfillmentProcessLogId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a fulfillmentProcessLog by URL.
     - POST /v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addFulfillmentProcessLogFileByURLWithRequestBuilder(body body: RecordFile, fulfillmentProcessLogId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/file"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessLogId}", withString: "\(fulfillmentProcessLogId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Add new tags for a fulfillmentProcessLog.
     - PUT /v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/tag/{fulfillmentProcessLogTag}
    ...
    public class func addFulfillmentProcessLogTagWithRequestBuilder(fulfillmentProcessLogId fulfillmentProcessLogId: Int32, fulfillmentProcessLogTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/tag/{fulfillmentProcessLogTag}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessLogId}", withString: "\(fulfillmentProcessLogId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter fulfillmentProcessLogId: (path) Id of the fulfillmentProcessLog to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteFulfillmentProcessLogFile(fulfillmentProcessLogId fulfillmentProcessLogId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteFulfillmentProcessLogFileWithRequestBuilder(fulfillmentProcessLogId: fulfillmentProcessLogId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a fulfillmentProcessLog.
     - DELETE /v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteFulfillmentProcessLogFileWithRequestBuilder(fulfillmentProcessLogId fulfillmentProcessLogId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessLogId}", withString: "\(fulfillmentProcessLogId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a fulfillmentProcessLog.
     - DELETE /v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/tag/{fulfillmentProcessLogTag}
    ...
    /**
     Get a duplicated a fulfillmentProcessLog by id
     - GET /v3.0/fulfillmentProcessLog/duplicate/{fulfillmentProcessLogId}
  ...
  "lobId" : 5
    ...
    public class func getDuplicateFulfillmentProcessLogByIdWithRequestBuilder(fulfillmentProcessLogId fulfillmentProcessLogId: Int32) -> RequestBuilder<FulfillmentProcessLog> {
        var path = "/v3.0/fulfillmentProcessLog/duplicate/{fulfillmentProcessLogId}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessLogId}", withString: "\(fulfillmentProcessLogId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search fulfillmentProcessLogs by filter
     - GET /v3.0/fulfillmentProcessLog/search
  ...
  "lobId" : 5
    ...
    public class func getFulfillmentProcessLogByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[FulfillmentProcessLog]> {
        let path = "/v3.0/fulfillmentProcessLog/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a fulfillmentProcessLog by id
     - GET /v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}
  ...
  "lobId" : 5
    ...
    public class func getFulfillmentProcessLogByIdWithRequestBuilder(fulfillmentProcessLogId fulfillmentProcessLogId: Int32) -> RequestBuilder<FulfillmentProcessLog> {
        var path = "/v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessLogId}", withString: "\(fulfillmentProcessLogId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter fulfillmentProcessLogId: (path) Id of the fulfillmentProcessLog to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getFulfillmentProcessLogFiles(fulfillmentProcessLogId fulfillmentProcessLogId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getFulfillmentProcessLogFilesWithRequestBuilder(fulfillmentProcessLogId: fulfillmentProcessLogId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a fulfillmentProcessLog.
     - GET /v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getFulfillmentProcessLogFilesWithRequestBuilder(fulfillmentProcessLogId fulfillmentProcessLogId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/file"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessLogId}", withString: "\(fulfillmentProcessLogId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a fulfillmentProcessLog.
     - GET /v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/tag
    ...
    public class func getFulfillmentProcessLogTagsWithRequestBuilder(fulfillmentProcessLogId fulfillmentProcessLogId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentProcessLog/{fulfillmentProcessLogId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessLogId}", withString: "\(fulfillmentProcessLogId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
