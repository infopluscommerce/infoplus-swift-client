...
public class PerpetualInventoryLogAPI: APIBase {
    ...
    /**
     Attach a file to a perpetualInventoryLog
     - POST /beta/perpetualInventoryLog/{perpetualInventoryLogId}/file/{fileName}
    ...
    public class func addPerpetualInventoryLogFileWithRequestBuilder(perpetualInventoryLogId perpetualInventoryLogId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/beta/perpetualInventoryLog/{perpetualInventoryLogId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{perpetualInventoryLogId}", withString: "\(perpetualInventoryLogId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Attach a file to a perpetualInventoryLog by URL.
     - POST /beta/perpetualInventoryLog/{perpetualInventoryLogId}/file
    ...
    public class func addPerpetualInventoryLogFileByURLWithRequestBuilder(body body: RecordFile, perpetualInventoryLogId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/perpetualInventoryLog/{perpetualInventoryLogId}/file"
        path = path.stringByReplacingOccurrencesOfString("{perpetualInventoryLogId}", withString: "\(perpetualInventoryLogId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Delete a file for a perpetualInventoryLog.
     - DELETE /beta/perpetualInventoryLog/{perpetualInventoryLogId}/file/{fileId}
    ...
    public class func deletePerpetualInventoryLogFileWithRequestBuilder(perpetualInventoryLogId perpetualInventoryLogId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/perpetualInventoryLog/{perpetualInventoryLogId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{perpetualInventoryLogId}", withString: "\(perpetualInventoryLogId)", options: .LiteralSearch, range: nil)
  ...
  "interimFact" : 2.884162126668780246063761296682059764862060546875,
  "legacyPoNo" : "legacyPoNo",
  "weightPerWrap" : 6.77832496304801335185175048536621034145355224609375,
  "vendorId" : 6,
  ...
  "mlCost" : 2.027123023002321833274663731572218239307403564453125,
  "lobId" : 5,
  ...
  "asnLine" : 8,
  "itemProductIdTagSchemeId" : 7,
  "orderDate" : "2000-01-23T04:56:07.000+00:00",
  "receiptStatus" : "receiptStatus",
  "factCost" : 3.61607674925191080461672754609026014804840087890625,
  "endQuantity" : 9,
  "maxFreight" : 1.489415909854170383397331534069962799549102783203125,
  "norcs" : "norcs",
  "mlVendor" : 6,
  "customFields" : {
    "key" : "{}"
  ...
  "endFact" : 3.557195227068097320710649000830017030239105224609375,
  "enteredBy" : "enteredBy",
  "caseWeight" : 0.885137473901165261480628032586537301540374755859375,
  "locationStatus" : "locationStatus",
  "distDate" : "2000-01-23T04:56:07.000+00:00",
  "endVal" : 6.438423552598546706349225132726132869720458984375,
  "wrapCode" : "wrapCode",
  ...
  "unitsPerWrap" : 7,
  "address" : "address",
  "cost" : 1.231513536777255612975068288506008684635162353515625,
  "interimVal" : 1.2846590061165319429647979632136411964893341064453125,
  "sell" : 1.024645700144157789424070870154537260532379150390625,
  "length" : 0.10263654006109401706225980888120830059051513671875,
  "maxOvers" : 1,
  ...
  "receivedSfp" : 5,
  "accrual" : "accrual",
  "freightCost" : 9.3693102714106686335071572102606296539306640625,
  "itemReceiptId" : 1,
  "maxOther" : 6.8468526983526398765889098285697400569915771484375,
  ...
  "freezeAction" : "freezeAction"
    ...
    /**
     Get the files for a perpetualInventoryLog.
     - GET /beta/perpetualInventoryLog/{perpetualInventoryLogId}/file
