...
public class ItemSerialSchemeAPI: APIBase {
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func addItemSerialSchemeWithRequestBuilder(body body: ItemSerialScheme) -> RequestBuilder<ItemSerialScheme> {
        let path = "/v3.0/itemSerialScheme"
    ...
    /**
     Add new audit for an itemSerialScheme
     - PUT /v3.0/itemSerialScheme/{itemSerialSchemeId}/audit/{itemSerialSchemeAudit}
    ...
    public class func addItemSerialSchemeAuditWithRequestBuilder(itemSerialSchemeId itemSerialSchemeId: Int32, itemSerialSchemeAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSerialScheme/{itemSerialSchemeId}/audit/{itemSerialSchemeAudit}"
    ...
    /**
     ...
     - parameter itemSerialSchemeId: (path) Id of the itemSerialScheme to add a file to 
     - parameter fileName: (path) Name of file 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addItemSerialSchemeFile(itemSerialSchemeId itemSerialSchemeId: Int32, fileName: String, completion: ((error: ErrorType?) -> Void)) {
        addItemSerialSchemeFileWithRequestBuilder(itemSerialSchemeId: itemSerialSchemeId, fileName: fileName).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an itemSerialScheme
     - POST /v3.0/itemSerialScheme/{itemSerialSchemeId}/file/{fileName}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addItemSerialSchemeFileWithRequestBuilder(itemSerialSchemeId itemSerialSchemeId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSerialScheme/{itemSerialSchemeId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{itemSerialSchemeId}", withString: "\(itemSerialSchemeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter itemSerialSchemeId: (path) Id of the itemSerialScheme to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addItemSerialSchemeFileByURL(body body: RecordFile, itemSerialSchemeId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addItemSerialSchemeFileByURLWithRequestBuilder(body: body, itemSerialSchemeId: itemSerialSchemeId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an itemSerialScheme by URL.
     - POST /v3.0/itemSerialScheme/{itemSerialSchemeId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addItemSerialSchemeFileByURLWithRequestBuilder(body body: RecordFile, itemSerialSchemeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSerialScheme/{itemSerialSchemeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{itemSerialSchemeId}", withString: "\(itemSerialSchemeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for an itemSerialScheme.
     - PUT /v3.0/itemSerialScheme/{itemSerialSchemeId}/tag/{itemSerialSchemeTag}
    ...
    public class func addItemSerialSchemeTagWithRequestBuilder(itemSerialSchemeId itemSerialSchemeId: Int32, itemSerialSchemeTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSerialScheme/{itemSerialSchemeId}/tag/{itemSerialSchemeTag}"
        path = path.stringByReplacingOccurrencesOfString("{itemSerialSchemeId}", withString: "\(itemSerialSchemeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete an itemSerialScheme
     - DELETE /v3.0/itemSerialScheme/{itemSerialSchemeId}
    ...
    public class func deleteItemSerialSchemeWithRequestBuilder(itemSerialSchemeId itemSerialSchemeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSerialScheme/{itemSerialSchemeId}"
        path = path.stringByReplacingOccurrencesOfString("{itemSerialSchemeId}", withString: "\(itemSerialSchemeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter itemSerialSchemeId: (path) Id of the itemSerialScheme to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteItemSerialSchemeFile(itemSerialSchemeId itemSerialSchemeId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteItemSerialSchemeFileWithRequestBuilder(itemSerialSchemeId: itemSerialSchemeId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for an itemSerialScheme.
     - DELETE /v3.0/itemSerialScheme/{itemSerialSchemeId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteItemSerialSchemeFileWithRequestBuilder(itemSerialSchemeId itemSerialSchemeId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSerialScheme/{itemSerialSchemeId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{itemSerialSchemeId}", withString: "\(itemSerialSchemeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for an itemSerialScheme.
     - DELETE /v3.0/itemSerialScheme/{itemSerialSchemeId}/tag/{itemSerialSchemeTag}
    ...
    /**
     Get a duplicated an itemSerialScheme by id
     - GET /v3.0/itemSerialScheme/duplicate/{itemSerialSchemeId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getDuplicateItemSerialSchemeByIdWithRequestBuilder(itemSerialSchemeId itemSerialSchemeId: Int32) -> RequestBuilder<ItemSerialScheme> {
        var path = "/v3.0/itemSerialScheme/duplicate/{itemSerialSchemeId}"
        path = path.stringByReplacingOccurrencesOfString("{itemSerialSchemeId}", withString: "\(itemSerialSchemeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search itemSerialSchemes by filter
     - GET /v3.0/itemSerialScheme/search
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getItemSerialSchemeByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[ItemSerialScheme]> {
        let path = "/v3.0/itemSerialScheme/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get an itemSerialScheme by id
     - GET /v3.0/itemSerialScheme/{itemSerialSchemeId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     ...
     - parameter itemSerialSchemeId: (path) Id of the itemSerialScheme to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getItemSerialSchemeFiles(itemSerialSchemeId itemSerialSchemeId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getItemSerialSchemeFilesWithRequestBuilder(itemSerialSchemeId: itemSerialSchemeId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for an itemSerialScheme.
     - GET /v3.0/itemSerialScheme/{itemSerialSchemeId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getItemSerialSchemeFilesWithRequestBuilder(itemSerialSchemeId itemSerialSchemeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSerialScheme/{itemSerialSchemeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{itemSerialSchemeId}", withString: "\(itemSerialSchemeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for an itemSerialScheme.
     - GET /v3.0/itemSerialScheme/{itemSerialSchemeId}/tag
    ...
    public class func getItemSerialSchemeTagsWithRequestBuilder(itemSerialSchemeId itemSerialSchemeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemSerialScheme/{itemSerialSchemeId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{itemSerialSchemeId}", withString: "\(itemSerialSchemeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
