...
public class QuickAdjustmentAPI: APIBase {
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     Add new audit for a quickAdjustment
     - PUT /v3.0/quickAdjustment/{quickAdjustmentId}/audit/{quickAdjustmentAudit}
    ...
    public class func addQuickAdjustmentAuditWithRequestBuilder(quickAdjustmentId quickAdjustmentId: Int32, quickAdjustmentAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/quickAdjustment/{quickAdjustmentId}/audit/{quickAdjustmentAudit}"
    ...
    /**
     ...
     - parameter quickAdjustmentId: (path) Id of the quickAdjustment to add a file to 
     - parameter fileName: (path) Name of file 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addQuickAdjustmentFile(quickAdjustmentId quickAdjustmentId: Int32, fileName: String, completion: ((error: ErrorType?) -> Void)) {
        addQuickAdjustmentFileWithRequestBuilder(quickAdjustmentId: quickAdjustmentId, fileName: fileName).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a quickAdjustment
     - POST /v3.0/quickAdjustment/{quickAdjustmentId}/file/{fileName}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addQuickAdjustmentFileWithRequestBuilder(quickAdjustmentId quickAdjustmentId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/quickAdjustment/{quickAdjustmentId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{quickAdjustmentId}", withString: "\(quickAdjustmentId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter quickAdjustmentId: (path) Id of the quickAdjustment to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addQuickAdjustmentFileByURL(body body: RecordFile, quickAdjustmentId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addQuickAdjustmentFileByURLWithRequestBuilder(body: body, quickAdjustmentId: quickAdjustmentId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a quickAdjustment by URL.
     - POST /v3.0/quickAdjustment/{quickAdjustmentId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addQuickAdjustmentFileByURLWithRequestBuilder(body body: RecordFile, quickAdjustmentId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/quickAdjustment/{quickAdjustmentId}/file"
        path = path.stringByReplacingOccurrencesOfString("{quickAdjustmentId}", withString: "\(quickAdjustmentId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for a quickAdjustment.
     - PUT /v3.0/quickAdjustment/{quickAdjustmentId}/tag/{quickAdjustmentTag}
    ...
    public class func addQuickAdjustmentTagWithRequestBuilder(quickAdjustmentId quickAdjustmentId: Int32, quickAdjustmentTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/quickAdjustment/{quickAdjustmentId}/tag/{quickAdjustmentTag}"
        path = path.stringByReplacingOccurrencesOfString("{quickAdjustmentId}", withString: "\(quickAdjustmentId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a quickAdjustment
     - DELETE /v3.0/quickAdjustment/{quickAdjustmentId}
    ...
    public class func deleteQuickAdjustmentWithRequestBuilder(quickAdjustmentId quickAdjustmentId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/quickAdjustment/{quickAdjustmentId}"
        path = path.stringByReplacingOccurrencesOfString("{quickAdjustmentId}", withString: "\(quickAdjustmentId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter quickAdjustmentId: (path) Id of the quickAdjustment to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteQuickAdjustmentFile(quickAdjustmentId quickAdjustmentId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteQuickAdjustmentFileWithRequestBuilder(quickAdjustmentId: quickAdjustmentId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a quickAdjustment.
     - DELETE /v3.0/quickAdjustment/{quickAdjustmentId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteQuickAdjustmentFileWithRequestBuilder(quickAdjustmentId quickAdjustmentId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/quickAdjustment/{quickAdjustmentId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{quickAdjustmentId}", withString: "\(quickAdjustmentId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a quickAdjustment.
     - DELETE /v3.0/quickAdjustment/{quickAdjustmentId}/tag/{quickAdjustmentTag}
    ...
    /**
     Run the ExecuteQuickAdjustment process.
     - POST /v3.0/quickAdjustment/executeQuickAdjustment
     - 
     - API Key:
       - type: apiKey API-Key 
       - name: api_key
  ...
  "status" : "status"
    ...
    public class func executeQuickAdjustmentWithRequestBuilder(body body: ExecuteQuickAdjustmentInputAPIModel) -> RequestBuilder<[ProcessOutputAPIModel]> {
        let path = "/v3.0/quickAdjustment/executeQuickAdjustment"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Get a duplicated a quickAdjustment by id
     - GET /v3.0/quickAdjustment/duplicate/{quickAdjustmentId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getDuplicateQuickAdjustmentByIdWithRequestBuilder(quickAdjustmentId quickAdjustmentId: Int32) -> RequestBuilder<QuickAdjustment> {
        var path = "/v3.0/quickAdjustment/duplicate/{quickAdjustmentId}"
        path = path.stringByReplacingOccurrencesOfString("{quickAdjustmentId}", withString: "\(quickAdjustmentId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search quickAdjustments by filter
     - GET /v3.0/quickAdjustment/search
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getQuickAdjustmentByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[QuickAdjustment]> {
        let path = "/v3.0/quickAdjustment/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a quickAdjustment by id
     - GET /v3.0/quickAdjustment/{quickAdjustmentId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     ...
     - parameter quickAdjustmentId: (path) Id of the quickAdjustment to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getQuickAdjustmentFiles(quickAdjustmentId quickAdjustmentId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getQuickAdjustmentFilesWithRequestBuilder(quickAdjustmentId: quickAdjustmentId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a quickAdjustment.
     - GET /v3.0/quickAdjustment/{quickAdjustmentId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getQuickAdjustmentFilesWithRequestBuilder(quickAdjustmentId quickAdjustmentId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/quickAdjustment/{quickAdjustmentId}/file"
        path = path.stringByReplacingOccurrencesOfString("{quickAdjustmentId}", withString: "\(quickAdjustmentId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a quickAdjustment.
     - GET /v3.0/quickAdjustment/{quickAdjustmentId}/tag
    ...
    public class func getQuickAdjustmentTagsWithRequestBuilder(quickAdjustmentId quickAdjustmentId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/quickAdjustment/{quickAdjustmentId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{quickAdjustmentId}", withString: "\(quickAdjustmentId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update a quickAdjustment custom fields
     - PUT /v3.0/quickAdjustment/customFields
    ...
    public class func updateQuickAdjustmentCustomFieldsWithRequestBuilder(body body: QuickAdjustment) -> RequestBuilder<Void> {
        let path = "/v3.0/quickAdjustment/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
