...
public class InventorySnapshotAPI: APIBase {
    ...
    /**
     Attach a file to an inventorySnapshot
     - POST /beta/inventorySnapshot/{inventorySnapshotId}/file/{fileName}
    ...
    public class func addInventorySnapshotFileWithRequestBuilder(inventorySnapshotId inventorySnapshotId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/beta/inventorySnapshot/{inventorySnapshotId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{inventorySnapshotId}", withString: "\(inventorySnapshotId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Attach a file to an inventorySnapshot by URL.
     - POST /beta/inventorySnapshot/{inventorySnapshotId}/file
    ...
    public class func addInventorySnapshotFileByURLWithRequestBuilder(body body: RecordFile, inventorySnapshotId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/inventorySnapshot/{inventorySnapshotId}/file"
        path = path.stringByReplacingOccurrencesOfString("{inventorySnapshotId}", withString: "\(inventorySnapshotId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Delete a file for an inventorySnapshot.
     - DELETE /beta/inventorySnapshot/{inventorySnapshotId}/file/{fileId}
    ...
    public class func deleteInventorySnapshotFileWithRequestBuilder(inventorySnapshotId inventorySnapshotId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/inventorySnapshot/{inventorySnapshotId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{inventorySnapshotId}", withString: "\(inventorySnapshotId)", options: .LiteralSearch, range: nil)
  ...
  "itemMajorGroupName" : "itemMajorGroupName"
    ...
    /**
     Get the files for an inventorySnapshot.
     - GET /beta/inventorySnapshot/{inventorySnapshotId}/file
