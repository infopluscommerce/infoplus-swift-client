...
public class FulfillmentProcessAPI: APIBase {
    ...
    /**
     Add new audit for a fulfillmentProcess
     - PUT /v3.0/fulfillmentProcess/{fulfillmentProcessId}/audit/{fulfillmentProcessAudit}
    ...
    public class func addFulfillmentProcessAuditWithRequestBuilder(fulfillmentProcessId fulfillmentProcessId: Int32, fulfillmentProcessAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentProcess/{fulfillmentProcessId}/audit/{fulfillmentProcessAudit}"
    ...
    /**
     Attach a file to a fulfillmentProcess
     - POST /v3.0/fulfillmentProcess/{fulfillmentProcessId}/file/{fileName}
    ...
    public class func addFulfillmentProcessFileWithRequestBuilder(fulfillmentProcessId fulfillmentProcessId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentProcess/{fulfillmentProcessId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessId}", withString: "\(fulfillmentProcessId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter fulfillmentProcessId: (path) Id of the fulfillmentProcess to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addFulfillmentProcessFileByURL(body body: RecordFile, fulfillmentProcessId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addFulfillmentProcessFileByURLWithRequestBuilder(body: body, fulfillmentProcessId: fulfillmentProcessId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a fulfillmentProcess by URL.
     - POST /v3.0/fulfillmentProcess/{fulfillmentProcessId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addFulfillmentProcessFileByURLWithRequestBuilder(body body: RecordFile, fulfillmentProcessId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentProcess/{fulfillmentProcessId}/file"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessId}", withString: "\(fulfillmentProcessId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Add new tags for a fulfillmentProcess.
     - PUT /v3.0/fulfillmentProcess/{fulfillmentProcessId}/tag/{fulfillmentProcessTag}
    ...
    public class func addFulfillmentProcessTagWithRequestBuilder(fulfillmentProcessId fulfillmentProcessId: Int32, fulfillmentProcessTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentProcess/{fulfillmentProcessId}/tag/{fulfillmentProcessTag}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessId}", withString: "\(fulfillmentProcessId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter fulfillmentProcessId: (path) Id of the fulfillmentProcess to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteFulfillmentProcessFile(fulfillmentProcessId fulfillmentProcessId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteFulfillmentProcessFileWithRequestBuilder(fulfillmentProcessId: fulfillmentProcessId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a fulfillmentProcess.
     - DELETE /v3.0/fulfillmentProcess/{fulfillmentProcessId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteFulfillmentProcessFileWithRequestBuilder(fulfillmentProcessId fulfillmentProcessId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentProcess/{fulfillmentProcessId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessId}", withString: "\(fulfillmentProcessId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a fulfillmentProcess.
     - DELETE /v3.0/fulfillmentProcess/{fulfillmentProcessId}/tag/{fulfillmentProcessTag}
    ...
    /**
     Get a duplicated a fulfillmentProcess by id
     - GET /v3.0/fulfillmentProcess/duplicate/{fulfillmentProcessId}
  ...
  "createLineItemEachGS1128Labels" : "createLineItemEachGS1128Labels",
  ...
  "shippedOrders" : 9,
  "completedToDo" : 8,
  "orderAssemblyGuideLayout" : "orderAssemblyGuideLayout",
  "overrideOrderInvoiceTemplateId" : 2,
  "preGenerateParcelLabels" : false,
  "labelSort" : "labelSort",
  "locationSort" : "locationSort",
  "createCartonGS1128Labels" : "createCartonGS1128Labels",
  ...
  "orderSmartFilterId" : 7
    ...
    public class func getDuplicateFulfillmentProcessByIdWithRequestBuilder(fulfillmentProcessId fulfillmentProcessId: Int32) -> RequestBuilder<FulfillmentProcess> {
        var path = "/v3.0/fulfillmentProcess/duplicate/{fulfillmentProcessId}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessId}", withString: "\(fulfillmentProcessId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search fulfillmentProcesses by filter
     - GET /v3.0/fulfillmentProcess/search
  ...
  "orderSmartFilterId" : 7
    ...
    public class func getFulfillmentProcessByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[FulfillmentProcess]> {
        let path = "/v3.0/fulfillmentProcess/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a fulfillmentProcess by id
     - GET /v3.0/fulfillmentProcess/{fulfillmentProcessId}
  ...
  "orderSmartFilterId" : 7
    ...
    public class func getFulfillmentProcessByIdWithRequestBuilder(fulfillmentProcessId fulfillmentProcessId: Int32) -> RequestBuilder<FulfillmentProcess> {
        var path = "/v3.0/fulfillmentProcess/{fulfillmentProcessId}"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessId}", withString: "\(fulfillmentProcessId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter fulfillmentProcessId: (path) Id of the fulfillmentProcess to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getFulfillmentProcessFiles(fulfillmentProcessId fulfillmentProcessId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getFulfillmentProcessFilesWithRequestBuilder(fulfillmentProcessId: fulfillmentProcessId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a fulfillmentProcess.
     - GET /v3.0/fulfillmentProcess/{fulfillmentProcessId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getFulfillmentProcessFilesWithRequestBuilder(fulfillmentProcessId fulfillmentProcessId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentProcess/{fulfillmentProcessId}/file"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessId}", withString: "\(fulfillmentProcessId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a fulfillmentProcess.
     - GET /v3.0/fulfillmentProcess/{fulfillmentProcessId}/tag
    ...
    public class func getFulfillmentProcessTagsWithRequestBuilder(fulfillmentProcessId fulfillmentProcessId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/fulfillmentProcess/{fulfillmentProcessId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{fulfillmentProcessId}", withString: "\(fulfillmentProcessId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update a fulfillmentProcess custom fields
     - PUT /v3.0/fulfillmentProcess/customFields
    ...
    public class func updateFulfillmentProcessCustomFieldsWithRequestBuilder(body body: FulfillmentProcess) -> RequestBuilder<Void> {
        let path = "/v3.0/fulfillmentProcess/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
