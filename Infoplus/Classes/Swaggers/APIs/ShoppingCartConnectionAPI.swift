...
public class ShoppingCartConnectionAPI: APIBase {
  ...
  "warehouseList" : [ {
    ...
    "street3" : "street3",
    "city" : "city",
    "inventorySearchCaseBarcode" : false,
    "shipStationAllowScanningSKUToIdentifyOrders" : false,
    "shipStationBlockShippingForUnresolvedShortWork" : false,
    "customFields" : {
      "key" : "{}"
    },
    "packStationAllowAddAllItems" : false,
    "inventorySearchPalletBarcode" : false,
    "lpnPrefix" : "lpnPrefix",
    "client" : 2,
    "company" : "company",
    "street1" : "street1",
  ...
  "inventoryLevelStoreControls" : "inventoryLevelStoreControls"
    ...
    /**
     Attach a file to a shoppingCartConnection
     - POST /beta/shoppingCartConnection/{shoppingCartConnectionId}/file/{fileName}
    ...
    public class func addShoppingCartConnectionFileWithRequestBuilder(shoppingCartConnectionId shoppingCartConnectionId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/beta/shoppingCartConnection/{shoppingCartConnectionId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{shoppingCartConnectionId}", withString: "\(shoppingCartConnectionId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Attach a file to a shoppingCartConnection by URL.
     - POST /beta/shoppingCartConnection/{shoppingCartConnectionId}/file
    ...
    public class func addShoppingCartConnectionFileByURLWithRequestBuilder(body body: RecordFile, shoppingCartConnectionId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/shoppingCartConnection/{shoppingCartConnectionId}/file"
        path = path.stringByReplacingOccurrencesOfString("{shoppingCartConnectionId}", withString: "\(shoppingCartConnectionId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Delete a file for a shoppingCartConnection.
     - DELETE /beta/shoppingCartConnection/{shoppingCartConnectionId}/file/{fileId}
    ...
    public class func deleteShoppingCartConnectionFileWithRequestBuilder(shoppingCartConnectionId shoppingCartConnectionId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/shoppingCartConnection/{shoppingCartConnectionId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{shoppingCartConnectionId}", withString: "\(shoppingCartConnectionId)", options: .LiteralSearch, range: nil)
  ...
  "inventoryLevelStoreControls" : "inventoryLevelStoreControls"
    ...
    /**
     Get the files for a shoppingCartConnection.
     - GET /beta/shoppingCartConnection/{shoppingCartConnectionId}/file
