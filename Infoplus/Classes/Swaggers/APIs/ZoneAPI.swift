...
public class ZoneAPI: APIBase {
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func addZoneFileByURLWithRequestBuilder(body body: RecordFile, zoneId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/zone/{zoneId}/file"
        path = path.stringByReplacingOccurrencesOfString("{zoneId}", withString: "\(zoneId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Delete a file for a zone.
     - DELETE /beta/zone/{zoneId}/file/{fileId}
    ...
    public class func deleteZoneFileWithRequestBuilder(zoneId zoneId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/zone/{zoneId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{zoneId}", withString: "\(zoneId)", options: .LiteralSearch, range: nil)
