...
public class ZoneAPI: APIBase {
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     Add new audit for a zone
     - PUT /v3.0/zone/{zoneId}/audit/{zoneAudit}
    ...
    public class func addZoneAuditWithRequestBuilder(zoneId zoneId: Int32, zoneAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/zone/{zoneId}/audit/{zoneAudit}"
    ...
    /**
     Attach a file to a zone
     - POST /v3.0/zone/{zoneId}/file/{fileName}
    ...
    public class func addZoneFileWithRequestBuilder(zoneId zoneId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/zone/{zoneId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{zoneId}", withString: "\(zoneId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter zoneId: (path) Id of the zone to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addZoneFileByURL(body body: RecordFile, zoneId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addZoneFileByURLWithRequestBuilder(body: body, zoneId: zoneId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addZoneFileByURLWithRequestBuilder(body body: RecordFile, zoneId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/zone/{zoneId}/file"
        path = path.stringByReplacingOccurrencesOfString("{zoneId}", withString: "\(zoneId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for a zone.
     - PUT /v3.0/zone/{zoneId}/tag/{zoneTag}
    ...
    public class func addZoneTagWithRequestBuilder(zoneId zoneId: Int32, zoneTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/zone/{zoneId}/tag/{zoneTag}"
        path = path.stringByReplacingOccurrencesOfString("{zoneId}", withString: "\(zoneId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter zoneId: (path) Id of the zone to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteZoneFile(zoneId zoneId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteZoneFileWithRequestBuilder(zoneId: zoneId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a zone.
     - DELETE /v3.0/zone/{zoneId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteZoneFileWithRequestBuilder(zoneId zoneId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/zone/{zoneId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{zoneId}", withString: "\(zoneId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a zone.
     - DELETE /v3.0/zone/{zoneId}/tag/{zoneTag}
    ...
    /**
     Get a duplicated a zone by id
     - GET /v3.0/zone/duplicate/{zoneId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getDuplicateZoneByIdWithRequestBuilder(zoneId zoneId: Int32) -> RequestBuilder<Zone> {
        var path = "/v3.0/zone/duplicate/{zoneId}"
        path = path.stringByReplacingOccurrencesOfString("{zoneId}", withString: "\(zoneId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     ...
     - parameter zoneId: (path) Id of the zone to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getZoneFiles(zoneId zoneId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getZoneFilesWithRequestBuilder(zoneId: zoneId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getZoneFilesWithRequestBuilder(zoneId zoneId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/zone/{zoneId}/file"
        path = path.stringByReplacingOccurrencesOfString("{zoneId}", withString: "\(zoneId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    public class func updateZoneCustomFieldsWithRequestBuilder(body body: Zone) -> RequestBuilder<Void> {
        let path = "/v3.0/zone/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
