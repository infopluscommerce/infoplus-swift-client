...
public class KitAPI: APIBase {
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     Add new audit for a kit
     - PUT /v3.0/kit/{kitId}/audit/{kitAudit}
    ...
    public class func addKitAuditWithRequestBuilder(kitId kitId: Int32, kitAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/kit/{kitId}/audit/{kitAudit}"
    ...
    /**
     ...
     - parameter kitId: (path) Id of the kit to add a file to 
     - parameter fileName: (path) Name of file 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addKitFile(kitId kitId: Int32, fileName: String, completion: ((error: ErrorType?) -> Void)) {
        addKitFileWithRequestBuilder(kitId: kitId, fileName: fileName).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a kit
     - POST /v3.0/kit/{kitId}/file/{fileName}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addKitFileWithRequestBuilder(kitId kitId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/kit/{kitId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{kitId}", withString: "\(kitId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter kitId: (path) Id of the kit to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addKitFileByURL(body body: RecordFile, kitId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addKitFileByURLWithRequestBuilder(body: body, kitId: kitId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addKitFileByURLWithRequestBuilder(body body: RecordFile, kitId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/kit/{kitId}/file"
        path = path.stringByReplacingOccurrencesOfString("{kitId}", withString: "\(kitId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    public class func addKitTagWithRequestBuilder(kitId kitId: Int32, kitTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/kit/{kitId}/tag/{kitTag}"
        path = path.stringByReplacingOccurrencesOfString("{kitId}", withString: "\(kitId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter kitId: (path) Id of the kit to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteKitFile(kitId kitId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteKitFileWithRequestBuilder(kitId: kitId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a kit.
     - DELETE /v3.0/kit/{kitId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteKitFileWithRequestBuilder(kitId kitId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/kit/{kitId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{kitId}", withString: "\(kitId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a kit.
     - DELETE /v3.0/kit/{kitId}/tag/{kitTag}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getDuplicateKitByIdWithRequestBuilder(kitId kitId: Int32) -> RequestBuilder<Kit> {
        var path = "/v3.0/kit/duplicate/{kitId}"
        path = path.stringByReplacingOccurrencesOfString("{kitId}", withString: "\(kitId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     ...
     - parameter kitId: (path) Id of the kit to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getKitFiles(kitId kitId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getKitFilesWithRequestBuilder(kitId: kitId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getKitFilesWithRequestBuilder(kitId kitId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/kit/{kitId}/file"
        path = path.stringByReplacingOccurrencesOfString("{kitId}", withString: "\(kitId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    public class func updateKitCustomFieldsWithRequestBuilder(body body: Kit) -> RequestBuilder<Void> {
        let path = "/v3.0/kit/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
