...
public class LoggedTimeAPI: APIBase {
    ...
    /**
     Add new audit for a loggedTime
     - PUT /v3.0/loggedTime/{loggedTimeId}/audit/{loggedTimeAudit}
    ...
    public class func addLoggedTimeAuditWithRequestBuilder(loggedTimeId loggedTimeId: Int32, loggedTimeAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/loggedTime/{loggedTimeId}/audit/{loggedTimeAudit}"
    ...
    /**
     Attach a file to a loggedTime
     - POST /v3.0/loggedTime/{loggedTimeId}/file/{fileName}
    ...
    public class func addLoggedTimeFileWithRequestBuilder(loggedTimeId loggedTimeId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/loggedTime/{loggedTimeId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{loggedTimeId}", withString: "\(loggedTimeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter loggedTimeId: (path) Id of the loggedTime to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addLoggedTimeFileByURL(body body: RecordFile, loggedTimeId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addLoggedTimeFileByURLWithRequestBuilder(body: body, loggedTimeId: loggedTimeId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a loggedTime by URL.
     - POST /v3.0/loggedTime/{loggedTimeId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addLoggedTimeFileByURLWithRequestBuilder(body body: RecordFile, loggedTimeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/loggedTime/{loggedTimeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{loggedTimeId}", withString: "\(loggedTimeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Add new tags for a loggedTime.
     - PUT /v3.0/loggedTime/{loggedTimeId}/tag/{loggedTimeTag}
    ...
    public class func addLoggedTimeTagWithRequestBuilder(loggedTimeId loggedTimeId: Int32, loggedTimeTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/loggedTime/{loggedTimeId}/tag/{loggedTimeTag}"
        path = path.stringByReplacingOccurrencesOfString("{loggedTimeId}", withString: "\(loggedTimeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter loggedTimeId: (path) Id of the loggedTime to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteLoggedTimeFile(loggedTimeId loggedTimeId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteLoggedTimeFileWithRequestBuilder(loggedTimeId: loggedTimeId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a loggedTime.
     - DELETE /v3.0/loggedTime/{loggedTimeId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteLoggedTimeFileWithRequestBuilder(loggedTimeId loggedTimeId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/loggedTime/{loggedTimeId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{loggedTimeId}", withString: "\(loggedTimeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a loggedTime.
     - DELETE /v3.0/loggedTime/{loggedTimeId}/tag/{loggedTimeTag}
    ...
    /**
     Get a duplicated a loggedTime by id
     - GET /v3.0/loggedTime/duplicate/{loggedTimeId}
  ...
  "lobId" : 5
    ...
    public class func getDuplicateLoggedTimeByIdWithRequestBuilder(loggedTimeId loggedTimeId: Int32) -> RequestBuilder<LoggedTime> {
        var path = "/v3.0/loggedTime/duplicate/{loggedTimeId}"
        path = path.stringByReplacingOccurrencesOfString("{loggedTimeId}", withString: "\(loggedTimeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
  ...
  "lobId" : 5
    ...
    public class func getLoggedTimeByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[LoggedTime]> {
        let path = "/v3.0/loggedTime/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a loggedTime by id
     - GET /v3.0/loggedTime/{loggedTimeId}
  ...
  "lobId" : 5
    ...
    public class func getLoggedTimeByIdWithRequestBuilder(loggedTimeId loggedTimeId: Int32) -> RequestBuilder<LoggedTime> {
        var path = "/v3.0/loggedTime/{loggedTimeId}"
        path = path.stringByReplacingOccurrencesOfString("{loggedTimeId}", withString: "\(loggedTimeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter loggedTimeId: (path) Id of the loggedTime to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getLoggedTimeFiles(loggedTimeId loggedTimeId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getLoggedTimeFilesWithRequestBuilder(loggedTimeId: loggedTimeId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a loggedTime.
     - GET /v3.0/loggedTime/{loggedTimeId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getLoggedTimeFilesWithRequestBuilder(loggedTimeId loggedTimeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/loggedTime/{loggedTimeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{loggedTimeId}", withString: "\(loggedTimeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a loggedTime.
     - GET /v3.0/loggedTime/{loggedTimeId}/tag
    ...
    public class func getLoggedTimeTagsWithRequestBuilder(loggedTimeId loggedTimeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/loggedTime/{loggedTimeId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{loggedTimeId}", withString: "\(loggedTimeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update a loggedTime custom fields
     - PUT /v3.0/loggedTime/customFields
    ...
    public class func updateLoggedTimeCustomFieldsWithRequestBuilder(body body: LoggedTime) -> RequestBuilder<Void> {
        let path = "/v3.0/loggedTime/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
