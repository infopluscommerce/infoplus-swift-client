...
public class JobAPI: APIBase {
  ...
  "status" : "status"
    ...
    /**
     Add new audit for a job
     - PUT /v3.0/job/{jobId}/audit/{jobAudit}
    ...
    public class func addJobAuditWithRequestBuilder(jobId jobId: Int32, jobAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/job/{jobId}/audit/{jobAudit}"
    ...
    /**
     ...
     - parameter jobId: (path) Id of the job to add a file to 
     - parameter fileName: (path) Name of file 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addJobFile(jobId jobId: Int32, fileName: String, completion: ((error: ErrorType?) -> Void)) {
        addJobFileWithRequestBuilder(jobId: jobId, fileName: fileName).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a job
     - POST /v3.0/job/{jobId}/file/{fileName}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addJobFileWithRequestBuilder(jobId jobId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/job/{jobId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{jobId}", withString: "\(jobId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter jobId: (path) Id of the job to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addJobFileByURL(body body: RecordFile, jobId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addJobFileByURLWithRequestBuilder(body: body, jobId: jobId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addJobFileByURLWithRequestBuilder(body body: RecordFile, jobId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/job/{jobId}/file"
        path = path.stringByReplacingOccurrencesOfString("{jobId}", withString: "\(jobId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    public class func addJobTagWithRequestBuilder(jobId jobId: Int32, jobTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/job/{jobId}/tag/{jobTag}"
        path = path.stringByReplacingOccurrencesOfString("{jobId}", withString: "\(jobId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter jobId: (path) Id of the job to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteJobFile(jobId jobId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteJobFileWithRequestBuilder(jobId: jobId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a job.
     - DELETE /v3.0/job/{jobId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteJobFileWithRequestBuilder(jobId jobId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/job/{jobId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{jobId}", withString: "\(jobId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a job.
     - DELETE /v3.0/job/{jobId}/tag/{jobTag}
  ...
  "status" : "status"
    ...
    public class func getDuplicateJobByIdWithRequestBuilder(jobId jobId: Int32) -> RequestBuilder<Job> {
        var path = "/v3.0/job/duplicate/{jobId}"
        path = path.stringByReplacingOccurrencesOfString("{jobId}", withString: "\(jobId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
  ...
  "status" : "status"
    ...
    /**
     ...
     - parameter jobId: (path) Id of the job to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getJobFiles(jobId jobId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getJobFilesWithRequestBuilder(jobId: jobId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getJobFilesWithRequestBuilder(jobId jobId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/job/{jobId}/file"
        path = path.stringByReplacingOccurrencesOfString("{jobId}", withString: "\(jobId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    public class func updateJobCustomFieldsWithRequestBuilder(body body: Job) -> RequestBuilder<Void> {
        let path = "/v3.0/job/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
