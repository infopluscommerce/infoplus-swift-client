...
public class AsnAPI: APIBase {
  ...
  "status" : "status"
    ...
    /**
     Attach a file to an asn
     - POST /beta/asn/{asnId}/file/{fileName}
    ...
    public class func addAsnFileWithRequestBuilder(asnId asnId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/beta/asn/{asnId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{asnId}", withString: "\(asnId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter body: (body) Input data for ClosePurchProcess process. 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func closeAsn(body body: ClosePurchProcessInputAPIModel, completion: ((data: [ProcessOutputAPIModel]?, error: ErrorType?) -> Void)) {
        closeAsnWithRequestBuilder(body: body).execute { (response, error) -> Void in
            completion(data: response?.body, error: error);
        }
    }
  ...
  "status" : "status"
     ...
     */
    public class func closeAsnWithRequestBuilder(body body: ClosePurchProcessInputAPIModel) -> RequestBuilder<[ProcessOutputAPIModel]> {
        let path = "/beta/asn/closeAsn"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Delete a file for an asn.
     - DELETE /beta/asn/{asnId}/file/{fileId}
    ...
    public class func deleteAsnFileWithRequestBuilder(asnId asnId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/asn/{asnId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{asnId}", withString: "\(asnId)", options: .LiteralSearch, range: nil)
