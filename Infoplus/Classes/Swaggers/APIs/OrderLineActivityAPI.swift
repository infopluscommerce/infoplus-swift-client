...
public class OrderLineActivityAPI: APIBase {
  ...
  "chargedRate" : 9.2541839462678385785920909256674349308013916015625,
  "firstShipDate" : "2000-01-23T04:56:07.000+00:00",
  "alcoholUPCCode" : "alcoholUPCCode",
  "billToAttention" : "billToAttention",
  "subtotal" : 0.8774076871421565559927557842456735670566558837890625,
  ...
  "authorizationAmount" : 9.132027271330688478201409452594816684722900390625,
  "freight" : 5.5332583970349862312332334113307297229766845703125,
  "billToCompany" : "billToCompany",
  "productionType" : "productionType",
  "taxOnFreight" : 9.7029638000235660655334868351928889751434326171875,
  ...
  "distributionCharges" : 7.93350688173715123951978966942988336086273193359375,
  "itemSummaryCodeId" : 9,
  ...
  "orderWeightLbs" : 3.258856561904760695824734284542500972747802734375,
  "extendedSell" : 1.173074250955943309548956676735542714595794677734375,
  "orderedQty" : 9,
  "shipCode" : "shipCode",
  "processFlag" : "processFlag",
  "billingQuantity" : 8.863729185622826634016746538691222667694091796875,
  "orderModifyDate" : "2000-01-23T04:56:07.000+00:00",
  "authorizedBy" : "authorizedBy",
  "holdCode" : "holdCode",
  "deliverOnDate" : "2000-01-23T04:56:07.000+00:00",
  "totalDiscount" : 4.863159081028840091676102019846439361572265625,
  "priorityCode" : 6,
  ...
  "shippingCharge" : 5.5073869641798811613853104063309729099273681640625,
  ...
  "totalPaid" : 7.26052126480210358039357743109576404094696044921875,
  "orderSourceName" : "orderSourceName",
  "numberOfInnerPacks" : 6,
  "productionLot" : "productionLot",
  "tax" : 0.519900201872498524124921459588222205638885498046875,
  "alcoholContainerId" : 3,
  "groupOrderId" : 0.885137473901165261480628032586537301540374755859375,
  ...
  "extendedCharge" : 1.826870217705811594299802891327999532222747802734375,
  "chargeCode" : "chargeCode",
  "numberOfLineItems" : 6,
  "itemSubGroupId" : 9,
  "orderEstimatedWeightLbs" : 4.078845849666752343409825698472559452056884765625,
  ...
  "shipmentConfirmationEmailTemplateId" : 1,
  ...
  "shipVia" : "shipVia",
  "total" : 1.0414449161182959269211778519093059003353118896484375,
  "adjustCode" : 7,
  "slaDate" : "2000-01-23T04:56:07.000+00:00",
  "itemAccountCodeId" : 8,
  "shippedQty" : 2,
  "shipToCountry" : "shipToCountry",
  "balanceDue" : 4.67894798900584873990737833082675933837890625,
  "orderLoadProgramId" : 7,
  ...
  "backOrderStatus" : "backOrderStatus"
    ...
    public class func addOrderLineActivityWithRequestBuilder(body body: OrderLineActivity) -> RequestBuilder<OrderLineActivity> {
        let path = "/v3.0/orderLineActivity"
    ...
    /**
     Add new audit for an orderLineActivity
     - PUT /v3.0/orderLineActivity/{orderLineActivityId}/audit/{orderLineActivityAudit}
    ...
    public class func addOrderLineActivityAuditWithRequestBuilder(orderLineActivityId orderLineActivityId: Int32, orderLineActivityAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/orderLineActivity/{orderLineActivityId}/audit/{orderLineActivityAudit}"
    ...
    /**
     Attach a file to an orderLineActivity
     - POST /v3.0/orderLineActivity/{orderLineActivityId}/file/{fileName}
    ...
    public class func addOrderLineActivityFileWithRequestBuilder(orderLineActivityId orderLineActivityId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/orderLineActivity/{orderLineActivityId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{orderLineActivityId}", withString: "\(orderLineActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter orderLineActivityId: (path) Id of the orderLineActivity to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addOrderLineActivityFileByURL(body body: RecordFile, orderLineActivityId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addOrderLineActivityFileByURLWithRequestBuilder(body: body, orderLineActivityId: orderLineActivityId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an orderLineActivity by URL.
     - POST /v3.0/orderLineActivity/{orderLineActivityId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addOrderLineActivityFileByURLWithRequestBuilder(body body: RecordFile, orderLineActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/orderLineActivity/{orderLineActivityId}/file"
        path = path.stringByReplacingOccurrencesOfString("{orderLineActivityId}", withString: "\(orderLineActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for an orderLineActivity.
     - PUT /v3.0/orderLineActivity/{orderLineActivityId}/tag/{orderLineActivityTag}
    ...
    public class func addOrderLineActivityTagWithRequestBuilder(orderLineActivityId orderLineActivityId: Int32, orderLineActivityTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/orderLineActivity/{orderLineActivityId}/tag/{orderLineActivityTag}"
        path = path.stringByReplacingOccurrencesOfString("{orderLineActivityId}", withString: "\(orderLineActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete an orderLineActivity
     - DELETE /v3.0/orderLineActivity/{orderLineActivityId}
    ...
    public class func deleteOrderLineActivityWithRequestBuilder(orderLineActivityId orderLineActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/orderLineActivity/{orderLineActivityId}"
        path = path.stringByReplacingOccurrencesOfString("{orderLineActivityId}", withString: "\(orderLineActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter orderLineActivityId: (path) Id of the orderLineActivity to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteOrderLineActivityFile(orderLineActivityId orderLineActivityId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteOrderLineActivityFileWithRequestBuilder(orderLineActivityId: orderLineActivityId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for an orderLineActivity.
     - DELETE /v3.0/orderLineActivity/{orderLineActivityId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteOrderLineActivityFileWithRequestBuilder(orderLineActivityId orderLineActivityId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/orderLineActivity/{orderLineActivityId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{orderLineActivityId}", withString: "\(orderLineActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for an orderLineActivity.
     - DELETE /v3.0/orderLineActivity/{orderLineActivityId}/tag/{orderLineActivityTag}
    ...
    /**
     Get a duplicated an orderLineActivity by id
     - GET /v3.0/orderLineActivity/duplicate/{orderLineActivityId}
  ...
  "backOrderStatus" : "backOrderStatus"
    ...
    public class func getDuplicateOrderLineActivityByIdWithRequestBuilder(orderLineActivityId orderLineActivityId: Int32) -> RequestBuilder<OrderLineActivity> {
        var path = "/v3.0/orderLineActivity/duplicate/{orderLineActivityId}"
        path = path.stringByReplacingOccurrencesOfString("{orderLineActivityId}", withString: "\(orderLineActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search orderLineActivitys by filter
     - GET /v3.0/orderLineActivity/search
  ...
  "backOrderStatus" : "backOrderStatus"
    ...
    public class func getOrderLineActivityByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[OrderLineActivity]> {
        let path = "/v3.0/orderLineActivity/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get an orderLineActivity by id
     - GET /v3.0/orderLineActivity/{orderLineActivityId}
  ...
  "backOrderStatus" : "backOrderStatus"
    ...
    /**
     ...
     - parameter orderLineActivityId: (path) Id of the orderLineActivity to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getOrderLineActivityFiles(orderLineActivityId orderLineActivityId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getOrderLineActivityFilesWithRequestBuilder(orderLineActivityId: orderLineActivityId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for an orderLineActivity.
     - GET /v3.0/orderLineActivity/{orderLineActivityId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getOrderLineActivityFilesWithRequestBuilder(orderLineActivityId orderLineActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/orderLineActivity/{orderLineActivityId}/file"
        path = path.stringByReplacingOccurrencesOfString("{orderLineActivityId}", withString: "\(orderLineActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for an orderLineActivity.
     - GET /v3.0/orderLineActivity/{orderLineActivityId}/tag
    ...
    public class func getOrderLineActivityTagsWithRequestBuilder(orderLineActivityId orderLineActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/orderLineActivity/{orderLineActivityId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{orderLineActivityId}", withString: "\(orderLineActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
