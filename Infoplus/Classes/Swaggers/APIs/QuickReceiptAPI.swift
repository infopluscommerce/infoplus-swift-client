...
public class QuickReceiptAPI: APIBase {
  ...
  "status" : "status"
    ...
    /**
     Add new audit for a quickReceipt
     - PUT /v3.0/quickReceipt/{quickReceiptId}/audit/{quickReceiptAudit}
    ...
    public class func addQuickReceiptAuditWithRequestBuilder(quickReceiptId quickReceiptId: Int32, quickReceiptAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/quickReceipt/{quickReceiptId}/audit/{quickReceiptAudit}"
    ...
    /**
     Attach a file to a quickReceipt
     - POST /v3.0/quickReceipt/{quickReceiptId}/file/{fileName}
    ...
    public class func addQuickReceiptFileWithRequestBuilder(quickReceiptId quickReceiptId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/quickReceipt/{quickReceiptId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{quickReceiptId}", withString: "\(quickReceiptId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter quickReceiptId: (path) Id of the quickReceipt to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addQuickReceiptFileByURL(body body: RecordFile, quickReceiptId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addQuickReceiptFileByURLWithRequestBuilder(body: body, quickReceiptId: quickReceiptId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a quickReceipt by URL.
     - POST /v3.0/quickReceipt/{quickReceiptId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addQuickReceiptFileByURLWithRequestBuilder(body body: RecordFile, quickReceiptId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/quickReceipt/{quickReceiptId}/file"
        path = path.stringByReplacingOccurrencesOfString("{quickReceiptId}", withString: "\(quickReceiptId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for a quickReceipt.
     - PUT /v3.0/quickReceipt/{quickReceiptId}/tag/{quickReceiptTag}
    ...
    public class func addQuickReceiptTagWithRequestBuilder(quickReceiptId quickReceiptId: Int32, quickReceiptTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/quickReceipt/{quickReceiptId}/tag/{quickReceiptTag}"
        path = path.stringByReplacingOccurrencesOfString("{quickReceiptId}", withString: "\(quickReceiptId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a quickReceipt
     - DELETE /v3.0/quickReceipt/{quickReceiptId}
    ...
    public class func deleteQuickReceiptWithRequestBuilder(quickReceiptId quickReceiptId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/quickReceipt/{quickReceiptId}"
        path = path.stringByReplacingOccurrencesOfString("{quickReceiptId}", withString: "\(quickReceiptId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter quickReceiptId: (path) Id of the quickReceipt to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteQuickReceiptFile(quickReceiptId quickReceiptId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteQuickReceiptFileWithRequestBuilder(quickReceiptId: quickReceiptId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a quickReceipt.
     - DELETE /v3.0/quickReceipt/{quickReceiptId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteQuickReceiptFileWithRequestBuilder(quickReceiptId quickReceiptId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/quickReceipt/{quickReceiptId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{quickReceiptId}", withString: "\(quickReceiptId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a quickReceipt.
     - DELETE /v3.0/quickReceipt/{quickReceiptId}/tag/{quickReceiptTag}
    ...
    /**
     Run the ExecuteQuickReceipt process.
     - POST /v3.0/quickReceipt/executeQuickReceipt
     - 
     - API Key:
       - type: apiKey API-Key 
       - name: api_key
  ...
  "status" : "status"
    ...
    public class func executeQuickReceiptWithRequestBuilder(body body: ExecuteQuickReceiptInputAPIModel) -> RequestBuilder<[ProcessOutputAPIModel]> {
        let path = "/v3.0/quickReceipt/executeQuickReceipt"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Get a duplicated a quickReceipt by id
     - GET /v3.0/quickReceipt/duplicate/{quickReceiptId}
  ...
  "status" : "status"
    ...
    public class func getDuplicateQuickReceiptByIdWithRequestBuilder(quickReceiptId quickReceiptId: Int32) -> RequestBuilder<QuickReceipt> {
        var path = "/v3.0/quickReceipt/duplicate/{quickReceiptId}"
        path = path.stringByReplacingOccurrencesOfString("{quickReceiptId}", withString: "\(quickReceiptId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
  ...
  "status" : "status"
    ...
    public class func getQuickReceiptByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[QuickReceipt]> {
        let path = "/v3.0/quickReceipt/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a quickReceipt by id
     - GET /v3.0/quickReceipt/{quickReceiptId}
  ...
  "status" : "status"
    ...
    /**
     ...
     - parameter quickReceiptId: (path) Id of the quickReceipt to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getQuickReceiptFiles(quickReceiptId quickReceiptId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getQuickReceiptFilesWithRequestBuilder(quickReceiptId: quickReceiptId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a quickReceipt.
     - GET /v3.0/quickReceipt/{quickReceiptId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getQuickReceiptFilesWithRequestBuilder(quickReceiptId quickReceiptId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/quickReceipt/{quickReceiptId}/file"
        path = path.stringByReplacingOccurrencesOfString("{quickReceiptId}", withString: "\(quickReceiptId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a quickReceipt.
     - GET /v3.0/quickReceipt/{quickReceiptId}/tag
    ...
    public class func getQuickReceiptTagsWithRequestBuilder(quickReceiptId quickReceiptId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/quickReceipt/{quickReceiptId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{quickReceiptId}", withString: "\(quickReceiptId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update a quickReceipt custom fields
     - PUT /v3.0/quickReceipt/customFields
    ...
    public class func updateQuickReceiptCustomFieldsWithRequestBuilder(body body: QuickReceipt) -> RequestBuilder<Void> {
        let path = "/v3.0/quickReceipt/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
