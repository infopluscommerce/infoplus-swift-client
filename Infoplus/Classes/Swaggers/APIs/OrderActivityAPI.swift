...
public class OrderActivityAPI: APIBase {
  ...
  "chargedRate" : 5.5332583970349862312332334113307297229766845703125,
  "firstShipDate" : "2000-01-23T04:56:07.000+00:00",
  "shippingSystemName" : "shippingSystemName",
  "warehouseId" : 3,
  "billToAttention" : "billToAttention",
  "subtotal" : 6.438423552598546706349225132726132869720458984375,
  "integrationPartnerName" : "integrationPartnerName",
  "status" : "status",
  "warehouseServiceLevelId" : 3,
  "alternateUsage" : "alternateUsage",
  "authorizationAmount" : 9.0183481860707832566959041287191212177276611328125,
  "freight" : 1.489415909854170383397331534069962799549102783203125,
  "billToCompany" : "billToCompany",
  "productionType" : "productionType",
  "taxOnFreight" : 3.557195227068097320710649000830017030239105224609375,
  ...
  "distributionCharges" : 1.2846590061165319429647979632136411964893341064453125,
  "numberOfPallets" : 4,
  "legacyRestrictionType" : "legacyRestrictionType",
  "shipToPhone" : "shipToPhone",
  "needByDate" : "2000-01-23T04:56:07.000+00:00",
  "shipCode" : "shipCode",
  "billingQuantity" : 7.04836565559697003635619694250635802745819091796875,
  "orderModifyDate" : "2000-01-23T04:56:07.000+00:00",
  "authorizedBy" : "authorizedBy",
  "holdCode" : "holdCode",
  "deliverOnDate" : "2000-01-23T04:56:07.000+00:00",
  "totalDiscount" : 6.77832496304801335185175048536621034145355224609375,
  "priorityCode" : 7,
  ...
  "shippingCharge" : 2.884162126668780246063761296682059764862060546875,
  ...
  "totalPaid" : 8.7620420127490010742121739895083010196685791015625,
  "orderSourceName" : "orderSourceName",
  "numberOfInnerPacks" : 0,
  "tax" : 6.96511769763884558415156789124011993408203125,
  "groupOrderId" : 6.02745618307040320615897144307382404804229736328125,
  "orderInvoiceTemplateId" : 7,
  "billToCountry" : "billToCountry",
  "branchSector" : "branchSector",
  "billToPhone" : "billToPhone",
  "orderDate" : "2000-01-23T04:56:07.000+00:00",
  "extendedCharge" : 3.258856561904760695824734284542500972747802734375,
  "numberOfLineItems" : 5,
  ...
  "shipVia" : "shipVia",
  "total" : 9.3693102714106686335071572102606296539306640625,
  "slaDate" : "2000-01-23T04:56:07.000+00:00",
  "weightLbs" : 6.8468526983526398765889098285697400569915771484375,
  "estimatedWeightLbs" : 7.4577447736837658709418974467553198337554931640625,
  "shipToCountry" : "shipToCountry",
  "balanceDue" : 6.683562403749608193948006373830139636993408203125,
  ...
  "backOrderStatus" : "backOrderStatus"
    ...
    /**
     Attach a file to an orderActivity
     - POST /beta/orderActivity/{orderActivityId}/file/{fileName}
    ...
    public class func addOrderActivityFileWithRequestBuilder(orderActivityId orderActivityId: Double, fileName: String) -> RequestBuilder<Void> {
        var path = "/beta/orderActivity/{orderActivityId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{orderActivityId}", withString: "\(orderActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Attach a file to an orderActivity by URL.
     - POST /beta/orderActivity/{orderActivityId}/file
    ...
    public class func addOrderActivityFileByURLWithRequestBuilder(body body: RecordFile, orderActivityId: Double) -> RequestBuilder<Void> {
        var path = "/beta/orderActivity/{orderActivityId}/file"
        path = path.stringByReplacingOccurrencesOfString("{orderActivityId}", withString: "\(orderActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Delete a file for an orderActivity.
     - DELETE /beta/orderActivity/{orderActivityId}/file/{fileId}
    ...
    public class func deleteOrderActivityFileWithRequestBuilder(orderActivityId orderActivityId: Double, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/orderActivity/{orderActivityId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{orderActivityId}", withString: "\(orderActivityId)", options: .LiteralSearch, range: nil)
  ...
  "backOrderStatus" : "backOrderStatus"
    ...
    /**
     Get the files for an orderActivity.
     - GET /beta/orderActivity/{orderActivityId}/file
