...
public class BillingCodeTypeAPI: APIBase {
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     Add new audit for a billingCodeType
     - PUT /v3.0/billingCodeType/{billingCodeTypeId}/audit/{billingCodeTypeAudit}
    ...
    public class func addBillingCodeTypeAuditWithRequestBuilder(billingCodeTypeId billingCodeTypeId: Int32, billingCodeTypeAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeType/{billingCodeTypeId}/audit/{billingCodeTypeAudit}"
    ...
    /**
     ...
     - parameter billingCodeTypeId: (path) Id of the billingCodeType to add a file to 
     - parameter fileName: (path) Name of file 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addBillingCodeTypeFile(billingCodeTypeId billingCodeTypeId: Int32, fileName: String, completion: ((error: ErrorType?) -> Void)) {
        addBillingCodeTypeFileWithRequestBuilder(billingCodeTypeId: billingCodeTypeId, fileName: fileName).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a billingCodeType
     - POST /v3.0/billingCodeType/{billingCodeTypeId}/file/{fileName}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addBillingCodeTypeFileWithRequestBuilder(billingCodeTypeId billingCodeTypeId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeType/{billingCodeTypeId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeTypeId}", withString: "\(billingCodeTypeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter billingCodeTypeId: (path) Id of the billingCodeType to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addBillingCodeTypeFileByURL(body body: RecordFile, billingCodeTypeId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addBillingCodeTypeFileByURLWithRequestBuilder(body: body, billingCodeTypeId: billingCodeTypeId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a billingCodeType by URL.
     - POST /v3.0/billingCodeType/{billingCodeTypeId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addBillingCodeTypeFileByURLWithRequestBuilder(body body: RecordFile, billingCodeTypeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeType/{billingCodeTypeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeTypeId}", withString: "\(billingCodeTypeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for a billingCodeType.
     - PUT /v3.0/billingCodeType/{billingCodeTypeId}/tag/{billingCodeTypeTag}
    ...
    public class func addBillingCodeTypeTagWithRequestBuilder(billingCodeTypeId billingCodeTypeId: Int32, billingCodeTypeTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeType/{billingCodeTypeId}/tag/{billingCodeTypeTag}"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeTypeId}", withString: "\(billingCodeTypeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a billingCodeType
     - DELETE /v3.0/billingCodeType/{billingCodeTypeId}
    ...
    public class func deleteBillingCodeTypeWithRequestBuilder(billingCodeTypeId billingCodeTypeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeType/{billingCodeTypeId}"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeTypeId}", withString: "\(billingCodeTypeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter billingCodeTypeId: (path) Id of the billingCodeType to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteBillingCodeTypeFile(billingCodeTypeId billingCodeTypeId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteBillingCodeTypeFileWithRequestBuilder(billingCodeTypeId: billingCodeTypeId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a billingCodeType.
     - DELETE /v3.0/billingCodeType/{billingCodeTypeId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteBillingCodeTypeFileWithRequestBuilder(billingCodeTypeId billingCodeTypeId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeType/{billingCodeTypeId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeTypeId}", withString: "\(billingCodeTypeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a billingCodeType.
     - DELETE /v3.0/billingCodeType/{billingCodeTypeId}/tag/{billingCodeTypeTag}
    ...
    /**
     Search billingCodeTypes by filter
     - GET /v3.0/billingCodeType/search
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getBillingCodeTypeByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[BillingCodeType]> {
        let path = "/v3.0/billingCodeType/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a billingCodeType by id
     - GET /v3.0/billingCodeType/{billingCodeTypeId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     ...
     - parameter billingCodeTypeId: (path) Id of the billingCodeType to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getBillingCodeTypeFiles(billingCodeTypeId billingCodeTypeId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getBillingCodeTypeFilesWithRequestBuilder(billingCodeTypeId: billingCodeTypeId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a billingCodeType.
     - GET /v3.0/billingCodeType/{billingCodeTypeId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getBillingCodeTypeFilesWithRequestBuilder(billingCodeTypeId billingCodeTypeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeType/{billingCodeTypeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeTypeId}", withString: "\(billingCodeTypeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a billingCodeType.
     - GET /v3.0/billingCodeType/{billingCodeTypeId}/tag
    ...
    public class func getBillingCodeTypeTagsWithRequestBuilder(billingCodeTypeId billingCodeTypeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/billingCodeType/{billingCodeTypeId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeTypeId}", withString: "\(billingCodeTypeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a duplicated a billingCodeType by id
     - GET /v3.0/billingCodeType/duplicate/{billingCodeTypeId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getDuplicateBillingCodeTypeByIdWithRequestBuilder(billingCodeTypeId billingCodeTypeId: Int32) -> RequestBuilder<BillingCodeType> {
        var path = "/v3.0/billingCodeType/duplicate/{billingCodeTypeId}"
        path = path.stringByReplacingOccurrencesOfString("{billingCodeTypeId}", withString: "\(billingCodeTypeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update a billingCodeType custom fields
     - PUT /v3.0/billingCodeType/customFields
    ...
    public class func updateBillingCodeTypeCustomFieldsWithRequestBuilder(body body: BillingCodeType) -> RequestBuilder<Void> {
        let path = "/v3.0/billingCodeType/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
