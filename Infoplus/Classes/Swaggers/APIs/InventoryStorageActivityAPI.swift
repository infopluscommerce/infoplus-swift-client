...
public class InventoryStorageActivityAPI: APIBase {
    ...
    /**
     Create an inventoryStorageActivity
     - POST /v3.0/inventoryStorageActivity
  ...
  "itemMajorGroupName" : "itemMajorGroupName"
    ...
    public class func addInventoryStorageActivityWithRequestBuilder(body body: InventoryStorageActivity) -> RequestBuilder<InventoryStorageActivity> {
        let path = "/v3.0/inventoryStorageActivity"
    ...
    /**
     Add new audit for an inventoryStorageActivity
     - PUT /v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/audit/{inventoryStorageActivityAudit}
    ...
    public class func addInventoryStorageActivityAuditWithRequestBuilder(inventoryStorageActivityId inventoryStorageActivityId: Int32, inventoryStorageActivityAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/audit/{inventoryStorageActivityAudit}"
    ...
    /**
     Attach a file to an inventoryStorageActivity
     - POST /v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/file/{fileName}
    ...
    public class func addInventoryStorageActivityFileWithRequestBuilder(inventoryStorageActivityId inventoryStorageActivityId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{inventoryStorageActivityId}", withString: "\(inventoryStorageActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter inventoryStorageActivityId: (path) Id of the inventoryStorageActivity to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addInventoryStorageActivityFileByURL(body body: RecordFile, inventoryStorageActivityId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addInventoryStorageActivityFileByURLWithRequestBuilder(body: body, inventoryStorageActivityId: inventoryStorageActivityId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an inventoryStorageActivity by URL.
     - POST /v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addInventoryStorageActivityFileByURLWithRequestBuilder(body body: RecordFile, inventoryStorageActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/file"
        path = path.stringByReplacingOccurrencesOfString("{inventoryStorageActivityId}", withString: "\(inventoryStorageActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for an inventoryStorageActivity.
     - PUT /v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/tag/{inventoryStorageActivityTag}
    ...
    public class func addInventoryStorageActivityTagWithRequestBuilder(inventoryStorageActivityId inventoryStorageActivityId: Int32, inventoryStorageActivityTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/tag/{inventoryStorageActivityTag}"
        path = path.stringByReplacingOccurrencesOfString("{inventoryStorageActivityId}", withString: "\(inventoryStorageActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete an inventoryStorageActivity
     - DELETE /v3.0/inventoryStorageActivity/{inventoryStorageActivityId}
    ...
    public class func deleteInventoryStorageActivityWithRequestBuilder(inventoryStorageActivityId inventoryStorageActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}"
        path = path.stringByReplacingOccurrencesOfString("{inventoryStorageActivityId}", withString: "\(inventoryStorageActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter inventoryStorageActivityId: (path) Id of the inventoryStorageActivity to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteInventoryStorageActivityFile(inventoryStorageActivityId inventoryStorageActivityId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteInventoryStorageActivityFileWithRequestBuilder(inventoryStorageActivityId: inventoryStorageActivityId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for an inventoryStorageActivity.
     - DELETE /v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteInventoryStorageActivityFileWithRequestBuilder(inventoryStorageActivityId inventoryStorageActivityId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{inventoryStorageActivityId}", withString: "\(inventoryStorageActivityId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for an inventoryStorageActivity.
     - DELETE /v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/tag/{inventoryStorageActivityTag}
    ...
    /**
     Get a duplicated an inventoryStorageActivity by id
     - GET /v3.0/inventoryStorageActivity/duplicate/{inventoryStorageActivityId}
  ...
  "itemMajorGroupName" : "itemMajorGroupName"
    ...
    public class func getDuplicateInventoryStorageActivityByIdWithRequestBuilder(inventoryStorageActivityId inventoryStorageActivityId: Int32) -> RequestBuilder<InventoryStorageActivity> {
        var path = "/v3.0/inventoryStorageActivity/duplicate/{inventoryStorageActivityId}"
        path = path.stringByReplacingOccurrencesOfString("{inventoryStorageActivityId}", withString: "\(inventoryStorageActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search inventoryStorageActivitys by filter
     - GET /v3.0/inventoryStorageActivity/search
  ...
  "itemMajorGroupName" : "itemMajorGroupName"
    ...
    public class func getInventoryStorageActivityByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[InventoryStorageActivity]> {
        let path = "/v3.0/inventoryStorageActivity/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get an inventoryStorageActivity by id
     - GET /v3.0/inventoryStorageActivity/{inventoryStorageActivityId}
  ...
  "itemMajorGroupName" : "itemMajorGroupName"
    ...
    /**
     ...
     - parameter inventoryStorageActivityId: (path) Id of the inventoryStorageActivity to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getInventoryStorageActivityFiles(inventoryStorageActivityId inventoryStorageActivityId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getInventoryStorageActivityFilesWithRequestBuilder(inventoryStorageActivityId: inventoryStorageActivityId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for an inventoryStorageActivity.
     - GET /v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getInventoryStorageActivityFilesWithRequestBuilder(inventoryStorageActivityId inventoryStorageActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/file"
        path = path.stringByReplacingOccurrencesOfString("{inventoryStorageActivityId}", withString: "\(inventoryStorageActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for an inventoryStorageActivity.
     - GET /v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/tag
    ...
    public class func getInventoryStorageActivityTagsWithRequestBuilder(inventoryStorageActivityId inventoryStorageActivityId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{inventoryStorageActivityId}", withString: "\(inventoryStorageActivityId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update an inventoryStorageActivity
     - PUT /v3.0/inventoryStorageActivity
