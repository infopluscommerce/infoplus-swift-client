...
public class WarehouseDocumentTypeAPI: APIBase {
    ...
    /**
     Add new audit for a warehouseDocumentType
     - PUT /v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/audit/{warehouseDocumentTypeAudit}
    ...
    public class func addWarehouseDocumentTypeAuditWithRequestBuilder(warehouseDocumentTypeId warehouseDocumentTypeId: Int32, warehouseDocumentTypeAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/audit/{warehouseDocumentTypeAudit}"
    ...
    /**
     Attach a file to a warehouseDocumentType
     - POST /v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/file/{fileName}
    ...
    public class func addWarehouseDocumentTypeFileWithRequestBuilder(warehouseDocumentTypeId warehouseDocumentTypeId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{warehouseDocumentTypeId}", withString: "\(warehouseDocumentTypeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter warehouseDocumentTypeId: (path) Id of the warehouseDocumentType to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addWarehouseDocumentTypeFileByURL(body body: RecordFile, warehouseDocumentTypeId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addWarehouseDocumentTypeFileByURLWithRequestBuilder(body: body, warehouseDocumentTypeId: warehouseDocumentTypeId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a warehouseDocumentType by URL.
     - POST /v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addWarehouseDocumentTypeFileByURLWithRequestBuilder(body body: RecordFile, warehouseDocumentTypeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{warehouseDocumentTypeId}", withString: "\(warehouseDocumentTypeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Add new tags for a warehouseDocumentType.
     - PUT /v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/tag/{warehouseDocumentTypeTag}
    ...
    public class func addWarehouseDocumentTypeTagWithRequestBuilder(warehouseDocumentTypeId warehouseDocumentTypeId: Int32, warehouseDocumentTypeTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/tag/{warehouseDocumentTypeTag}"
        path = path.stringByReplacingOccurrencesOfString("{warehouseDocumentTypeId}", withString: "\(warehouseDocumentTypeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter warehouseDocumentTypeId: (path) Id of the warehouseDocumentType to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteWarehouseDocumentTypeFile(warehouseDocumentTypeId warehouseDocumentTypeId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteWarehouseDocumentTypeFileWithRequestBuilder(warehouseDocumentTypeId: warehouseDocumentTypeId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a warehouseDocumentType.
     - DELETE /v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteWarehouseDocumentTypeFileWithRequestBuilder(warehouseDocumentTypeId warehouseDocumentTypeId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{warehouseDocumentTypeId}", withString: "\(warehouseDocumentTypeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a warehouseDocumentType.
     - DELETE /v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/tag/{warehouseDocumentTypeTag}
    ...
    /**
     Get a duplicated a warehouseDocumentType by id
     - GET /v3.0/warehouseDocumentType/duplicate/{warehouseDocumentTypeId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getDuplicateWarehouseDocumentTypeByIdWithRequestBuilder(warehouseDocumentTypeId warehouseDocumentTypeId: Int32) -> RequestBuilder<WarehouseDocumentType> {
        var path = "/v3.0/warehouseDocumentType/duplicate/{warehouseDocumentTypeId}"
        path = path.stringByReplacingOccurrencesOfString("{warehouseDocumentTypeId}", withString: "\(warehouseDocumentTypeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search warehouseDocumentTypes by filter
     - GET /v3.0/warehouseDocumentType/search
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getWarehouseDocumentTypeByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[WarehouseDocumentType]> {
        let path = "/v3.0/warehouseDocumentType/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a warehouseDocumentType by id
     - GET /v3.0/warehouseDocumentType/{warehouseDocumentTypeId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getWarehouseDocumentTypeByIdWithRequestBuilder(warehouseDocumentTypeId warehouseDocumentTypeId: Int32) -> RequestBuilder<WarehouseDocumentType> {
        var path = "/v3.0/warehouseDocumentType/{warehouseDocumentTypeId}"
        path = path.stringByReplacingOccurrencesOfString("{warehouseDocumentTypeId}", withString: "\(warehouseDocumentTypeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter warehouseDocumentTypeId: (path) Id of the warehouseDocumentType to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getWarehouseDocumentTypeFiles(warehouseDocumentTypeId warehouseDocumentTypeId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getWarehouseDocumentTypeFilesWithRequestBuilder(warehouseDocumentTypeId: warehouseDocumentTypeId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a warehouseDocumentType.
     - GET /v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getWarehouseDocumentTypeFilesWithRequestBuilder(warehouseDocumentTypeId warehouseDocumentTypeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{warehouseDocumentTypeId}", withString: "\(warehouseDocumentTypeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a warehouseDocumentType.
     - GET /v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/tag
    ...
    public class func getWarehouseDocumentTypeTagsWithRequestBuilder(warehouseDocumentTypeId warehouseDocumentTypeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/warehouseDocumentType/{warehouseDocumentTypeId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{warehouseDocumentTypeId}", withString: "\(warehouseDocumentTypeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
