...
public class BusinessTransactionAPI: APIBase {
  ...
  "status" : "status"
    ...
    public class func addBusinessTransactionWithRequestBuilder(body body: BusinessTransaction) -> RequestBuilder<BusinessTransaction> {
        let path = "/beta/businessTransaction"
    ...
    /**
     Attach a file to a businessTransaction
     - POST /beta/businessTransaction/{businessTransactionId}/file/{fileName}
    ...
    public class func addBusinessTransactionFileWithRequestBuilder(businessTransactionId businessTransactionId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/beta/businessTransaction/{businessTransactionId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{businessTransactionId}", withString: "\(businessTransactionId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Attach a file to a businessTransaction by URL.
     - POST /beta/businessTransaction/{businessTransactionId}/file
    ...
    public class func addBusinessTransactionFileByURLWithRequestBuilder(body body: RecordFile, businessTransactionId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/businessTransaction/{businessTransactionId}/file"
        path = path.stringByReplacingOccurrencesOfString("{businessTransactionId}", withString: "\(businessTransactionId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Delete a file for a businessTransaction.
     - DELETE /beta/businessTransaction/{businessTransactionId}/file/{fileId}
    ...
    public class func deleteBusinessTransactionFileWithRequestBuilder(businessTransactionId businessTransactionId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/businessTransaction/{businessTransactionId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{businessTransactionId}", withString: "\(businessTransactionId)", options: .LiteralSearch, range: nil)
  ...
  "status" : "status"
    ...
    /**
     Get the files for a businessTransaction.
     - GET /beta/businessTransaction/{businessTransactionId}/file
