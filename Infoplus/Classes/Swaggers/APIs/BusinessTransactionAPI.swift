...
public class BusinessTransactionAPI: APIBase {
    /**
     ...
     - parameter body: (body) BusinessTransaction to be inserted. 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addBusinessTransaction(body body: BusinessTransaction, completion: ((data: BusinessTransaction?, error: ErrorType?) -> Void)) {
        addBusinessTransactionWithRequestBuilder(body: body).execute { (response, error) -> Void in
  ...
  "status" : "status"
     ...
     */
    public class func addBusinessTransactionWithRequestBuilder(body body: BusinessTransaction) -> RequestBuilder<BusinessTransaction> {
        let path = "/v3.0/businessTransaction"
    ...
    /**
     Add new audit for a businessTransaction
     - PUT /v3.0/businessTransaction/{businessTransactionId}/audit/{businessTransactionAudit}
    ...
    public class func addBusinessTransactionAuditWithRequestBuilder(businessTransactionId businessTransactionId: Int32, businessTransactionAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/businessTransaction/{businessTransactionId}/audit/{businessTransactionAudit}"
    ...
    /**
     ...
     - parameter businessTransactionId: (path) Id of the businessTransaction to add a file to 
     - parameter fileName: (path) Name of file 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addBusinessTransactionFile(businessTransactionId businessTransactionId: Int32, fileName: String, completion: ((error: ErrorType?) -> Void)) {
        addBusinessTransactionFileWithRequestBuilder(businessTransactionId: businessTransactionId, fileName: fileName).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a businessTransaction
     - POST /v3.0/businessTransaction/{businessTransactionId}/file/{fileName}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addBusinessTransactionFileWithRequestBuilder(businessTransactionId businessTransactionId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/businessTransaction/{businessTransactionId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{businessTransactionId}", withString: "\(businessTransactionId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter businessTransactionId: (path) Id of the businessTransaction to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addBusinessTransactionFileByURL(body body: RecordFile, businessTransactionId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addBusinessTransactionFileByURLWithRequestBuilder(body: body, businessTransactionId: businessTransactionId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a businessTransaction by URL.
     - POST /v3.0/businessTransaction/{businessTransactionId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addBusinessTransactionFileByURLWithRequestBuilder(body body: RecordFile, businessTransactionId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/businessTransaction/{businessTransactionId}/file"
        path = path.stringByReplacingOccurrencesOfString("{businessTransactionId}", withString: "\(businessTransactionId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for a businessTransaction.
     - PUT /v3.0/businessTransaction/{businessTransactionId}/tag/{businessTransactionTag}
    ...
    public class func addBusinessTransactionTagWithRequestBuilder(businessTransactionId businessTransactionId: Int32, businessTransactionTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/businessTransaction/{businessTransactionId}/tag/{businessTransactionTag}"
        path = path.stringByReplacingOccurrencesOfString("{businessTransactionId}", withString: "\(businessTransactionId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter businessTransactionId: (path) Id of the businessTransaction to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteBusinessTransactionFile(businessTransactionId businessTransactionId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteBusinessTransactionFileWithRequestBuilder(businessTransactionId: businessTransactionId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a businessTransaction.
     - DELETE /v3.0/businessTransaction/{businessTransactionId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteBusinessTransactionFileWithRequestBuilder(businessTransactionId businessTransactionId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/businessTransaction/{businessTransactionId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{businessTransactionId}", withString: "\(businessTransactionId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a businessTransaction.
     - DELETE /v3.0/businessTransaction/{businessTransactionId}/tag/{businessTransactionTag}
    ...
    /**
     Search businessTransactions by filter
     - GET /v3.0/businessTransaction/search
  ...
  "status" : "status"
    ...
    public class func getBusinessTransactionByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[BusinessTransaction]> {
        let path = "/v3.0/businessTransaction/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a businessTransaction by id
     - GET /v3.0/businessTransaction/{businessTransactionId}
  ...
  "status" : "status"
    ...
    public class func getBusinessTransactionByIdWithRequestBuilder(businessTransactionId businessTransactionId: Int32) -> RequestBuilder<BusinessTransaction> {
        var path = "/v3.0/businessTransaction/{businessTransactionId}"
        path = path.stringByReplacingOccurrencesOfString("{businessTransactionId}", withString: "\(businessTransactionId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter businessTransactionId: (path) Id of the businessTransaction to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getBusinessTransactionFiles(businessTransactionId businessTransactionId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getBusinessTransactionFilesWithRequestBuilder(businessTransactionId: businessTransactionId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a businessTransaction.
     - GET /v3.0/businessTransaction/{businessTransactionId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getBusinessTransactionFilesWithRequestBuilder(businessTransactionId businessTransactionId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/businessTransaction/{businessTransactionId}/file"
        path = path.stringByReplacingOccurrencesOfString("{businessTransactionId}", withString: "\(businessTransactionId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a businessTransaction.
     - GET /v3.0/businessTransaction/{businessTransactionId}/tag
    ...
    public class func getBusinessTransactionTagsWithRequestBuilder(businessTransactionId businessTransactionId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/businessTransaction/{businessTransactionId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{businessTransactionId}", withString: "\(businessTransactionId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a duplicated a businessTransaction by id
     - GET /v3.0/businessTransaction/duplicate/{businessTransactionId}
  ...
  "status" : "status"
    ...
    public class func getDuplicateBusinessTransactionByIdWithRequestBuilder(businessTransactionId businessTransactionId: Int32) -> RequestBuilder<BusinessTransaction> {
        var path = "/v3.0/businessTransaction/duplicate/{businessTransactionId}"
        path = path.stringByReplacingOccurrencesOfString("{businessTransactionId}", withString: "\(businessTransactionId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateBusinessTransaction(body body: BusinessTransaction, completion: ((error: ErrorType?) -> Void)) {
        updateBusinessTransactionWithRequestBuilder(body: body).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateBusinessTransactionWithRequestBuilder(body body: BusinessTransaction) -> RequestBuilder<Void> {
        let path = "/v3.0/businessTransaction"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Update a businessTransaction custom fields
     - PUT /v3.0/businessTransaction/customFields
    ...
    public class func updateBusinessTransactionCustomFieldsWithRequestBuilder(body body: BusinessTransaction) -> RequestBuilder<Void> {
        let path = "/v3.0/businessTransaction/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
