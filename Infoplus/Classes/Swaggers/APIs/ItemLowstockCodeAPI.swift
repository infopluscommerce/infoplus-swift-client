...
public class ItemLowstockCodeAPI: APIBase {
  ...
  "lobId" : 0
    ...
    public class func addItemLowstockCodeWithRequestBuilder(body body: ItemLowstockCode) -> RequestBuilder<ItemLowstockCode> {
        let path = "/v3.0/itemLowstockCode"
    ...
    /**
     Add new audit for an itemLowstockCode
     - PUT /v3.0/itemLowstockCode/{itemLowstockCodeId}/audit/{itemLowstockCodeAudit}
    ...
    public class func addItemLowstockCodeAuditWithRequestBuilder(itemLowstockCodeId itemLowstockCodeId: Int32, itemLowstockCodeAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemLowstockCode/{itemLowstockCodeId}/audit/{itemLowstockCodeAudit}"
    ...
    /**
     Attach a file to an itemLowstockCode
     - POST /v3.0/itemLowstockCode/{itemLowstockCodeId}/file/{fileName}
    ...
    public class func addItemLowstockCodeFileWithRequestBuilder(itemLowstockCodeId itemLowstockCodeId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemLowstockCode/{itemLowstockCodeId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{itemLowstockCodeId}", withString: "\(itemLowstockCodeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Attach a file to an itemLowstockCode by URL.
     - POST /v3.0/itemLowstockCode/{itemLowstockCodeId}/file
    ...
    public class func addItemLowstockCodeFileByURLWithRequestBuilder(body body: RecordFile, itemLowstockCodeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemLowstockCode/{itemLowstockCodeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{itemLowstockCodeId}", withString: "\(itemLowstockCodeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for an itemLowstockCode.
     - PUT /v3.0/itemLowstockCode/{itemLowstockCodeId}/tag/{itemLowstockCodeTag}
    ...
    public class func addItemLowstockCodeTagWithRequestBuilder(itemLowstockCodeId itemLowstockCodeId: Int32, itemLowstockCodeTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemLowstockCode/{itemLowstockCodeId}/tag/{itemLowstockCodeTag}"
        path = path.stringByReplacingOccurrencesOfString("{itemLowstockCodeId}", withString: "\(itemLowstockCodeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete an itemLowstockCode
     - DELETE /v3.0/itemLowstockCode/{itemLowstockCodeId}
    ...
    public class func deleteItemLowstockCodeWithRequestBuilder(itemLowstockCodeId itemLowstockCodeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemLowstockCode/{itemLowstockCodeId}"
        path = path.stringByReplacingOccurrencesOfString("{itemLowstockCodeId}", withString: "\(itemLowstockCodeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Delete a file for an itemLowstockCode.
     - DELETE /v3.0/itemLowstockCode/{itemLowstockCodeId}/file/{fileId}
    ...
    public class func deleteItemLowstockCodeFileWithRequestBuilder(itemLowstockCodeId itemLowstockCodeId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemLowstockCode/{itemLowstockCodeId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{itemLowstockCodeId}", withString: "\(itemLowstockCodeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for an itemLowstockCode.
     - DELETE /v3.0/itemLowstockCode/{itemLowstockCodeId}/tag/{itemLowstockCodeTag}
    ...
    /**
     Get a duplicated an itemLowstockCode by id
     - GET /v3.0/itemLowstockCode/duplicate/{itemLowstockCodeId}
  ...
  "lobId" : 0
    ...
    public class func getDuplicateItemLowstockCodeByIdWithRequestBuilder(itemLowstockCodeId itemLowstockCodeId: Int32) -> RequestBuilder<ItemLowstockCode> {
        var path = "/v3.0/itemLowstockCode/duplicate/{itemLowstockCodeId}"
        path = path.stringByReplacingOccurrencesOfString("{itemLowstockCodeId}", withString: "\(itemLowstockCodeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search itemLowstockCodes by filter
     - GET /v3.0/itemLowstockCode/search
  ...
  "lobId" : 0
    ...
    public class func getItemLowstockCodeByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[ItemLowstockCode]> {
        let path = "/v3.0/itemLowstockCode/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get an itemLowstockCode by id
     - GET /v3.0/itemLowstockCode/{itemLowstockCodeId}
  ...
  "lobId" : 0
    ...
    /**
     Get the files for an itemLowstockCode.
     - GET /v3.0/itemLowstockCode/{itemLowstockCodeId}/file
    ...
    /**
     Get the tags for an itemLowstockCode.
     - GET /v3.0/itemLowstockCode/{itemLowstockCodeId}/tag
    ...
    public class func getItemLowstockCodeTagsWithRequestBuilder(itemLowstockCodeId itemLowstockCodeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemLowstockCode/{itemLowstockCodeId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{itemLowstockCodeId}", withString: "\(itemLowstockCodeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
