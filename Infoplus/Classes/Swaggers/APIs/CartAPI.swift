...
public class CartAPI: APIBase {
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     Add new audit for a cart
     - PUT /v3.0/cart/{cartId}/audit/{cartAudit}
    ...
    public class func addCartAuditWithRequestBuilder(cartId cartId: Int32, cartAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/cart/{cartId}/audit/{cartAudit}"
    ...
    /**
     Attach a file to a cart
     - POST /v3.0/cart/{cartId}/file/{fileName}
    ...
    public class func addCartFileWithRequestBuilder(cartId cartId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/cart/{cartId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{cartId}", withString: "\(cartId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter cartId: (path) Id of the cart to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addCartFileByURL(body body: RecordFile, cartId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addCartFileByURLWithRequestBuilder(body: body, cartId: cartId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addCartFileByURLWithRequestBuilder(body body: RecordFile, cartId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/cart/{cartId}/file"
        path = path.stringByReplacingOccurrencesOfString("{cartId}", withString: "\(cartId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for a cart.
     - PUT /v3.0/cart/{cartId}/tag/{cartTag}
    ...
    public class func addCartTagWithRequestBuilder(cartId cartId: Int32, cartTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/cart/{cartId}/tag/{cartTag}"
        path = path.stringByReplacingOccurrencesOfString("{cartId}", withString: "\(cartId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter cartId: (path) Id of the cart to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteCartFile(cartId cartId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteCartFileWithRequestBuilder(cartId: cartId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a cart.
     - DELETE /v3.0/cart/{cartId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteCartFileWithRequestBuilder(cartId cartId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/cart/{cartId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{cartId}", withString: "\(cartId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a cart.
     - DELETE /v3.0/cart/{cartId}/tag/{cartTag}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     ...
     - parameter cartId: (path) Id of the cart to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getCartFiles(cartId cartId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getCartFilesWithRequestBuilder(cartId: cartId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getCartFilesWithRequestBuilder(cartId cartId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/cart/{cartId}/file"
        path = path.stringByReplacingOccurrencesOfString("{cartId}", withString: "\(cartId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a duplicated a cart by id
     - GET /v3.0/cart/duplicate/{cartId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getDuplicateCartByIdWithRequestBuilder(cartId cartId: Int32) -> RequestBuilder<Cart> {
        var path = "/v3.0/cart/duplicate/{cartId}"
        path = path.stringByReplacingOccurrencesOfString("{cartId}", withString: "\(cartId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
