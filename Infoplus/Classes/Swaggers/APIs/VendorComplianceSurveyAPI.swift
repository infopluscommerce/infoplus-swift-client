...
public class VendorComplianceSurveyAPI: APIBase {
    ...
    /**
     Create a vendorComplianceSurvey
     - POST /v3.0/vendorComplianceSurvey
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func addVendorComplianceSurveyWithRequestBuilder(body body: VendorComplianceSurvey) -> RequestBuilder<VendorComplianceSurvey> {
        let path = "/v3.0/vendorComplianceSurvey"
    ...
    /**
     Add new audit for a vendorComplianceSurvey
     - PUT /v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/audit/{vendorComplianceSurveyAudit}
    ...
    public class func addVendorComplianceSurveyAuditWithRequestBuilder(vendorComplianceSurveyId vendorComplianceSurveyId: Int32, vendorComplianceSurveyAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/audit/{vendorComplianceSurveyAudit}"
    ...
    /**
     Attach a file to a vendorComplianceSurvey
     - POST /v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/file/{fileName}
    ...
    public class func addVendorComplianceSurveyFileWithRequestBuilder(vendorComplianceSurveyId vendorComplianceSurveyId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{vendorComplianceSurveyId}", withString: "\(vendorComplianceSurveyId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter vendorComplianceSurveyId: (path) Id of the vendorComplianceSurvey to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addVendorComplianceSurveyFileByURL(body body: RecordFile, vendorComplianceSurveyId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addVendorComplianceSurveyFileByURLWithRequestBuilder(body: body, vendorComplianceSurveyId: vendorComplianceSurveyId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a vendorComplianceSurvey by URL.
     - POST /v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addVendorComplianceSurveyFileByURLWithRequestBuilder(body body: RecordFile, vendorComplianceSurveyId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/file"
        path = path.stringByReplacingOccurrencesOfString("{vendorComplianceSurveyId}", withString: "\(vendorComplianceSurveyId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for a vendorComplianceSurvey.
     - PUT /v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/tag/{vendorComplianceSurveyTag}
    ...
    public class func addVendorComplianceSurveyTagWithRequestBuilder(vendorComplianceSurveyId vendorComplianceSurveyId: Int32, vendorComplianceSurveyTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/tag/{vendorComplianceSurveyTag}"
        path = path.stringByReplacingOccurrencesOfString("{vendorComplianceSurveyId}", withString: "\(vendorComplianceSurveyId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a vendorComplianceSurvey
     - DELETE /v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}
    ...
    public class func deleteVendorComplianceSurveyWithRequestBuilder(vendorComplianceSurveyId vendorComplianceSurveyId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}"
        path = path.stringByReplacingOccurrencesOfString("{vendorComplianceSurveyId}", withString: "\(vendorComplianceSurveyId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter vendorComplianceSurveyId: (path) Id of the vendorComplianceSurvey to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteVendorComplianceSurveyFile(vendorComplianceSurveyId vendorComplianceSurveyId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteVendorComplianceSurveyFileWithRequestBuilder(vendorComplianceSurveyId: vendorComplianceSurveyId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a vendorComplianceSurvey.
     - DELETE /v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteVendorComplianceSurveyFileWithRequestBuilder(vendorComplianceSurveyId vendorComplianceSurveyId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{vendorComplianceSurveyId}", withString: "\(vendorComplianceSurveyId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a vendorComplianceSurvey.
     - DELETE /v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/tag/{vendorComplianceSurveyTag}
    ...
    /**
     Get a duplicated a vendorComplianceSurvey by id
     - GET /v3.0/vendorComplianceSurvey/duplicate/{vendorComplianceSurveyId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getDuplicateVendorComplianceSurveyByIdWithRequestBuilder(vendorComplianceSurveyId vendorComplianceSurveyId: Int32) -> RequestBuilder<VendorComplianceSurvey> {
        var path = "/v3.0/vendorComplianceSurvey/duplicate/{vendorComplianceSurveyId}"
        path = path.stringByReplacingOccurrencesOfString("{vendorComplianceSurveyId}", withString: "\(vendorComplianceSurveyId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search vendorComplianceSurveys by filter
     - GET /v3.0/vendorComplianceSurvey/search
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getVendorComplianceSurveyByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[VendorComplianceSurvey]> {
        let path = "/v3.0/vendorComplianceSurvey/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a vendorComplianceSurvey by id
     - GET /v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     ...
     - parameter vendorComplianceSurveyId: (path) Id of the vendorComplianceSurvey to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getVendorComplianceSurveyFiles(vendorComplianceSurveyId vendorComplianceSurveyId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getVendorComplianceSurveyFilesWithRequestBuilder(vendorComplianceSurveyId: vendorComplianceSurveyId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a vendorComplianceSurvey.
     - GET /v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getVendorComplianceSurveyFilesWithRequestBuilder(vendorComplianceSurveyId vendorComplianceSurveyId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/file"
        path = path.stringByReplacingOccurrencesOfString("{vendorComplianceSurveyId}", withString: "\(vendorComplianceSurveyId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a vendorComplianceSurvey.
     - GET /v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/tag
    ...
    public class func getVendorComplianceSurveyTagsWithRequestBuilder(vendorComplianceSurveyId vendorComplianceSurveyId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/vendorComplianceSurvey/{vendorComplianceSurveyId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{vendorComplianceSurveyId}", withString: "\(vendorComplianceSurveyId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update a vendorComplianceSurvey
     - PUT /v3.0/vendorComplianceSurvey
    ...
    /**
     Update a vendorComplianceSurvey custom fields
     - PUT /v3.0/vendorComplianceSurvey/customFields
    ...
    public class func updateVendorComplianceSurveyCustomFieldsWithRequestBuilder(body body: VendorComplianceSurvey) -> RequestBuilder<Void> {
        let path = "/v3.0/vendorComplianceSurvey/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
