...
public class VendorComplianceSurveyAPI: APIBase {
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     Attach a file to a vendorComplianceSurvey by URL.
     - POST /beta/vendorComplianceSurvey/{vendorComplianceSurveyId}/file
    ...
    public class func addVendorComplianceSurveyFileByURLWithRequestBuilder(body body: RecordFile, vendorComplianceSurveyId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/vendorComplianceSurvey/{vendorComplianceSurveyId}/file"
        path = path.stringByReplacingOccurrencesOfString("{vendorComplianceSurveyId}", withString: "\(vendorComplianceSurveyId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Delete a file for a vendorComplianceSurvey.
     - DELETE /beta/vendorComplianceSurvey/{vendorComplianceSurveyId}/file/{fileId}
    ...
    public class func deleteVendorComplianceSurveyFileWithRequestBuilder(vendorComplianceSurveyId vendorComplianceSurveyId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/vendorComplianceSurvey/{vendorComplianceSurveyId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{vendorComplianceSurveyId}", withString: "\(vendorComplianceSurveyId)", options: .LiteralSearch, range: nil)
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     Get the files for a vendorComplianceSurvey.
     - GET /beta/vendorComplianceSurvey/{vendorComplianceSurveyId}/file
