...
public class FinanceSystemConnectionLogAPI: APIBase {
    ...
    /**
     Add new audit for a financeSystemConnectionLog
     - PUT /v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/audit/{financeSystemConnectionLogAudit}
    ...
    public class func addFinanceSystemConnectionLogAuditWithRequestBuilder(financeSystemConnectionLogId financeSystemConnectionLogId: Int32, financeSystemConnectionLogAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/audit/{financeSystemConnectionLogAudit}"
    ...
    /**
     Attach a file to a financeSystemConnectionLog
     - POST /v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/file/{fileName}
    ...
    public class func addFinanceSystemConnectionLogFileWithRequestBuilder(financeSystemConnectionLogId financeSystemConnectionLogId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{financeSystemConnectionLogId}", withString: "\(financeSystemConnectionLogId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter financeSystemConnectionLogId: (path) Id of the financeSystemConnectionLog to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addFinanceSystemConnectionLogFileByURL(body body: RecordFile, financeSystemConnectionLogId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addFinanceSystemConnectionLogFileByURLWithRequestBuilder(body: body, financeSystemConnectionLogId: financeSystemConnectionLogId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a financeSystemConnectionLog by URL.
     - POST /v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addFinanceSystemConnectionLogFileByURLWithRequestBuilder(body body: RecordFile, financeSystemConnectionLogId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/file"
        path = path.stringByReplacingOccurrencesOfString("{financeSystemConnectionLogId}", withString: "\(financeSystemConnectionLogId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Add new tags for a financeSystemConnectionLog.
     - PUT /v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/tag/{financeSystemConnectionLogTag}
    ...
    public class func addFinanceSystemConnectionLogTagWithRequestBuilder(financeSystemConnectionLogId financeSystemConnectionLogId: Int32, financeSystemConnectionLogTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/tag/{financeSystemConnectionLogTag}"
        path = path.stringByReplacingOccurrencesOfString("{financeSystemConnectionLogId}", withString: "\(financeSystemConnectionLogId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter financeSystemConnectionLogId: (path) Id of the financeSystemConnectionLog to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteFinanceSystemConnectionLogFile(financeSystemConnectionLogId financeSystemConnectionLogId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteFinanceSystemConnectionLogFileWithRequestBuilder(financeSystemConnectionLogId: financeSystemConnectionLogId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a financeSystemConnectionLog.
     - DELETE /v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteFinanceSystemConnectionLogFileWithRequestBuilder(financeSystemConnectionLogId financeSystemConnectionLogId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{financeSystemConnectionLogId}", withString: "\(financeSystemConnectionLogId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a financeSystemConnectionLog.
     - DELETE /v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/tag/{financeSystemConnectionLogTag}
    ...
    /**
     Get a duplicated a financeSystemConnectionLog by id
     - GET /v3.0/financeSystemConnectionLog/duplicate/{financeSystemConnectionLogId}
  ...
  "adjustmentIdId" : 2
    ...
    public class func getDuplicateFinanceSystemConnectionLogByIdWithRequestBuilder(financeSystemConnectionLogId financeSystemConnectionLogId: Int32) -> RequestBuilder<FinanceSystemConnectionLog> {
        var path = "/v3.0/financeSystemConnectionLog/duplicate/{financeSystemConnectionLogId}"
        path = path.stringByReplacingOccurrencesOfString("{financeSystemConnectionLogId}", withString: "\(financeSystemConnectionLogId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search financeSystemConnectionLogs by filter
     - GET /v3.0/financeSystemConnectionLog/search
  ...
  "adjustmentIdId" : 2
    ...
    public class func getFinanceSystemConnectionLogByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[FinanceSystemConnectionLog]> {
        let path = "/v3.0/financeSystemConnectionLog/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a financeSystemConnectionLog by id
     - GET /v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}
  ...
  "adjustmentIdId" : 2
    ...
    public class func getFinanceSystemConnectionLogByIdWithRequestBuilder(financeSystemConnectionLogId financeSystemConnectionLogId: Int32) -> RequestBuilder<FinanceSystemConnectionLog> {
        var path = "/v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}"
        path = path.stringByReplacingOccurrencesOfString("{financeSystemConnectionLogId}", withString: "\(financeSystemConnectionLogId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter financeSystemConnectionLogId: (path) Id of the financeSystemConnectionLog to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getFinanceSystemConnectionLogFiles(financeSystemConnectionLogId financeSystemConnectionLogId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getFinanceSystemConnectionLogFilesWithRequestBuilder(financeSystemConnectionLogId: financeSystemConnectionLogId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a financeSystemConnectionLog.
     - GET /v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getFinanceSystemConnectionLogFilesWithRequestBuilder(financeSystemConnectionLogId financeSystemConnectionLogId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/file"
        path = path.stringByReplacingOccurrencesOfString("{financeSystemConnectionLogId}", withString: "\(financeSystemConnectionLogId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a financeSystemConnectionLog.
     - GET /v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/tag
    ...
    public class func getFinanceSystemConnectionLogTagsWithRequestBuilder(financeSystemConnectionLogId financeSystemConnectionLogId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/financeSystemConnectionLog/{financeSystemConnectionLogId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{financeSystemConnectionLogId}", withString: "\(financeSystemConnectionLogId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
