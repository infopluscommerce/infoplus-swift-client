...
public class JobTimeAPI: APIBase {
  ...
  "lobId" : 5
    ...
    /**
     Add new audit for a jobTime
     - PUT /v3.0/jobTime/{jobTimeId}/audit/{jobTimeAudit}
    ...
    public class func addJobTimeAuditWithRequestBuilder(jobTimeId jobTimeId: Int32, jobTimeAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/jobTime/{jobTimeId}/audit/{jobTimeAudit}"
    ...
    /**
     Attach a file to a jobTime
     - POST /v3.0/jobTime/{jobTimeId}/file/{fileName}
    ...
    public class func addJobTimeFileWithRequestBuilder(jobTimeId jobTimeId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/jobTime/{jobTimeId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{jobTimeId}", withString: "\(jobTimeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter jobTimeId: (path) Id of the jobTime to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addJobTimeFileByURL(body body: RecordFile, jobTimeId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addJobTimeFileByURLWithRequestBuilder(body: body, jobTimeId: jobTimeId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a jobTime by URL.
     - POST /v3.0/jobTime/{jobTimeId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addJobTimeFileByURLWithRequestBuilder(body body: RecordFile, jobTimeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/jobTime/{jobTimeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{jobTimeId}", withString: "\(jobTimeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for a jobTime.
     - PUT /v3.0/jobTime/{jobTimeId}/tag/{jobTimeTag}
    ...
    public class func addJobTimeTagWithRequestBuilder(jobTimeId jobTimeId: Int32, jobTimeTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/jobTime/{jobTimeId}/tag/{jobTimeTag}"
        path = path.stringByReplacingOccurrencesOfString("{jobTimeId}", withString: "\(jobTimeId)", options: .LiteralSearch, range: nil)
    ...
    public class func deleteJobTimeWithRequestBuilder(jobTimeId jobTimeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/jobTime/{jobTimeId}"
        path = path.stringByReplacingOccurrencesOfString("{jobTimeId}", withString: "\(jobTimeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter jobTimeId: (path) Id of the jobTime to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteJobTimeFile(jobTimeId jobTimeId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteJobTimeFileWithRequestBuilder(jobTimeId: jobTimeId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a jobTime.
     - DELETE /v3.0/jobTime/{jobTimeId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteJobTimeFileWithRequestBuilder(jobTimeId jobTimeId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/jobTime/{jobTimeId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{jobTimeId}", withString: "\(jobTimeId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a jobTime.
     - DELETE /v3.0/jobTime/{jobTimeId}/tag/{jobTimeTag}
    ...
    /**
     Get a duplicated a jobTime by id
     - GET /v3.0/jobTime/duplicate/{jobTimeId}
  ...
  "lobId" : 5
    ...
    public class func getDuplicateJobTimeByIdWithRequestBuilder(jobTimeId jobTimeId: Int32) -> RequestBuilder<JobTime> {
        var path = "/v3.0/jobTime/duplicate/{jobTimeId}"
        path = path.stringByReplacingOccurrencesOfString("{jobTimeId}", withString: "\(jobTimeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
  ...
  "lobId" : 5
    ...
    /**
     ...
     - parameter jobTimeId: (path) Id of the jobTime to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getJobTimeFiles(jobTimeId jobTimeId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getJobTimeFilesWithRequestBuilder(jobTimeId: jobTimeId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a jobTime.
     - GET /v3.0/jobTime/{jobTimeId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getJobTimeFilesWithRequestBuilder(jobTimeId jobTimeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/jobTime/{jobTimeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{jobTimeId}", withString: "\(jobTimeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a jobTime.
     - GET /v3.0/jobTime/{jobTimeId}/tag
    ...
    public class func getJobTimeTagsWithRequestBuilder(jobTimeId jobTimeId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/jobTime/{jobTimeId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{jobTimeId}", withString: "\(jobTimeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    public class func updateJobTimeCustomFieldsWithRequestBuilder(body body: JobTime) -> RequestBuilder<Void> {
        let path = "/v3.0/jobTime/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
