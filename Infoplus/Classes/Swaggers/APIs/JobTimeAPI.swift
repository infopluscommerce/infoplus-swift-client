...
public class JobTimeAPI: APIBase {
  ...
  "lobId" : 5
    ...
    /**
     Attach a file to a jobTime by URL.
     - POST /beta/jobTime/{jobTimeId}/file
    ...
    public class func addJobTimeFileByURLWithRequestBuilder(body body: RecordFile, jobTimeId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/jobTime/{jobTimeId}/file"
        path = path.stringByReplacingOccurrencesOfString("{jobTimeId}", withString: "\(jobTimeId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Delete a file for a jobTime.
     - DELETE /beta/jobTime/{jobTimeId}/file/{fileId}
    ...
    public class func deleteJobTimeFileWithRequestBuilder(jobTimeId jobTimeId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/jobTime/{jobTimeId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{jobTimeId}", withString: "\(jobTimeId)", options: .LiteralSearch, range: nil)
  ...
  "lobId" : 5
    ...
    /**
     Get the files for a jobTime.
     - GET /beta/jobTime/{jobTimeId}/file
