...
public class WarehouseAPI: APIBase {
    /**
     ...
     - parameter body: (body) Warehouse to be inserted. 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addWarehouse(body body: Warehouse, completion: ((data: Warehouse?, error: ErrorType?) -> Void)) {
        addWarehouseWithRequestBuilder(body: body).execute { (response, error) -> Void in
  ...
  "packStationRequireConfirmOnError" : false
     ...
     */
    public class func addWarehouseWithRequestBuilder(body body: Warehouse) -> RequestBuilder<Warehouse> {
        let path = "/v3.0/warehouse"
    ...
    /**
     Add new audit for a warehouse
     - PUT /v3.0/warehouse/{warehouseId}/audit/{warehouseAudit}
    ...
    public class func addWarehouseAuditWithRequestBuilder(warehouseId warehouseId: Int32, warehouseAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/warehouse/{warehouseId}/audit/{warehouseAudit}"
    ...
    /**
     Attach a file to a warehouse
     - POST /v3.0/warehouse/{warehouseId}/file/{fileName}
    ...
    public class func addWarehouseFileWithRequestBuilder(warehouseId warehouseId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/warehouse/{warehouseId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{warehouseId}", withString: "\(warehouseId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter warehouseId: (path) Id of the warehouse to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addWarehouseFileByURL(body body: RecordFile, warehouseId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addWarehouseFileByURLWithRequestBuilder(body: body, warehouseId: warehouseId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a warehouse by URL.
     - POST /v3.0/warehouse/{warehouseId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addWarehouseFileByURLWithRequestBuilder(body body: RecordFile, warehouseId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/warehouse/{warehouseId}/file"
        path = path.stringByReplacingOccurrencesOfString("{warehouseId}", withString: "\(warehouseId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for a warehouse.
     - PUT /v3.0/warehouse/{warehouseId}/tag/{warehouseTag}
    ...
    public class func addWarehouseTagWithRequestBuilder(warehouseId warehouseId: Int32, warehouseTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/warehouse/{warehouseId}/tag/{warehouseTag}"
        path = path.stringByReplacingOccurrencesOfString("{warehouseId}", withString: "\(warehouseId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter warehouseId: (path) Id of the warehouse to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteWarehouseFile(warehouseId warehouseId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteWarehouseFileWithRequestBuilder(warehouseId: warehouseId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a warehouse.
     - DELETE /v3.0/warehouse/{warehouseId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteWarehouseFileWithRequestBuilder(warehouseId warehouseId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/warehouse/{warehouseId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{warehouseId}", withString: "\(warehouseId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a warehouse.
     - DELETE /v3.0/warehouse/{warehouseId}/tag/{warehouseTag}
    ...
    /**
     Get a duplicated a warehouse by id
     - GET /v3.0/warehouse/duplicate/{warehouseId}
  ...
  "packStationRequireConfirmOnError" : false
    ...
    public class func getDuplicateWarehouseByIdWithRequestBuilder(warehouseId warehouseId: Int32) -> RequestBuilder<Warehouse> {
        var path = "/v3.0/warehouse/duplicate/{warehouseId}"
        path = path.stringByReplacingOccurrencesOfString("{warehouseId}", withString: "\(warehouseId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
  ...
  "packStationRequireConfirmOnError" : false
    ...
    public class func getWarehouseByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[Warehouse]> {
        let path = "/v3.0/warehouse/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a warehouse by id
     - GET /v3.0/warehouse/{warehouseId}
  ...
  "packStationRequireConfirmOnError" : false
    ...
    public class func getWarehouseByIdWithRequestBuilder(warehouseId warehouseId: Int32) -> RequestBuilder<Warehouse> {
        var path = "/v3.0/warehouse/{warehouseId}"
        path = path.stringByReplacingOccurrencesOfString("{warehouseId}", withString: "\(warehouseId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter warehouseId: (path) Id of the warehouse to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getWarehouseFiles(warehouseId warehouseId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getWarehouseFilesWithRequestBuilder(warehouseId: warehouseId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a warehouse.
     - GET /v3.0/warehouse/{warehouseId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getWarehouseFilesWithRequestBuilder(warehouseId warehouseId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/warehouse/{warehouseId}/file"
        path = path.stringByReplacingOccurrencesOfString("{warehouseId}", withString: "\(warehouseId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a warehouse.
     - GET /v3.0/warehouse/{warehouseId}/tag
    ...
    public class func getWarehouseTagsWithRequestBuilder(warehouseId warehouseId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/warehouse/{warehouseId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{warehouseId}", withString: "\(warehouseId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update a warehouse custom fields
     - PUT /v3.0/warehouse/customFields
    ...
    public class func updateWarehouseCustomFieldsWithRequestBuilder(body body: Warehouse) -> RequestBuilder<Void> {
        let path = "/v3.0/warehouse/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
