...
public class InventoryDetailAPI: APIBase {
    ...
    /**
     Add new audit for an inventoryDetail
     - PUT /v3.0/inventoryDetail/{inventoryDetailId}/audit/{inventoryDetailAudit}
    ...
    public class func addInventoryDetailAuditWithRequestBuilder(inventoryDetailId inventoryDetailId: Int32, inventoryDetailAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryDetail/{inventoryDetailId}/audit/{inventoryDetailAudit}"
    ...
    /**
     ...
     - parameter inventoryDetailId: (path) Id of the inventoryDetail to add a file to 
     - parameter fileName: (path) Name of file 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addInventoryDetailFile(inventoryDetailId inventoryDetailId: Int32, fileName: String, completion: ((error: ErrorType?) -> Void)) {
        addInventoryDetailFileWithRequestBuilder(inventoryDetailId: inventoryDetailId, fileName: fileName).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an inventoryDetail
     - POST /v3.0/inventoryDetail/{inventoryDetailId}/file/{fileName}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addInventoryDetailFileWithRequestBuilder(inventoryDetailId inventoryDetailId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryDetail/{inventoryDetailId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{inventoryDetailId}", withString: "\(inventoryDetailId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter inventoryDetailId: (path) Id of the inventoryDetail to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addInventoryDetailFileByURL(body body: RecordFile, inventoryDetailId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addInventoryDetailFileByURLWithRequestBuilder(body: body, inventoryDetailId: inventoryDetailId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an inventoryDetail by URL.
     - POST /v3.0/inventoryDetail/{inventoryDetailId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addInventoryDetailFileByURLWithRequestBuilder(body body: RecordFile, inventoryDetailId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryDetail/{inventoryDetailId}/file"
        path = path.stringByReplacingOccurrencesOfString("{inventoryDetailId}", withString: "\(inventoryDetailId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Add new tags for an inventoryDetail.
     - PUT /v3.0/inventoryDetail/{inventoryDetailId}/tag/{inventoryDetailTag}
    ...
    public class func addInventoryDetailTagWithRequestBuilder(inventoryDetailId inventoryDetailId: Int32, inventoryDetailTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryDetail/{inventoryDetailId}/tag/{inventoryDetailTag}"
        path = path.stringByReplacingOccurrencesOfString("{inventoryDetailId}", withString: "\(inventoryDetailId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter inventoryDetailId: (path) Id of the inventoryDetail to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteInventoryDetailFile(inventoryDetailId inventoryDetailId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteInventoryDetailFileWithRequestBuilder(inventoryDetailId: inventoryDetailId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for an inventoryDetail.
     - DELETE /v3.0/inventoryDetail/{inventoryDetailId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteInventoryDetailFileWithRequestBuilder(inventoryDetailId inventoryDetailId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryDetail/{inventoryDetailId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{inventoryDetailId}", withString: "\(inventoryDetailId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for an inventoryDetail.
     - DELETE /v3.0/inventoryDetail/{inventoryDetailId}/tag/{inventoryDetailTag}
    ...
    /**
     Get a duplicated an inventoryDetail by id
     - GET /v3.0/inventoryDetail/duplicate/{inventoryDetailId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getDuplicateInventoryDetailByIdWithRequestBuilder(inventoryDetailId inventoryDetailId: Int32) -> RequestBuilder<InventoryDetail> {
        var path = "/v3.0/inventoryDetail/duplicate/{inventoryDetailId}"
        path = path.stringByReplacingOccurrencesOfString("{inventoryDetailId}", withString: "\(inventoryDetailId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Search inventoryDetails by filter
     - GET /v3.0/inventoryDetail/search
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getInventoryDetailByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[InventoryDetail]> {
        let path = "/v3.0/inventoryDetail/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get an inventoryDetail by id
     - GET /v3.0/inventoryDetail/{inventoryDetailId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getInventoryDetailByIdWithRequestBuilder(inventoryDetailId inventoryDetailId: Int32) -> RequestBuilder<InventoryDetail> {
        var path = "/v3.0/inventoryDetail/{inventoryDetailId}"
        path = path.stringByReplacingOccurrencesOfString("{inventoryDetailId}", withString: "\(inventoryDetailId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter inventoryDetailId: (path) Id of the inventoryDetail to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getInventoryDetailFiles(inventoryDetailId inventoryDetailId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getInventoryDetailFilesWithRequestBuilder(inventoryDetailId: inventoryDetailId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for an inventoryDetail.
     - GET /v3.0/inventoryDetail/{inventoryDetailId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getInventoryDetailFilesWithRequestBuilder(inventoryDetailId inventoryDetailId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryDetail/{inventoryDetailId}/file"
        path = path.stringByReplacingOccurrencesOfString("{inventoryDetailId}", withString: "\(inventoryDetailId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for an inventoryDetail.
     - GET /v3.0/inventoryDetail/{inventoryDetailId}/tag
    ...
    public class func getInventoryDetailTagsWithRequestBuilder(inventoryDetailId inventoryDetailId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/inventoryDetail/{inventoryDetailId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{inventoryDetailId}", withString: "\(inventoryDetailId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update an inventoryDetail custom fields
     - PUT /v3.0/inventoryDetail/customFields
    ...
    public class func updateInventoryDetailCustomFieldsWithRequestBuilder(body body: InventoryDetail) -> RequestBuilder<Void> {
        let path = "/v3.0/inventoryDetail/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
