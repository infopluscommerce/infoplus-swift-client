...
public class ItemBuyerAPI: APIBase {
  ...
  "lobId" : 0
    ...
    /**
     Add new audit for an itemBuyer
     - PUT /v3.0/itemBuyer/{itemBuyerId}/audit/{itemBuyerAudit}
    ...
    public class func addItemBuyerAuditWithRequestBuilder(itemBuyerId itemBuyerId: Int32, itemBuyerAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemBuyer/{itemBuyerId}/audit/{itemBuyerAudit}"
    ...
    /**
     Attach a file to an itemBuyer
     - POST /v3.0/itemBuyer/{itemBuyerId}/file/{fileName}
    ...
    public class func addItemBuyerFileWithRequestBuilder(itemBuyerId itemBuyerId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemBuyer/{itemBuyerId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{itemBuyerId}", withString: "\(itemBuyerId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter itemBuyerId: (path) Id of the itemBuyer to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addItemBuyerFileByURL(body body: RecordFile, itemBuyerId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addItemBuyerFileByURLWithRequestBuilder(body: body, itemBuyerId: itemBuyerId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to an itemBuyer by URL.
     - POST /v3.0/itemBuyer/{itemBuyerId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addItemBuyerFileByURLWithRequestBuilder(body body: RecordFile, itemBuyerId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemBuyer/{itemBuyerId}/file"
        path = path.stringByReplacingOccurrencesOfString("{itemBuyerId}", withString: "\(itemBuyerId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Add new tags for an itemBuyer.
     - PUT /v3.0/itemBuyer/{itemBuyerId}/tag/{itemBuyerTag}
    ...
    public class func addItemBuyerTagWithRequestBuilder(itemBuyerId itemBuyerId: Int32, itemBuyerTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/itemBuyer/{itemBuyerId}/tag/{itemBuyerTag}"
        path = path.stringByReplacingOccurrencesOfString("{itemBuyerId}", withString: "\(itemBuyerId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete an itemBuyer
     - DELETE /v3.0/itemBuyer/{itemBuyerId}
    ...
    public class func deleteItemBuyerWithRequestBuilder(itemBuyerId itemBuyerId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemBuyer/{itemBuyerId}"
        path = path.stringByReplacingOccurrencesOfString("{itemBuyerId}", withString: "\(itemBuyerId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter itemBuyerId: (path) Id of the itemBuyer to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteItemBuyerFile(itemBuyerId itemBuyerId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteItemBuyerFileWithRequestBuilder(itemBuyerId: itemBuyerId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for an itemBuyer.
     - DELETE /v3.0/itemBuyer/{itemBuyerId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteItemBuyerFileWithRequestBuilder(itemBuyerId itemBuyerId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemBuyer/{itemBuyerId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{itemBuyerId}", withString: "\(itemBuyerId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for an itemBuyer.
     - DELETE /v3.0/itemBuyer/{itemBuyerId}/tag/{itemBuyerTag}
    ...
    /**
     Get a duplicated an itemBuyer by id
     - GET /v3.0/itemBuyer/duplicate/{itemBuyerId}
  ...
  "lobId" : 0
    ...
    public class func getDuplicateItemBuyerByIdWithRequestBuilder(itemBuyerId itemBuyerId: Int32) -> RequestBuilder<ItemBuyer> {
        var path = "/v3.0/itemBuyer/duplicate/{itemBuyerId}"
        path = path.stringByReplacingOccurrencesOfString("{itemBuyerId}", withString: "\(itemBuyerId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
  ...
  "lobId" : 0
    ...
    public class func getItemBuyerByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[ItemBuyer]> {
        let path = "/v3.0/itemBuyer/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get an itemBuyer by id
     - GET /v3.0/itemBuyer/{itemBuyerId}
  ...
  "lobId" : 0
    ...
    /**
     ...
     - parameter itemBuyerId: (path) Id of the itemBuyer to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getItemBuyerFiles(itemBuyerId itemBuyerId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getItemBuyerFilesWithRequestBuilder(itemBuyerId: itemBuyerId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for an itemBuyer.
     - GET /v3.0/itemBuyer/{itemBuyerId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getItemBuyerFilesWithRequestBuilder(itemBuyerId itemBuyerId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemBuyer/{itemBuyerId}/file"
        path = path.stringByReplacingOccurrencesOfString("{itemBuyerId}", withString: "\(itemBuyerId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for an itemBuyer.
     - GET /v3.0/itemBuyer/{itemBuyerId}/tag
    ...
    public class func getItemBuyerTagsWithRequestBuilder(itemBuyerId itemBuyerId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/itemBuyer/{itemBuyerId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{itemBuyerId}", withString: "\(itemBuyerId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
