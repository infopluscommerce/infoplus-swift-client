...
public class ParcelInvoiceAPI: APIBase {
    ...
    /**
     Add new audit for a parcelInvoice
     - PUT /v3.0/parcelInvoice/{parcelInvoiceId}/audit/{parcelInvoiceAudit}
    ...
    public class func addParcelInvoiceAuditWithRequestBuilder(parcelInvoiceId parcelInvoiceId: Int32, parcelInvoiceAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/parcelInvoice/{parcelInvoiceId}/audit/{parcelInvoiceAudit}"
    ...
    /**
     Attach a file to a parcelInvoice
     - POST /v3.0/parcelInvoice/{parcelInvoiceId}/file/{fileName}
    ...
    public class func addParcelInvoiceFileWithRequestBuilder(parcelInvoiceId parcelInvoiceId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/parcelInvoice/{parcelInvoiceId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{parcelInvoiceId}", withString: "\(parcelInvoiceId)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter parcelInvoiceId: (path) Id of the parcelInvoice to add an file to 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addParcelInvoiceFileByURL(body body: RecordFile, parcelInvoiceId: Int32, completion: ((error: ErrorType?) -> Void)) {
        addParcelInvoiceFileByURLWithRequestBuilder(body: body, parcelInvoiceId: parcelInvoiceId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Attach a file to a parcelInvoice by URL.
     - POST /v3.0/parcelInvoice/{parcelInvoiceId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addParcelInvoiceFileByURLWithRequestBuilder(body body: RecordFile, parcelInvoiceId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/parcelInvoice/{parcelInvoiceId}/file"
        path = path.stringByReplacingOccurrencesOfString("{parcelInvoiceId}", withString: "\(parcelInvoiceId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Add new tags for a parcelInvoice.
     - PUT /v3.0/parcelInvoice/{parcelInvoiceId}/tag/{parcelInvoiceTag}
    ...
    public class func addParcelInvoiceTagWithRequestBuilder(parcelInvoiceId parcelInvoiceId: Int32, parcelInvoiceTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/parcelInvoice/{parcelInvoiceId}/tag/{parcelInvoiceTag}"
        path = path.stringByReplacingOccurrencesOfString("{parcelInvoiceId}", withString: "\(parcelInvoiceId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a parcelInvoice
     - DELETE /v3.0/parcelInvoice/{parcelInvoiceId}
    ...
    public class func deleteParcelInvoiceWithRequestBuilder(parcelInvoiceId parcelInvoiceId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/parcelInvoice/{parcelInvoiceId}"
        path = path.stringByReplacingOccurrencesOfString("{parcelInvoiceId}", withString: "\(parcelInvoiceId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     ...
     - parameter parcelInvoiceId: (path) Id of the parcelInvoice to remove file from 
     - parameter fileId: (path) Id of the file to delete 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteParcelInvoiceFile(parcelInvoiceId parcelInvoiceId: Int32, fileId: Int32, completion: ((error: ErrorType?) -> Void)) {
        deleteParcelInvoiceFileWithRequestBuilder(parcelInvoiceId: parcelInvoiceId, fileId: fileId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Delete a file for a parcelInvoice.
     - DELETE /v3.0/parcelInvoice/{parcelInvoiceId}/file/{fileId}
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteParcelInvoiceFileWithRequestBuilder(parcelInvoiceId parcelInvoiceId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/parcelInvoice/{parcelInvoiceId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{parcelInvoiceId}", withString: "\(parcelInvoiceId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a parcelInvoice.
     - DELETE /v3.0/parcelInvoice/{parcelInvoiceId}/tag/{parcelInvoiceTag}
    ...
    /**
     Get a duplicated a parcelInvoice by id
     - GET /v3.0/parcelInvoice/duplicate/{parcelInvoiceId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getDuplicateParcelInvoiceByIdWithRequestBuilder(parcelInvoiceId parcelInvoiceId: Int32) -> RequestBuilder<ParcelInvoice> {
        var path = "/v3.0/parcelInvoice/duplicate/{parcelInvoiceId}"
        path = path.stringByReplacingOccurrencesOfString("{parcelInvoiceId}", withString: "\(parcelInvoiceId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    public class func getParcelInvoiceByFilterWithRequestBuilder(filter filter: String? = nil, page: Int32? = nil, limit: Int32? = nil, sort: String? = nil) -> RequestBuilder<[ParcelInvoice]> {
        let path = "/v3.0/parcelInvoice/search"
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get a parcelInvoice by id
     - GET /v3.0/parcelInvoice/{parcelInvoiceId}
  ...
  "createDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     ...
     - parameter parcelInvoiceId: (path) Id of the parcelInvoice to get files for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getParcelInvoiceFiles(parcelInvoiceId parcelInvoiceId: Int32, completion: ((error: ErrorType?) -> Void)) {
        getParcelInvoiceFilesWithRequestBuilder(parcelInvoiceId: parcelInvoiceId).execute { (response, error) -> Void in
            completion(error: error);
        }
    }
    ...
    /**
     Get the files for a parcelInvoice.
     - GET /v3.0/parcelInvoice/{parcelInvoiceId}/file
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getParcelInvoiceFilesWithRequestBuilder(parcelInvoiceId parcelInvoiceId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/parcelInvoice/{parcelInvoiceId}/file"
        path = path.stringByReplacingOccurrencesOfString("{parcelInvoiceId}", withString: "\(parcelInvoiceId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the tags for a parcelInvoice.
     - GET /v3.0/parcelInvoice/{parcelInvoiceId}/tag
    ...
    public class func getParcelInvoiceTagsWithRequestBuilder(parcelInvoiceId parcelInvoiceId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/parcelInvoice/{parcelInvoiceId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{parcelInvoiceId}", withString: "\(parcelInvoiceId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
