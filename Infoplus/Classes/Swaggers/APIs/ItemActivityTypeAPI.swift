...
public class ItemActivityTypeAPI: APIBase {
    ...
    /**
     Get an itemActivityType by id
     - GET /v3.0/itemActivityType/{itemActivityTypeId}
  ...
  "label" : "label"
    ...
    public class func getItemActivityTypeByIdWithRequestBuilder(itemActivityTypeId itemActivityTypeId: String) -> RequestBuilder<ItemActivityType> {
        var path = "/v3.0/itemActivityType/{itemActivityTypeId}"
    ...
    /**
     Search itemActivityTypes
     - GET /v3.0/itemActivityType/search
  ...
  "label" : "label"
    ...
    public class func getItemActivityTypeBySearchTextWithRequestBuilder(searchText searchText: String? = nil, page: Int32? = nil, limit: Int32? = nil) -> RequestBuilder<[ItemActivityType]> {
        let path = "/v3.0/itemActivityType/search"
        let URLString = InfoplusAPI.basePath + path
