...
public class ShipmentAPI: APIBase {
    ...
    /**
     Add new audit for a shipment
     - PUT /v3.0/shipment/{shipmentId}/audit/{shipmentAudit}
    ...
    public class func addShipmentAuditWithRequestBuilder(shipmentId shipmentId: Int32, shipmentAudit: String) -> RequestBuilder<Void> {
        var path = "/v3.0/shipment/{shipmentId}/audit/{shipmentAudit}"
    ...
    /**
     Attach a file to a shipment
     - POST /v3.0/shipment/{shipmentId}/file/{fileName}
    ...
    public class func addShipmentFileWithRequestBuilder(shipmentId shipmentId: Int32, fileName: String) -> RequestBuilder<Void> {
        var path = "/v3.0/shipment/{shipmentId}/file/{fileName}"
        path = path.stringByReplacingOccurrencesOfString("{shipmentId}", withString: "\(shipmentId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Attach a file to a shipment by URL.
     - POST /v3.0/shipment/{shipmentId}/file
    ...
    public class func addShipmentFileByURLWithRequestBuilder(body body: RecordFile, shipmentId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/shipment/{shipmentId}/file"
        path = path.stringByReplacingOccurrencesOfString("{shipmentId}", withString: "\(shipmentId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Add new tags for a shipment.
     - PUT /v3.0/shipment/{shipmentId}/tag/{shipmentTag}
    ...
    public class func addShipmentTagWithRequestBuilder(shipmentId shipmentId: Int32, shipmentTag: String) -> RequestBuilder<Void> {
        var path = "/v3.0/shipment/{shipmentId}/tag/{shipmentTag}"
        path = path.stringByReplacingOccurrencesOfString("{shipmentId}", withString: "\(shipmentId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a file for a shipment.
     - DELETE /v3.0/shipment/{shipmentId}/file/{fileId}
    ...
    public class func deleteShipmentFileWithRequestBuilder(shipmentId shipmentId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/shipment/{shipmentId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{shipmentId}", withString: "\(shipmentId)", options: .LiteralSearch, range: nil)
    ...
    /**
     Delete a tag for a shipment.
     - DELETE /v3.0/shipment/{shipmentId}/tag/{shipmentTag}
    ...
    /**
     Get a duplicated a shipment by id
     - GET /v3.0/shipment/duplicate/{shipmentId}
     - Returns a duplicated shipment identified by the specified id.
     - API Key:
       - type: apiKey API-Key 
       - name: api_key
     - examples: [{contentType=application/json, example={
  "retailFreightAmount" : 7.4577447736837658709418974467553198337554931640625,
  "cartonTypeId" : 5,
  ...
  "lobId" : 1,
  "weightLbs" : 1.231513536777255612975068288506008684635162353515625,
  ...
  "chargedFreightAmount" : 1.489415909854170383397331534069962799549102783203125,
  "dim2In" : 2.027123023002321833274663731572218239307403564453125,
  "omsOrderNo" : 9,
  "carrier" : 6,
  "shipped" : false,
  "residential" : false,
  "dimWeight" : 1.024645700144157789424070870154537260532379150390625,
  "loadId" : 9,
  "trackingNo" : "trackingNo",
  "warehouseId" : 6,
  "shipmentId" : "shipmentId",
  "publishedFreightAmount" : 6.8468526983526398765889098285697400569915771484375,
  ...
  "status" : "status"
    ...
    public class func getDuplicateShipmentByIdWithRequestBuilder(shipmentId shipmentId: Int32) -> RequestBuilder<Shipment> {
        var path = "/v3.0/shipment/duplicate/{shipmentId}"
        path = path.stringByReplacingOccurrencesOfString("{shipmentId}", withString: "\(shipmentId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
  ...
  "status" : "status"
    ...
    public class func getShipmentByIdWithRequestBuilder(shipmentId shipmentId: Int32) -> RequestBuilder<Shipment> {
        var path = "/v3.0/shipment/{shipmentId}"
        path = path.stringByReplacingOccurrencesOfString("{shipmentId}", withString: "\(shipmentId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Get the files for a shipment.
     - GET /v3.0/shipment/{shipmentId}/file
    ...
    /**
     Get the tags for a shipment.
     - GET /v3.0/shipment/{shipmentId}/tag
    ...
    public class func getShipmentTagsWithRequestBuilder(shipmentId shipmentId: Int32) -> RequestBuilder<Void> {
        var path = "/v3.0/shipment/{shipmentId}/tag"
        path = path.stringByReplacingOccurrencesOfString("{shipmentId}", withString: "\(shipmentId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
    ...
    /**
     Update a shipment custom fields
     - PUT /v3.0/shipment/customFields
    ...
    public class func updateShipmentCustomFieldsWithRequestBuilder(body body: Shipment) -> RequestBuilder<Void> {
        let path = "/v3.0/shipment/customFields"
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
