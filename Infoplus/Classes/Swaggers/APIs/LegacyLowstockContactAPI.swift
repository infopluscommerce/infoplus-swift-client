...
public class LegacyLowstockContactAPI: APIBase {
  ...
  "lobId" : 0
    ...
    /**
     Attach a file to a legacyLowstockContact by URL.
     - POST /beta/legacyLowstockContact/{legacyLowstockContactId}/file
    ...
    public class func addLegacyLowstockContactFileByURLWithRequestBuilder(body body: RecordFile, legacyLowstockContactId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/legacyLowstockContact/{legacyLowstockContactId}/file"
        path = path.stringByReplacingOccurrencesOfString("{legacyLowstockContactId}", withString: "\(legacyLowstockContactId)", options: .LiteralSearch, range: nil)
        let URLString = InfoplusAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     Delete a file for a legacyLowstockContact.
     - DELETE /beta/legacyLowstockContact/{legacyLowstockContactId}/file/{fileId}
    ...
    public class func deleteLegacyLowstockContactFileWithRequestBuilder(legacyLowstockContactId legacyLowstockContactId: Int32, fileId: Int32) -> RequestBuilder<Void> {
        var path = "/beta/legacyLowstockContact/{legacyLowstockContactId}/file/{fileId}"
        path = path.stringByReplacingOccurrencesOfString("{legacyLowstockContactId}", withString: "\(legacyLowstockContactId)", options: .LiteralSearch, range: nil)
  ...
  "lobId" : 0
    ...
    /**
     Get the files for a legacyLowstockContact.
     - GET /beta/legacyLowstockContact/{legacyLowstockContactId}/file
