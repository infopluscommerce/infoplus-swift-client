...
public class OrderSourceReservationAPI: APIBase {
  ...
  "createDate" : "2000-01-23T04:56:07.000+0000"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getDuplicateOrderSourceReservationById(orderSourceReservationId orderSourceReservationId: Int, completion: ((data: OrderSourceReservation?, error: ErrorType?) -> Void)) {
