...
class Decoders {
    ...
    static private func initialize() {
        dispatch_once(&once) {
            ...
            // Decoder for [CarrierCompanyCode]
            Decoders.addDecoder(clazz: [CarrierCompanyCode].self) { (source: AnyObject) -> [CarrierCompanyCode] in
                return Decoders.decode(clazz: [CarrierCompanyCode].self, source: source)
            }
            // Decoder for CarrierCompanyCode
            Decoders.addDecoder(clazz: CarrierCompanyCode.self) { (source: AnyObject) -> CarrierCompanyCode in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = CarrierCompanyCode()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.label = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["label"])
            ...
            Decoders.addDecoder(clazz: CartonType.self) { (source: AnyObject) -> CartonType in
                ...
                instance.noOfCavities = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["noOfCavities"])
                instance.materialDescription = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["materialDescription"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }


            // Decoder for [ClosePurchProcessInputAPIModel]
            Decoders.addDecoder(clazz: [ClosePurchProcessInputAPIModel].self) { (source: AnyObject) -> [ClosePurchProcessInputAPIModel] in
                return Decoders.decode(clazz: [ClosePurchProcessInputAPIModel].self, source: source)
            }
            // Decoder for ClosePurchProcessInputAPIModel
            Decoders.addDecoder(clazz: ClosePurchProcessInputAPIModel.self) { (source: AnyObject) -> ClosePurchProcessInputAPIModel in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ClosePurchProcessInputAPIModel()
                instance.idList = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["idList"])
                return instance
            }


            // Decoder for [CommodityCode]
            Decoders.addDecoder(clazz: [CommodityCode].self) { (source: AnyObject) -> [CommodityCode] in
                return Decoders.decode(clazz: [CommodityCode].self, source: source)
            }
            // Decoder for CommodityCode
            Decoders.addDecoder(clazz: CommodityCode.self) { (source: AnyObject) -> CommodityCode in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = CommodityCode()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.code = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["code"])
                instance.meaning = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["meaning"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            ...
            // Decoder for [CustomField]
            Decoders.addDecoder(clazz: [CustomField].self) { (source: AnyObject) -> [CustomField] in
                return Decoders.decode(clazz: [CustomField].self, source: source)
            }
            // Decoder for CustomField
            Decoders.addDecoder(clazz: CustomField.self) { (source: AnyObject) -> CustomField in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = CustomField()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.name = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["name"])
                ...
                instance.fieldType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["fieldType"])
                instance.searchable = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["searchable"])
                instance.tooltip = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["tooltip"])
                instance.tabLabel = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["tabLabel"])
                instance.recordType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["recordType"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }
            ...
            // Decoder for [DasFeeType]
            Decoders.addDecoder(clazz: [DasFeeType].self) { (source: AnyObject) -> [DasFeeType] in
                return Decoders.decode(clazz: [DasFeeType].self, source: source)
            }
            // Decoder for DasFeeType
            Decoders.addDecoder(clazz: DasFeeType.self) { (source: AnyObject) -> DasFeeType in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = DasFeeType()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.label = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["label"])
                return instance
            }
            ...
            // Decoder for [DasFees]
            Decoders.addDecoder(clazz: [DasFees].self) { (source: AnyObject) -> [DasFees] in
                return Decoders.decode(clazz: [DasFees].self, source: source)
            }
            // Decoder for DasFees
            Decoders.addDecoder(clazz: DasFees.self) { (source: AnyObject) -> DasFees in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = DasFees()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.carrierCompanyCode = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["carrierCompanyCode"])
                instance.zip = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["zip"])
                instance.dasFeeType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["dasFeeType"])
                instance.fee = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["fee"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }


            // Decoder for [Dropship]
            Decoders.addDecoder(clazz: [Dropship].self) { (source: AnyObject) -> [Dropship] in
                return Decoders.decode(clazz: [Dropship].self, source: source)
            }
            // Decoder for Dropship
            Decoders.addDecoder(clazz: Dropship.self) { (source: AnyObject) -> Dropship in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = Dropship()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                ...
                instance.lobId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lobId"])
                instance.transmitDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["transmitDate"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }
            ...
            // Decoder for [ExecuteExternalShipmentInputAPIModel]
            Decoders.addDecoder(clazz: [ExecuteExternalShipmentInputAPIModel].self) { (source: AnyObject) -> [ExecuteExternalShipmentInputAPIModel] in
                return Decoders.decode(clazz: [ExecuteExternalShipmentInputAPIModel].self, source: source)
            }
            // Decoder for ExecuteExternalShipmentInputAPIModel
            Decoders.addDecoder(clazz: ExecuteExternalShipmentInputAPIModel.self) { (source: AnyObject) -> ExecuteExternalShipmentInputAPIModel in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ExecuteExternalShipmentInputAPIModel()
                instance.idList = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["idList"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: FulfillmentPlan.self) { (source: AnyObject) -> FulfillmentPlan in
                ...
                instance.selectAlternatePickLocation = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["selectAlternatePickLocation"])
                instance.autoCreateCycleCountWork = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["autoCreateCycleCountWork"])
                instance.autoAdjustmentTolerance = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["autoAdjustmentTolerance"])
                ...
                instance.orderAssemblyGuideLayout = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["orderAssemblyGuideLayout"])
                ...
                instance.createCartonGS1128Labels = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["createCartonGS1128Labels"])
                instance.createLineItemEachGS1128Labels = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["createLineItemEachGS1128Labels"])
            ...
            // Decoder for [GS1128LabelDTO]
            Decoders.addDecoder(clazz: [GS1128LabelDTO].self) { (source: AnyObject) -> [GS1128LabelDTO] in
                return Decoders.decode(clazz: [GS1128LabelDTO].self, source: source)
            }
            // Decoder for GS1128LabelDTO
            Decoders.addDecoder(clazz: GS1128LabelDTO.self) { (source: AnyObject) -> GS1128LabelDTO in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = GS1128LabelDTO()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.gs1128TemplateId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["gs1128TemplateId"])
                instance.noOfCopies = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["noOfCopies"])
                instance.lobId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lobId"])
                instance.orderNo = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["orderNo"])
                instance.recordType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["recordType"])
                instance.palletLoadId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["palletLoadId"])
                instance.masterCartonLoadId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["masterCartonLoadId"])
                instance.cartonId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["cartonId"])
                instance.lineItemId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lineItemId"])
                instance.lineItemUnitNo = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lineItemUnitNo"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.sscc = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["sscc"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }


            // Decoder for [GetOrderPackDataInput]
            Decoders.addDecoder(clazz: [GetOrderPackDataInput].self) { (source: AnyObject) -> [GetOrderPackDataInput] in
                return Decoders.decode(clazz: [GetOrderPackDataInput].self, source: source)
            }
            // Decoder for GetOrderPackDataInput
            Decoders.addDecoder(clazz: GetOrderPackDataInput.self) { (source: AnyObject) -> GetOrderPackDataInput in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = GetOrderPackDataInput()
                instance.orderNo = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["orderNo"])
                return instance
            }


            // Decoder for [GetOrderPackDataOutput]
            Decoders.addDecoder(clazz: [GetOrderPackDataOutput].self) { (source: AnyObject) -> [GetOrderPackDataOutput] in
                return Decoders.decode(clazz: [GetOrderPackDataOutput].self, source: source)
            }
            // Decoder for GetOrderPackDataOutput
            Decoders.addDecoder(clazz: GetOrderPackDataOutput.self) { (source: AnyObject) -> GetOrderPackDataOutput in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = GetOrderPackDataOutput()
                instance.orderNo = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["orderNo"])
                instance.order = Decoders.decodeOptional(clazz: Order.self, source: sourceDictionary["order"])
                instance.palletList = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["palletList"])
                instance.masterCartonList = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["masterCartonList"])
                instance.cartonList = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["cartonList"])
                instance.fullItemList = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["fullItemList"])
                instance.unpackedItemList = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["unpackedItemList"])
                return instance
            }
            ...
            // Decoder for [Gs1128Label]
            Decoders.addDecoder(clazz: [Gs1128Label].self) { (source: AnyObject) -> [Gs1128Label] in
                return Decoders.decode(clazz: [Gs1128Label].self, source: source)
            }
            // Decoder for Gs1128Label
            Decoders.addDecoder(clazz: Gs1128Label.self) { (source: AnyObject) -> Gs1128Label in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = Gs1128Label()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.sscc = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["sscc"])
                instance.lobId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lobId"])
                instance.orderNo = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["orderNo"])
            ...
            // Decoder for [Gs1128Template]
            Decoders.addDecoder(clazz: [Gs1128Template].self) { (source: AnyObject) -> [Gs1128Template] in
                return Decoders.decode(clazz: [Gs1128Template].self, source: source)
            }
            // Decoder for Gs1128Template
            Decoders.addDecoder(clazz: Gs1128Template.self) { (source: AnyObject) -> Gs1128Template in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = Gs1128Template()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.name = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["name"])
                instance.templateWidthIn = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["templateWidthIn"])
                instance.templateHeightIn = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["templateHeightIn"])
                instance.scriptId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["scriptId"])
                instance.apiVersion = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["apiVersion"])
                instance.row1Active = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row1Active"])
                instance.row1RightColumnActive = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row1RightColumnActive"])
                instance.row1Height = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row1Height"])
                instance.row1Width = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row1Width"])
                instance.row1ContentLeft = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row1ContentLeft"])
                instance.row1ContentRight = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row1ContentRight"])
                instance.row2Active = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row2Active"])
                instance.row2RightColumnActive = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row2RightColumnActive"])
                instance.row2Height = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row2Height"])
                instance.row2Width = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row2Width"])
                instance.row2ContentLeft = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row2ContentLeft"])
                instance.row2ContentRight = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row2ContentRight"])
                instance.row3Active = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row3Active"])
                instance.row3RightColumnActive = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row3RightColumnActive"])
                instance.row3Height = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row3Height"])
                instance.row3Width = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row3Width"])
                instance.row3ContentLeft = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row3ContentLeft"])
                instance.row3ContentRight = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row3ContentRight"])
                instance.row4Active = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row4Active"])
                instance.row4RightColumnActive = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row4RightColumnActive"])
                instance.row4Height = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row4Height"])
                instance.row4Width = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row4Width"])
                instance.row4ContentLeft = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row4ContentLeft"])
                instance.row4ContentRight = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row4ContentRight"])
                instance.row5Active = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row5Active"])
                instance.row5RightColumnActive = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row5RightColumnActive"])
                instance.row5Height = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row5Height"])
                instance.row5Width = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row5Width"])
                instance.row5ContentLeft = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row5ContentLeft"])
                instance.row5ContentRight = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row5ContentRight"])
                instance.row6Active = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row6Active"])
                instance.row6RightColumnActive = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row6RightColumnActive"])
                instance.row6Height = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row6Height"])
                instance.row6Width = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row6Width"])
                instance.row6ContentLeft = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row6ContentLeft"])
                instance.row6ContentRight = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row6ContentRight"])
                instance.row7Active = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row7Active"])
                instance.row7RightColumnActive = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row7RightColumnActive"])
                instance.row7Height = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row7Height"])
                instance.row7Width = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row7Width"])
                instance.row7ContentLeft = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row7ContentLeft"])
                instance.row7ContentRight = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row7ContentRight"])
                instance.row8Active = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row8Active"])
                instance.row8RightColumnActive = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row8RightColumnActive"])
                instance.row8Height = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row8Height"])
                instance.row8Width = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row8Width"])
                instance.row8ContentLeft = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row8ContentLeft"])
                instance.row8ContentRight = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row8ContentRight"])
                instance.row9Active = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row9Active"])
                instance.row9RightColumnActive = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row9RightColumnActive"])
                instance.row9Height = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row9Height"])
                instance.row9Width = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row9Width"])
                instance.row9ContentLeft = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row9ContentLeft"])
                instance.row9ContentRight = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row9ContentRight"])
                instance.row10Active = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row10Active"])
                instance.row10RightColumnActive = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["row10RightColumnActive"])
                instance.row10Height = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row10Height"])
                instance.row10Width = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["row10Width"])
                instance.row10ContentLeft = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row10ContentLeft"])
                instance.row10ContentRight = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["row10ContentRight"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            ...
            Decoders.addDecoder(clazz: InventoryDetail.self) { (source: AnyObject) -> InventoryDetail in
                ...
                instance.sku = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["sku"])
                instance.quantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["quantity"])
                instance.outstandingPickQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["outstandingPickQuantity"])
            ...
            Decoders.addDecoder(clazz: Item.self) { (source: AnyObject) -> Item in
                ...
                instance.commodityCodeId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["commodityCodeId"])
                ...
                instance.uspsHazmatTypeId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["uspsHazmatTypeId"])
                ...
                instance.openReturnPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["openReturnPOQuantity"])
                ...
                instance.openReturnPOQuantityInnerPacks = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["openReturnPOQuantityInnerPacks"])
                ...
                instance.openReturnPOQuantityCases = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["openReturnPOQuantityCases"])
                ...
                instance.openReturnPOQuantityPallets = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["openReturnPOQuantityPallets"])
                ...
                instance.w1OpenReturnPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w1OpenReturnPOQuantity"])
                ...
                instance.w2OpenReturnPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w2OpenReturnPOQuantity"])
                ...
                instance.w3OpenReturnPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w3OpenReturnPOQuantity"])
                ...
                instance.w4OpenReturnPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w4OpenReturnPOQuantity"])
                ...
                instance.w5OpenReturnPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w5OpenReturnPOQuantity"])
                ...
                instance.warehouse6Id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["warehouse6Id"])
                instance.w6AvailableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w6AvailableQuantity"])
                instance.w6DamagedQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w6DamagedQuantity"])
                instance.w6InFulfillmentProcessQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w6InFulfillmentProcessQuantity"])
                instance.w6OnHandQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w6OnHandQuantity"])
                instance.w6OpenOrderQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w6OpenOrderQuantity"])
                instance.w6OpenPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w6OpenPOQuantity"])
                instance.w6OpenReturnPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w6OpenReturnPOQuantity"])
                instance.w6OrderableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w6OrderableQuantity"])
                instance.w6UnallocatableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w6UnallocatableQuantity"])
                instance.w6UnavailableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w6UnavailableQuantity"])
                instance.w6DaysOnHand = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w6DaysOnHand"])
                instance.w6StockStatus = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["w6StockStatus"])
                instance.w6EstimatedPallets = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w6EstimatedPallets"])
                instance.w6EstimatedCases = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w6EstimatedCases"])
                instance.w6EstimatedInnerPacks = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w6EstimatedInnerPacks"])
                instance.w6NextRequestedDeliveryDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["w6NextRequestedDeliveryDate"])
                instance.warehouse7Id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["warehouse7Id"])
                instance.w7AvailableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w7AvailableQuantity"])
                instance.w7DamagedQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w7DamagedQuantity"])
                instance.w7InFulfillmentProcessQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w7InFulfillmentProcessQuantity"])
                instance.w7OnHandQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w7OnHandQuantity"])
                instance.w7OpenOrderQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w7OpenOrderQuantity"])
                instance.w7OpenPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w7OpenPOQuantity"])
                instance.w7OpenReturnPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w7OpenReturnPOQuantity"])
                instance.w7OrderableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w7OrderableQuantity"])
                instance.w7UnallocatableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w7UnallocatableQuantity"])
                instance.w7UnavailableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w7UnavailableQuantity"])
                instance.w7DaysOnHand = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w7DaysOnHand"])
                instance.w7StockStatus = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["w7StockStatus"])
                instance.w7EstimatedPallets = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w7EstimatedPallets"])
                instance.w7EstimatedCases = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w7EstimatedCases"])
                instance.w7EstimatedInnerPacks = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w7EstimatedInnerPacks"])
                instance.w7NextRequestedDeliveryDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["w7NextRequestedDeliveryDate"])
                instance.warehouse8Id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["warehouse8Id"])
                instance.w8AvailableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w8AvailableQuantity"])
                instance.w8DamagedQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w8DamagedQuantity"])
                instance.w8InFulfillmentProcessQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w8InFulfillmentProcessQuantity"])
                instance.w8OnHandQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w8OnHandQuantity"])
                instance.w8OpenOrderQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w8OpenOrderQuantity"])
                instance.w8OpenPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w8OpenPOQuantity"])
                instance.w8OpenReturnPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w8OpenReturnPOQuantity"])
                instance.w8OrderableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w8OrderableQuantity"])
                instance.w8UnallocatableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w8UnallocatableQuantity"])
                instance.w8UnavailableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w8UnavailableQuantity"])
                instance.w8DaysOnHand = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w8DaysOnHand"])
                instance.w8StockStatus = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["w8StockStatus"])
                instance.w8EstimatedPallets = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w8EstimatedPallets"])
                instance.w8EstimatedCases = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w8EstimatedCases"])
                instance.w8EstimatedInnerPacks = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w8EstimatedInnerPacks"])
                instance.w8NextRequestedDeliveryDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["w8NextRequestedDeliveryDate"])
                instance.warehouse9Id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["warehouse9Id"])
                instance.w9AvailableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w9AvailableQuantity"])
                instance.w9DamagedQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w9DamagedQuantity"])
                instance.w9InFulfillmentProcessQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w9InFulfillmentProcessQuantity"])
                instance.w9OnHandQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w9OnHandQuantity"])
                instance.w9OpenOrderQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w9OpenOrderQuantity"])
                instance.w9OpenPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w9OpenPOQuantity"])
                instance.w9OpenReturnPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w9OpenReturnPOQuantity"])
                instance.w9OrderableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w9OrderableQuantity"])
                instance.w9UnallocatableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w9UnallocatableQuantity"])
                instance.w9UnavailableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w9UnavailableQuantity"])
                instance.w9DaysOnHand = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w9DaysOnHand"])
                instance.w9StockStatus = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["w9StockStatus"])
                instance.w9EstimatedPallets = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w9EstimatedPallets"])
                instance.w9EstimatedCases = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w9EstimatedCases"])
                instance.w9EstimatedInnerPacks = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w9EstimatedInnerPacks"])
                instance.w9NextRequestedDeliveryDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["w9NextRequestedDeliveryDate"])
                instance.warehouse10Id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["warehouse10Id"])
                instance.w10AvailableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w10AvailableQuantity"])
                instance.w10DamagedQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w10DamagedQuantity"])
                instance.w10InFulfillmentProcessQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w10InFulfillmentProcessQuantity"])
                instance.w10OnHandQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w10OnHandQuantity"])
                instance.w10OpenOrderQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w10OpenOrderQuantity"])
                instance.w10OpenPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w10OpenPOQuantity"])
                instance.w10OpenReturnPOQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w10OpenReturnPOQuantity"])
                instance.w10OrderableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w10OrderableQuantity"])
                instance.w10UnallocatableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w10UnallocatableQuantity"])
                instance.w10UnavailableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w10UnavailableQuantity"])
                instance.w10DaysOnHand = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w10DaysOnHand"])
                instance.w10StockStatus = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["w10StockStatus"])
                instance.w10EstimatedPallets = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w10EstimatedPallets"])
                instance.w10EstimatedCases = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w10EstimatedCases"])
                instance.w10EstimatedInnerPacks = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["w10EstimatedInnerPacks"])
                instance.w10NextRequestedDeliveryDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["w10NextRequestedDeliveryDate"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }
            ...
            // Decoder for [ItemActivity]
            Decoders.addDecoder(clazz: [ItemActivity].self) { (source: AnyObject) -> [ItemActivity] in
                return Decoders.decode(clazz: [ItemActivity].self, source: source)
            }
            // Decoder for ItemActivity
            Decoders.addDecoder(clazz: ItemActivity.self) { (source: AnyObject) -> ItemActivity in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ItemActivity()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.lobId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lobId"])
                instance.inventoryChange = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["inventoryChange"])
                instance.activityType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["activityType"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.notes = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["notes"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
            ...
            Decoders.addDecoder(clazz: ItemReceiptActivity.self) { (source: AnyObject) -> ItemReceiptActivity in
                ...
                instance.receivedNumberOfInnerPack = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["receivedNumberOfInnerPack"])
                instance.receivedNumberOfCases = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["receivedNumberOfCases"])
                instance.receivedNumberOfPallets = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["receivedNumberOfPallets"])
                instance.receiptStatus = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["receiptStatus"])
                instance.receiptStatusName = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["receiptStatusName"])
                instance.receiptUnitCode = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["receiptUnitCode"])
                instance.receiptUnitCodeText = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["receiptUnitCodeText"])
            ...
            Decoders.addDecoder(clazz: ItemSerialScheme.self) { (source: AnyObject) -> ItemSerialScheme in
                ...
                instance.allowUniqueSerialReturns = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["allowUniqueSerialReturns"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: LineOfBusiness.self) { (source: AnyObject) -> LineOfBusiness in
                ...
                instance.gs1CompanyPrefix = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["gs1CompanyPrefix"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            ...
            // Decoder for [Load]
            Decoders.addDecoder(clazz: [Load].self) { (source: AnyObject) -> [Load] in
                return Decoders.decode(clazz: [Load].self, source: source)
            }
            // Decoder for Load
            Decoders.addDecoder(clazz: Load.self) { (source: AnyObject) -> Load in
                let sourceDictionary = source as! [NSObject:AnyObject]
                ...
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.lobId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lobId"])
                instance.lpn = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["lpn"])
                instance.behaviorType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["behaviorType"])
                instance.warehouseId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["warehouseId"])
                instance.locationId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["locationId"])
                instance.parentLoadId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["parentLoadId"])
                instance.palletTypeId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["palletTypeId"])
                instance.cartonTypeId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["cartonTypeId"])
                instance.orderNoList = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["orderNoList"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            ...
            // Decoder for [LoadContent]
            Decoders.addDecoder(clazz: [LoadContent].self) { (source: AnyObject) -> [LoadContent] in
                return Decoders.decode(clazz: [LoadContent].self, source: source)
            }
            // Decoder for LoadContent
            Decoders.addDecoder(clazz: LoadContent.self) { (source: AnyObject) -> LoadContent in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = LoadContent()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.loadId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["loadId"])
                instance.masterCartonId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["masterCartonId"])
                instance.lobId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lobId"])
                instance.cartonId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["cartonId"])
                instance.itemId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["itemId"])
                instance.itemReceiptId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["itemReceiptId"])
            ...
            Decoders.addDecoder(clazz: Location.self) { (source: AnyObject) -> Location in
                ...
                instance.contentMixingRule = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["contentMixingRule"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.quantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["quantity"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
            ...
            // Decoder for [ManifestPartner]
            Decoders.addDecoder(clazz: [ManifestPartner].self) { (source: AnyObject) -> [ManifestPartner] in
                return Decoders.decode(clazz: [ManifestPartner].self, source: source)
            }
            // Decoder for ManifestPartner
            Decoders.addDecoder(clazz: ManifestPartner.self) { (source: AnyObject) -> ManifestPartner in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ManifestPartner()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.label = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["label"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: Order.self) { (source: AnyObject) -> Order in
                ...
                instance.freight = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["freight"])
                instance.fulfillabilityDetails = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["fulfillabilityDetails"])
                instance.giftMessageTo = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["giftMessageTo"])
                instance.giftMessageFrom = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["giftMessageFrom"])
                instance.giftMessage = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["giftMessage"])
                instance.groupOrderId = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["groupOrderId"])
                ...
                instance.storeNo = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["storeNo"])
                instance.storeName = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["storeName"])
                instance.departmentNo = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["departmentNo"])
                instance.departmentName = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["departmentName"])
                instance.vendorNo = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["vendorNo"])
                instance.internalUse91 = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["internalUse91"])
                instance.deliveryDays = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["deliveryDays"])
                instance.deliveryDateGuaranteed = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["deliveryDateGuaranteed"])
                instance.fulfillability = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["fulfillability"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: OrderLine.self) { (source: AnyObject) -> OrderLine in
                ...
                instance.overrideReceiptsForFulfillmentList = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["overrideReceiptsForFulfillmentList"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: OrderLineActivity.self) { (source: AnyObject) -> OrderLineActivity in
                ...
                instance.orderSourceSKU = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["orderSourceSKU"])
                instance.unitCode = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["unitCode"])
                instance.unitCodeName = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["unitCodeName"])
                instance.itemMajorGroupId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["itemMajorGroupId"])
            ...
            Decoders.addDecoder(clazz: OrderSource.self) { (source: AnyObject) -> OrderSource in
                ...
                instance.palletGS1128TemplateId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["palletGS1128TemplateId"])
                instance.palletGS1128NoOfCopies = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["palletGS1128NoOfCopies"])
                instance.masterCartonGS1128TemplateId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["masterCartonGS1128TemplateId"])
                instance.masterCartonGS1128NoOfCopies = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["masterCartonGS1128NoOfCopies"])
                instance.cartonGS1128TemplateId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["cartonGS1128TemplateId"])
                instance.cartonGS1128NoOfCopies = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["cartonGS1128NoOfCopies"])
                instance.lineItemEachGS1128TemplateId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lineItemEachGS1128TemplateId"])
                instance.lineItemEachGS1128NoOfCopies = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lineItemEachGS1128NoOfCopies"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }
            ...
            // Decoder for [OverrideReceiptsForFulfillment]
            Decoders.addDecoder(clazz: [OverrideReceiptsForFulfillment].self) { (source: AnyObject) -> [OverrideReceiptsForFulfillment] in
                return Decoders.decode(clazz: [OverrideReceiptsForFulfillment].self, source: source)
            }
            // Decoder for OverrideReceiptsForFulfillment
            Decoders.addDecoder(clazz: OverrideReceiptsForFulfillment.self) { (source: AnyObject) -> OverrideReceiptsForFulfillment in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = OverrideReceiptsForFulfillment()
                instance.itemReceiptId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["itemReceiptId"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }
            ...
            // Decoder for [PackedCarton]
            Decoders.addDecoder(clazz: [PackedCarton].self) { (source: AnyObject) -> [PackedCarton] in
                return Decoders.decode(clazz: [PackedCarton].self, source: source)
            }
            // Decoder for PackedCarton
            Decoders.addDecoder(clazz: PackedCarton.self) { (source: AnyObject) -> PackedCarton in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = PackedCarton()
                return instance
            }


            // Decoder for [PackedItem]
            Decoders.addDecoder(clazz: [PackedItem].self) { (source: AnyObject) -> [PackedItem] in
                return Decoders.decode(clazz: [PackedItem].self, source: source)
            }
            // Decoder for PackedItem
            Decoders.addDecoder(clazz: PackedItem.self) { (source: AnyObject) -> PackedItem in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = PackedItem()
                return instance
            }


            // Decoder for [PackedMasterCarton]
            Decoders.addDecoder(clazz: [PackedMasterCarton].self) { (source: AnyObject) -> [PackedMasterCarton] in
                return Decoders.decode(clazz: [PackedMasterCarton].self, source: source)
            }
            // Decoder for PackedMasterCarton
            Decoders.addDecoder(clazz: PackedMasterCarton.self) { (source: AnyObject) -> PackedMasterCarton in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = PackedMasterCarton()
                return instance
            }


            // Decoder for [PackedPallet]
            Decoders.addDecoder(clazz: [PackedPallet].self) { (source: AnyObject) -> [PackedPallet] in
                return Decoders.decode(clazz: [PackedPallet].self, source: source)
            }
            // Decoder for PackedPallet
            Decoders.addDecoder(clazz: PackedPallet.self) { (source: AnyObject) -> PackedPallet in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = PackedPallet()
                return instance
            }


            // Decoder for [PackingDetail]
            Decoders.addDecoder(clazz: [PackingDetail].self) { (source: AnyObject) -> [PackingDetail] in
                return Decoders.decode(clazz: [PackingDetail].self, source: source)
            }
            // Decoder for PackingDetail
            Decoders.addDecoder(clazz: PackingDetail.self) { (source: AnyObject) -> PackingDetail in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = PackingDetail()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.lobId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lobId"])
                instance.orderId = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["orderId"])
                instance.palletId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["palletId"])
                instance.masterCartonId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["masterCartonId"])
                instance.cartonId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["cartonId"])
                instance.userId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["userId"])
                instance.sku = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["sku"])
                ...
                instance.lineItemId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lineItemId"])
                instance.quantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["quantity"])
                instance.cartonGS1128Label = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["cartonGS1128Label"])
                instance.palletGS1128Label = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["palletGS1128Label"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }


            // Decoder for [PackingPlan]
            Decoders.addDecoder(clazz: [PackingPlan].self) { (source: AnyObject) -> [PackingPlan] in
                return Decoders.decode(clazz: [PackingPlan].self, source: source)
            }
            // Decoder for PackingPlan
            Decoders.addDecoder(clazz: PackingPlan.self) { (source: AnyObject) -> PackingPlan in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = PackingPlan()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.fulfillmentProcessId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["fulfillmentProcessId"])
            ...
            // Decoder for [PackingPlanDetail]
            Decoders.addDecoder(clazz: [PackingPlanDetail].self) { (source: AnyObject) -> [PackingPlanDetail] in
                return Decoders.decode(clazz: [PackingPlanDetail].self, source: source)
            }
            // Decoder for PackingPlanDetail
            Decoders.addDecoder(clazz: PackingPlanDetail.self) { (source: AnyObject) -> PackingPlanDetail in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = PackingPlanDetail()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.packingPlanId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["packingPlanId"])
                instance.palletNo = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["palletNo"])
                instance.palletTypeId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["palletTypeId"])
                instance.masterCartonNo = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["masterCartonNo"])
                instance.masterCartonTypeId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["masterCartonTypeId"])
                instance.cartonNo = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["cartonNo"])
                instance.cartonTypeId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["cartonTypeId"])
                instance.cartonId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["cartonId"])
                instance.orderId = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["orderId"])
                instance.lobId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lobId"])
                instance.skuId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["skuId"])
                instance.lineItemId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lineItemId"])
                instance.quantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["quantity"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            ...
            // Decoder for [PalletType]
            Decoders.addDecoder(clazz: [PalletType].self) { (source: AnyObject) -> [PalletType] in
                return Decoders.decode(clazz: [PalletType].self, source: source)
            }
            // Decoder for PalletType
            Decoders.addDecoder(clazz: PalletType.self) { (source: AnyObject) -> PalletType in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = PalletType()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.name = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["name"])
                instance.palletLengthIn = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["palletLengthIn"])
                instance.palletWidthIn = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["palletWidthIn"])
                instance.palletHeightIn = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["palletHeightIn"])
                instance.palletWeightLbs = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["palletWeightLbs"])
                instance.packableLengthIn = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["packableLengthIn"])
                instance.packableWidthIn = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["packableWidthIn"])
                instance.packableHeightIn = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["packableHeightIn"])
                instance.lobId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lobId"])
                instance.isActive = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["isActive"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            ...
            Decoders.addDecoder(clazz: ParcelAccount.self) { (source: AnyObject) -> ParcelAccount in
                ...
                instance.orderSourceId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["orderSourceId"])
                instance.client = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["client"])
                instance.ipcDatabaseId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["ipcDatabaseId"])
                instance.name = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["name"])
                instance.manifestPartner = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["manifestPartner"])
                instance.manifestPartnerId = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["manifestPartnerId"])
                instance.manifestPartnerCredentials = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["manifestPartnerCredentials"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }
            ...
            // Decoder for [ProductCharges]
            Decoders.addDecoder(clazz: [ProductCharges].self) { (source: AnyObject) -> [ProductCharges] in
                return Decoders.decode(clazz: [ProductCharges].self, source: source)
            }
            // Decoder for ProductCharges
            Decoders.addDecoder(clazz: ProductCharges.self) { (source: AnyObject) -> ProductCharges in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ProductCharges()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.charge = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["charge"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
            ...
            Decoders.addDecoder(clazz: QuickReceipt.self) { (source: AnyObject) -> QuickReceipt in
                ...
                instance.locationId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["locationId"])
                instance.quantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["quantity"])
                instance.itemSerials = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["itemSerials"])
                instance.vendorId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["vendorId"])
                instance.carrier = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["carrier"])
                instance.status = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["status"])
                instance.unitCode = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["unitCode"])
            ...
            // Decoder for [RateCard]
            Decoders.addDecoder(clazz: [RateCard].self) { (source: AnyObject) -> [RateCard] in
                return Decoders.decode(clazz: [RateCard].self, source: source)
            }
            // Decoder for RateCard
            Decoders.addDecoder(clazz: RateCard.self) { (source: AnyObject) -> RateCard in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = RateCard()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.effectiveDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["effectiveDate"])
                instance.expirationDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["expirationDate"])
                instance.lineOfBusinessId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lineOfBusinessId"])
                instance.carrier = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["carrier"])
                instance.carrierServiceId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["carrierServiceId"])
                instance.weight = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["weight"])
                instance.zone = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["zone"])
                instance.rate = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["rate"])
            ...
            // Decoder for [RateType]
            Decoders.addDecoder(clazz: [RateType].self) { (source: AnyObject) -> [RateType] in
                return Decoders.decode(clazz: [RateType].self, source: source)
            }
            // Decoder for RateType
            Decoders.addDecoder(clazz: RateType.self) { (source: AnyObject) -> RateType in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = RateType()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.label = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["label"])
                return instance
            }
            ...
            // Decoder for [ReturnOrder]
            Decoders.addDecoder(clazz: [ReturnOrder].self) { (source: AnyObject) -> [ReturnOrder] in
                return Decoders.decode(clazz: [ReturnOrder].self, source: source)
            }
            // Decoder for ReturnOrder
            Decoders.addDecoder(clazz: ReturnOrder.self) { (source: AnyObject) -> ReturnOrder in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ReturnOrder()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.lobId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lobId"])
                instance.warehouseId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["warehouseId"])
                instance.originalOrderNo = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["originalOrderNo"])
                instance.reshipOrderNo = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["reshipOrderNo"])
                instance.returnAsnId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["returnAsnId"])
                instance.customerNo = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["customerNo"])
                instance.shipToAttention = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["shipToAttention"])
                instance.shipToCompany = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["shipToCompany"])
                instance.shipToStreet = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["shipToStreet"])
                ...
                instance.shipToPhone = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["shipToPhone"])
                instance.shipToEmail = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["shipToEmail"])
                instance.returnOrderStatus = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["returnOrderStatus"])
                instance.returnReason = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["returnReason"])
                instance.returnCategory = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["returnCategory"])
                instance.returnInstructions = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["returnInstructions"])
                instance.returnOrderLineItemList = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["returnOrderLineItemList"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }


            // Decoder for [ReturnOrderLine]
            Decoders.addDecoder(clazz: [ReturnOrderLine].self) { (source: AnyObject) -> [ReturnOrderLine] in
                return Decoders.decode(clazz: [ReturnOrderLine].self, source: source)
            }
            // Decoder for ReturnOrderLine
            Decoders.addDecoder(clazz: ReturnOrderLine.self) { (source: AnyObject) -> ReturnOrderLine in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ReturnOrderLine()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.lobId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lobId"])
                instance.warehouseId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["warehouseId"])
                instance.returnOrderId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["returnOrderId"])
                instance.originalOrderNo = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["originalOrderNo"])
                instance.reshipOrderNo = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["reshipOrderNo"])
                instance.returnItemReceiptId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["returnItemReceiptId"])
                instance.sku = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["sku"])
                instance.originalShippedQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["originalShippedQuantity"])
                instance.expectedReturnQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["expectedReturnQuantity"])
                instance.actualReturnQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["actualReturnQuantity"])
                instance.originalItemReceiptId = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["originalItemReceiptId"])
                instance.returnOrderLineStatus = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["returnOrderLineStatus"])
                instance.returnOrderLineAction = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["returnOrderLineAction"])
                instance.returnOrderLineInspectionStatus = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["returnOrderLineInspectionStatus"])
                instance.returnOrderLineDetailList = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["returnOrderLineDetailList"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }


            // Decoder for [ReturnOrderLineDetails]
            Decoders.addDecoder(clazz: [ReturnOrderLineDetails].self) { (source: AnyObject) -> [ReturnOrderLineDetails] in
                return Decoders.decode(clazz: [ReturnOrderLineDetails].self, source: source)
            }
            // Decoder for ReturnOrderLineDetails
            Decoders.addDecoder(clazz: ReturnOrderLineDetails.self) { (source: AnyObject) -> ReturnOrderLineDetails in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ReturnOrderLineDetails()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.lobId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lobId"])
                instance.warehouseId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["warehouseId"])
                instance.returnOrderId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["returnOrderId"])
                instance.returnOrderLineId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["returnOrderLineId"])
                instance.sku = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["sku"])
                instance.quantityReturned = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["quantityReturned"])
                instance.warehouseLocationId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["warehouseLocationId"])
                instance.returnInspectionStatus = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["returnInspectionStatus"])
                instance.returnItemReceiptId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["returnItemReceiptId"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            }
            ...
            // Decoder for [ReturnShipment]
            Decoders.addDecoder(clazz: [ReturnShipment].self) { (source: AnyObject) -> [ReturnShipment] in
                return Decoders.decode(clazz: [ReturnShipment].self, source: source)
            }
            // Decoder for ReturnShipment
            Decoders.addDecoder(clazz: ReturnShipment.self) { (source: AnyObject) -> ReturnShipment in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ReturnShipment()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.shipDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["shipDate"])
            ...
            Decoders.addDecoder(clazz: Shipment.self) { (source: AnyObject) -> Shipment in
                ...
                instance.thirdPartyParcelAccountNo = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["thirdPartyParcelAccountNo"])
                instance.shipmentId = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["shipmentId"])
                instance.manifestPartnerOrderId = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["manifestPartnerOrderId"])
                instance.manifestId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["manifestId"])
                instance.residential = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["residential"])
                instance.billingOption = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["billingOption"])
                instance.weightLbs = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["weightLbs"])
            ...
            Decoders.addDecoder(clazz: Substitution.self) { (source: AnyObject) -> Substitution in
                ...
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.orderSKU = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["orderSKU"])
                instance.substituteSKU = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["substituteSKU"])
            ...
            // Decoder for [UspsHazmatType]
            Decoders.addDecoder(clazz: [UspsHazmatType].self) { (source: AnyObject) -> [UspsHazmatType] in
                return Decoders.decode(clazz: [UspsHazmatType].self, source: source)
            }
            // Decoder for UspsHazmatType
            Decoders.addDecoder(clazz: UspsHazmatType.self) { (source: AnyObject) -> UspsHazmatType in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = UspsHazmatType()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.label = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["label"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: Warehouse.self) { (source: AnyObject) -> Warehouse in
                ...
                instance.packStationAllowPackingBeforePickWorkIsComplete = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["packStationAllowPackingBeforePickWorkIsComplete"])
                instance.packStationSkipCartonLPN = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["packStationSkipCartonLPN"])
                instance.packStationRequireConfirmOnError = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["packStationRequireConfirmOnError"])
                instance.packStationAllowScanningSKUToIdentifyOrders = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["packStationAllowScanningSKUToIdentifyOrders"])
                instance.packStationAllowEntryOfItemQuantities = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["packStationAllowEntryOfItemQuantities"])
                instance.packStationAllowAddAllItems = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["packStationAllowAddAllItems"])
                instance.shipStationWeightCheckPackedOrders = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["shipStationWeightCheckPackedOrders"])
                instance.shipStationShowUserWeightCheckExceptions = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["shipStationShowUserWeightCheckExceptions"])
                instance.shipStationAutoPrintPreGeneratedLabels = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["shipStationAutoPrintPreGeneratedLabels"])
                instance.shipStationAllowScanningSKUToIdentifyOrders = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["shipStationAllowScanningSKUToIdentifyOrders"])
                instance.shipStationAllowRateShopping = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["shipStationAllowRateShopping"])
                instance.shipStationBlockShippingForUnresolvedShortWork = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["shipStationBlockShippingForUnresolvedShortWork"])
                instance.inventorySearchInnerPackBarcode = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["inventorySearchInnerPackBarcode"])
                instance.inventorySearchCaseBarcode = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["inventorySearchCaseBarcode"])
                instance.inventorySearchPalletBarcode = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["inventorySearchPalletBarcode"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            ...
            Decoders.addDecoder(clazz: WarehouseDocument.self) { (source: AnyObject) -> WarehouseDocument in
                ...
                instance.printerType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["printerType"])
                instance.clientId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["clientId"])
                instance.name = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["name"])
                instance.description = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["description"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
            ...
            // Decoder for [WarehouseInventory]
            Decoders.addDecoder(clazz: [WarehouseInventory].self) { (source: AnyObject) -> [WarehouseInventory] in
                return Decoders.decode(clazz: [WarehouseInventory].self, source: source)
            }
            // Decoder for WarehouseInventory
            Decoders.addDecoder(clazz: WarehouseInventory.self) { (source: AnyObject) -> WarehouseInventory in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = WarehouseInventory()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.sku = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["sku"])
                instance.lobId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["lobId"])
                instance.warehouseId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["warehouseId"])
                ...
                instance.orderableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["orderableQuantity"])
                instance.unallocatableQuantity = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["unallocatableQuantity"])
                instance.daysOnHand = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["daysOnHand"])
                instance.stockStatus = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["stockStatus"])
                instance.availableQuantityCases = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["availableQuantityCases"])
                instance.availableQuantityInnerPacks = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["availableQuantityInnerPacks"])
                instance.availableQuantityPallets = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["availableQuantityPallets"])
                instance.damagedQuantityCases = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["damagedQuantityCases"])
                ...
                instance.unavailableQuantityPallets = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["unavailableQuantityPallets"])
                instance.totalDemand = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["totalDemand"])
                instance.nextRequestDeliveryDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["nextRequestDeliveryDate"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
                return instance
            ...
            // Decoder for [ZipCodeZone]
            Decoders.addDecoder(clazz: [ZipCodeZone].self) { (source: AnyObject) -> [ZipCodeZone] in
                return Decoders.decode(clazz: [ZipCodeZone].self, source: source)
            }
            // Decoder for ZipCodeZone
            Decoders.addDecoder(clazz: ZipCodeZone.self) { (source: AnyObject) -> ZipCodeZone in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ZipCodeZone()
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.createDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["createDate"])
                instance.modifyDate = Decoders.decodeOptional(clazz: NSDate.self, source: sourceDictionary["modifyDate"])
                instance.warehouseNo = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["warehouseNo"])
                instance.carrierCompanyCode = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["carrierCompanyCode"])
                instance.zip = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["zip"])
                instance.zone = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["zone"])
                instance.customFields = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["customFields"])
